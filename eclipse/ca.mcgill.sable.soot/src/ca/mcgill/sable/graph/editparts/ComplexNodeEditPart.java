...
public class ComplexNodeEditPart extends AbstractGraphicalEditPart
        ...
        while (it.hasNext()) {
            ...
            if (next instanceof SimpleNodeEditPart) {
                ...
                getFigure()
                        .setSize(
                                getFigure().getBounds().width
                                        + ((SimpleNodeEditPart) next).getFigure().getBounds().width,
                                getFigure().getBounds().height
                                        + ((SimpleNodeEditPart) next)
                                                .getFigure()
                                                .getBounds()
                                                .height);
                ...
                getFigure()
                        .setSize(
                                getFigure().getBounds().width
                                        + ((GraphEditPart) next).getFigureWidth(),
                                getFigure().getBounds().height
                                        + ((GraphEditPart) next).getFigureHeight());
            }
        }
    }
}
