...
public class SootPartManager {
    ...
    public void updatePart(IEditorPart part) {
        ...
        if (part instanceof JimpleEditor) {
            ...
            SourceViewer viewer =
                    (SourceViewer)
                            ((AbstractTextEditor) part).getAdapter(ITextOperationTarget.class);
    ...
    private void handleTypes(SootAttributesHandler handler, IFile file) {
        IWorkbenchPage page =
                SootPlugin.getDefault().getWorkbench().getActiveWorkbenchWindow().getActivePage();
    ...
    private void handleKeys(SootAttributesHandler handler) {
        ...
        IViewPart viewPart =
                SootPlugin.getDefault()
                        ...
                        .getActivePage()
                        .findView(ISootConstants.ANALYSIS_KEY_VIEW_ID);
        try {
            if (viewPart == null) {
                IWorkbenchPart activePart = page.getActivePart();
