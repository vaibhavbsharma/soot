...
public class SootResourceManager implements IResourceChangeListener, ITextListener {
    ...
    private static final String JAVA_FILE_EXT =
            Messages.getString("SootResourceManager.java"); // $NON-NLS-1$
    public static final String JIMPLE_FILE_EXT =
            Messages.getString("SootResourceManager.jimple"); // $NON-NLS-1$
