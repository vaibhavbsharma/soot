...
public class JimpleFile {
    ...
    public boolean isJimpleFile() throws IOException, CoreException {
        ...
        JimpleBody jBody =
                new JimpleBody(sb.subSequence(leftBracePos, rightBracePos).toString(), getArr());
    ...
    public JimpleOutlineObject getOutline() {
        ...
        JimpleOutlineObject file =
                new JimpleOutlineObject(className, findImageType(), findDecorators());
        ...
        while (itF.hasNext()) {
            ...
            getFields().add(field);
            file.addChild(
                    new JimpleOutlineObject(
                            field.getLabel(), field.getImageType(), field.findDecorators()));
        }
        ...
        while (it.hasNext()) {
            ...
            file.addChild(
                    new JimpleOutlineObject(
                            method.getLabel(), method.getImageType(), method.findDecorators()));
        }
