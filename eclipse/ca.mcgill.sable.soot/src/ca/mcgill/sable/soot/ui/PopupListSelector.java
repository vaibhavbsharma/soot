...
public class PopupListSelector {
    ...
    public PopupListSelector(Shell parent) {
        ...
        list.setBackground(
                SootPlugin.getDefault().getColorManager().getColor(new RGB(255, 255, 255)));
    ...
    public String open(Rectangle rect) {
        ...
        // Position the dialog so that it does not run off the screen and the largest number of
        // items are visible
        ...
        if (listSize.x < getMinimumWidth()) listSize.x = getMinimumWidth();
