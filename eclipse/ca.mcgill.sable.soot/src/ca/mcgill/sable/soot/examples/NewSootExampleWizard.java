...
public abstract class NewSootExampleWizard extends JavaProjectWizard {
    ...
    public boolean performFinish() {
        ...
        if (performFinish) {
            ...
            try {
                ...
                if (is == null) {
                    new RuntimeException("Resource " + templateFilePath + " not found!")
                            .printStackTrace();
                } else {
                    ...
                    if (firstSourceEntry != null) {
                        IPath path =
                                SootPlugin.getWorkspace()
                                        .getRoot()
                                        .getFile(firstSourceEntry.getPath())
                                        .getLocation();
                                        ...
                                        new Runnable() {
                                            public void run() {
                                                try {
                                                    ...
                                                    IDE.openEditor(
                                                            activePage, (IFile) newResource, true);
    ...
    protected static class FirstPage extends WizardPage {
        ...
        public void createControl(Composite parent) {
            ...
            setControl(composite);
            label.setText(
                    "Please create a new Java project using the following Wizard "
