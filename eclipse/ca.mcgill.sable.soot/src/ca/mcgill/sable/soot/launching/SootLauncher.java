...
/** Main Soot Launcher. Handles running Soot directly (or as a process) */
public abstract class SootLauncher implements IWorkbenchWindowActionDelegate {
    ...
    private void sendSootOutputEvent(String toSend) {
        SootOutputEvent send =
                new SootOutputEvent(this, ISootOutputEventConstants.SOOT_NEW_TEXT_EVENT);
    ...
    private void initPaths() {
        ...
        setOutputLocation(
                platform_location
                        + getFileHandler().getSootOutputFolder().getFullPath().toOSString());
    }
    ...
    protected void addJars() {
        try {
            ...
            IPackageFragmentRoot[] roots =
                    getSootSelection().getJavaProject().getAllPackageFragmentRoots();
