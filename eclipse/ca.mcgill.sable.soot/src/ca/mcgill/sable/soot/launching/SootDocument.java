...
public class SootDocument extends Document implements ISootOutputEventListener {
    ...
    private void showSootOutputView() {
        ...
        if (window != null) {
            ...
            if (page != null) {
                try {
                    IViewPart sootOutputViewer =
                            page.findView("ca.mcgill.sable.soot.ui.sootoutputview.view");
    ...
    private void update(Runnable runnable) {
        if (getViewer().getTextViewer() != null
                && getViewer().getTextViewer().getControl() != null
                && getViewer().getControl().getDisplay() != null) {
