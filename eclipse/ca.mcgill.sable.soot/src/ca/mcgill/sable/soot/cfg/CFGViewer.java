...
public class CFGViewer {
    ...
    public void run(Object sootGraph) {
        ...
        org.eclipse.draw2d.graph.DirectedGraph dg =
                makeSootGraph((soot.toolkits.graph.DirectedGraph) sootGraph);
    ...
    public org.eclipse.draw2d.graph.DirectedGraph makeSootGraph(
            soot.toolkits.graph.DirectedGraph sootGraph) {
