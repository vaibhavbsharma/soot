...
public class CallGraphGenerator {
    ...
    public void run() {
        ...
        try {
            ...
            ((GraphEditor) part)
                    .setMenuProvider(
                            new CGMenuProvider(
                                    ((GraphEditor) part).getGraphEditorGraphicalViewer(),
                                    ((GraphEditor) part).getGraphEditorActionRegistry(),
                                    part));
        ...
        getController()
                .setEvent(
                        new InteractionEvent(
                                IInteractionConstants.CALL_GRAPH_NEXT_METHOD, node.getData()));
    ...
    public void showInCode(CallGraphNode node) {
        ...
        try {
            IEditorPart part =
                    page.openEditor(
                            new FileEditorInput((IFile) fileToOpen),
