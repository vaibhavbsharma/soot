...
public class PointsToAnalysis {
    ...
    public static void main(String[] args) {
        ...
        if (args[0].equals("paddle")) setPaddlePointsToAnalysis();
        else if (args[0].equals("spark")) setSparkPointsToAnalysis();
    ...
    private static int getLineNumber(Stmt s) {
        ...
        while (ti.hasNext()) {
            Object o = ti.next();
            if (o instanceof LineNumberTag) return Integer.parseInt(o.toString());
        }
        return -1;
    }
    ...
    private static SootField getField(String classname, String fieldname) {
        ...
        while (ci.hasNext()) {
            ...
            if (sc.getName().equals(classname)) return sc.getFieldByName(fieldname);
        }
        throw new RuntimeException("Field " + fieldname + " was not found in class " + classname);
    }

    private static Map /*<Integer,Local>*/ getLocals(
