...
/**
 * Provides an interface for querying the expressions that are very busy before and after a unit in
 * a method.
 *
...
public interface VeryBusyExpressions {
    ...
    /**
     * Returns the list of expressions that are very busy after the specified Unit.
     *
     * @param s the Unit that defines this query.
