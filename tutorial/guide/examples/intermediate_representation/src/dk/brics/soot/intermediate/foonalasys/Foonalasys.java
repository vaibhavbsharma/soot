...
/**
 * A <code>Foonalysis</code> object encapsulates a foonalysis performed on a collection of classes.
 * The class also contains some convenience methods for loading and traversing the classes to be
 * analyzed.
 *
 * <p>
 */
public class Foonalasys {
    ...
    /**
     * Loads the named class into the Soot scene, marks it as an application class, and generates
     * bodies for all of its concrete methods.
     *
