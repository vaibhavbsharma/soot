        ...
        for (SootClass ac : app) {
            ...
            for (SootMethod sm : sootMethods) {
                if (sm.isConcrete()) {
                    ...
                    // System.err.println("Setting up link between entry and first stmt of the
                    // method...");
                    ...
                    si = cug.iterator();
                    // System.err.println("Setting up link between the last statement and the first
                    // statement...");
                    while (si.hasNext()) {
                        Stmt stmt = (Stmt) si.next();
                    ...
                    //					while (si.hasNext()) {
                    //						Stmt stmt = (Stmt)si.next();
                    //						System.err.println("The stmt: "+stmt+" translates to
                    // "+st.getFirst(stmt));
