 ...
 *
 * <p>A statements belongs to the body of some method. It has control flow edges to and from other
 * statements.
 */
public abstract class Statement {
    ...
    /**
     * Returns all targets of control flow edges originating from this node.
     *
    ...
    /**
     * Returns all origins of control flow edges going to this node.
     *
     * @return a collection of {@link dk.brics.soot.intermediate.Statement} objects.
     */
    ...
    /**
     * Returns the index of this statement, indicating the sequence number in which the statement
     * was added to its method.
     *
     * @return the index.
     */
    public int getIndex() {
    ...
    /**
     * Returns a string representation of this statement. This is handled by a {@link
     * dk.brics.soot.intermediate.ToStringVisitor}.
     *
    ...
    /**
     * Visit this statement by the given statement visitor. This will invoke the corresponding
     ...
     */
    public abstract <T> T process(StatementProcessor<T> v);
