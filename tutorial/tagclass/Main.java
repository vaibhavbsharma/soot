...
/**
 * Example of using Soot to create a classfile from scratch. The 'createclass' example creates a
 * HelloWorld class file using Soot. It proceeds as follows:
 *
 * <p>- Create a SootClass <code>HelloWorld</code> extending java.lang.Object.
 *
 * <p>- Create a 'main' method and add it to the class.
 *
 * <p>- Create an empty JimpleBody and add it to the 'main' method.
 *
 * <p>- Add locals and statements to JimpleBody.
 *
 * <p>- Write the result out to a class file.
 */
public class Main {
