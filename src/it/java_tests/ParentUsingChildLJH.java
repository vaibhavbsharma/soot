/**
 * @testcase PUREJAVA PR#728 interface using preceding subinterface in its definition (order
 *     matters)
 */
...
public class ParentUsingChildLJH {
  public static void main(String[] args) {
    ...
    if (!(battle instanceof Child.Toy)) System.out.println("!battle instanceof Child.Toy");
  }
}
