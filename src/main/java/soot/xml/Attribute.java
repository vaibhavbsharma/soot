...
public class Attribute {
  ...
  public void addTag(Tag t) {
    if (t instanceof LineNumberTag) {
      ...
      StringAttribute string =
          new StringAttribute(formatForXML(st.getInfo()), st.getAnalysisType());
      addText(string);
      ...
      ColorAttribute ca =
          new ColorAttribute(
              ct.getRed(), ct.getGreen(), ct.getBlue(), ct.isForeground(), ct.getAnalysisType());
      // color(ca);
      addColor(ca);
    }
  ...
  public void print(PrintWriter writerOut) {
    if (isEmpty()) {
      ...
      // System.out.println("<srcPos sline=\""+javaStartLn()+"\" eline=\""+javaEndLn()+"\"
      // spos=\""+javaStartPos()+"\" epos=\""+javaEndPos()+"\"/>");
      // System.out.println("<jmpPos sline=\""+jimpleStartLn()+"\" eline=\""+jimpleEndLn()+"\"
