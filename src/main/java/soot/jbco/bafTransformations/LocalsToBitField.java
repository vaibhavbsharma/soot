    ...
    while (it.hasNext()) {
      ...
      if (unit instanceof StoreInst) {
        ...
        if (nloc != null) {
          ...
          long longmask =
              ~((size == 1 ? 0x1L : size == 8 ? 0xFFL : size == 16 ? 0xFFFFL : 0xFFFFFFFFL)
                  << index);
        ...
        if (nloc != null) {
          ...
          int size = sizes.get(bafLoc);
          long longmask =
              (size == 1 ? 0x1L : size == 8 ? 0xFFL : size == 16 ? 0xFFFFL : 0xFFFFFFFFL) << index;
        ...
        if (nloc != null) {
          ...
          u.insertBefore(
              Baf.v().newPrimitiveCastInst(LongType.v(), ii.getConstant().getType()), unit);
