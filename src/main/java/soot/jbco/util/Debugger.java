  ...
  public static void printUnits(Body b, String msg) {
    ...
    while (udit.hasNext()) {
      ...
      if (unit instanceof TargetArgInst) {
        ...
        System.out.println(
            numbers.get(unit).toString()
                + " "
                + unit
                + "   #"
                + numbers.get(ti.getTarget()).toString());
        continue;
    ...
    while (tit.hasNext()) {
      Trap t = tit.next();
      System.out.println(
          numbers.get(t.getBeginUnit())
              + " "
              + t.getBeginUnit()
              + " to "
              + numbers.get(t.getEndUnit())
              + " "
              + t.getEndUnit()
              + "  at "
              + numbers.get(t.getHandlerUnit())
              + " "
              + t.getHandlerUnit());
    }
