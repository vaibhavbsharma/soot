...
public class Util {
  ...
  public static void addInnerClassTag(
      soot.SootClass sc, String innerName, String outerName, String simpleName, int access) {
  ...
  public static void addLineTag(soot.tagkit.Host host, polyglot.ast.Node node) {
    ...
    if (soot.options.Options.v().keep_line_number()) {
      if (node.position() != null) {
        host.addTag(
            new soot.tagkit.SourceLineNumberTag(node.position().line(), node.position().line()));
      }
    }
  }
  ...
  public static soot.Local getThis(
      soot.Type sootType, soot.Body body, HashMap getThisMap, LocalGenerator lg) {
    ...
    soot.jimple.FieldRef fieldRef =
        soot.jimple.Jimple.v().newInstanceFieldRef(specialThisLocal, outerThisField.makeRef());
  ...
  public static soot.Local getThisGivenOuter(
      soot.Type sootType, HashMap getThisMap, soot.Body body, LocalGenerator lg, soot.Local t2) {
  ...
  public static soot.Local getPrivateAccessFieldInvoke(
      soot.SootMethodRef toInvoke, ArrayList params, soot.Body body, LocalGenerator lg) {
