...
public class PrivateFieldAccMethodSource implements soot.MethodSource {
  ...
  public PrivateFieldAccMethodSource(
      soot.Type fieldType, String fieldName, boolean isStatic, soot.SootClass classToInvoke) {
  ...
  public soot.Body getBody(soot.SootMethod sootMethod, String phaseName) {
    ...
    soot.SootFieldRef field =
        soot.Scene.v().makeFieldRef(classToInvoke, fieldName, fieldType, isStatic);
