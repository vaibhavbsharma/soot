...
public class Transform implements HasPhaseOptions {
  ...
  /**
   * Allows user-defined phases to have options other than just enabled without having to mess with
   * the XML. Call this method with a space-separated list of options declared for this Transform.
   * Only declared options may be passed to this transform as a phase option.
   */
  ...
  /**
   * Allows user-defined phases to have options other than just enabled without having to mess with
   * the XML. Call this method with a space-separated list of option:value pairs that this Transform
   * is to use as default parameters (eg `enabled:off').
   */
