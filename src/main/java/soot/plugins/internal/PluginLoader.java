    ...
    try {
      final JAXBContext context =
          JAXBContext.newInstance(
              Plugins.class, PluginDescription.class, PhasePluginDescription.class);
    ...
    try {
      ...
      if (!(instance instanceof SootPhasePlugin)) {
        throw new RuntimeException(
            "The plugin class '"
                + pluginDescription.getClassName()
                + "' does not implement SootPhasePlugin.");
      }
      ...
      Transform transform =
          new Transform(pluginDescription.getPhaseName(), phasePlugin.getTransformer());
      ...
      throw new RuntimeException(
          "Failed to instanciate plugin class for " + pluginDescription + ".", e);
    } catch (final IllegalAccessException e) {
      throw new RuntimeException(
          "Not allowed to access plugin class for " + pluginDescription + ".", e);
    }
  }
