 ...
 * IdentityStmts. We reduce the traps to start at the first "real" instruction. We could also use a
 * TrapTigthener, but that would be too expensive for just producing working Dex code.
 *
 * @author Steven Arzt
 */
