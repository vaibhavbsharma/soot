...
/**
 * The "31t" instruction format: It needs three 16-bit code units, has one register and is used for
 * jump targets (hence the "t").<br>
 * <br>
...
public class Insn31t extends InsnWithOffset implements OneRegInsn {
  ...
  protected BuilderInstruction getRealInsn0(LabelAssigner assigner) {
    return new BuilderInstruction31t(
        opc, (short) getRegA().getNumber(), assigner.getOrCreateLabel(payload));
  }
