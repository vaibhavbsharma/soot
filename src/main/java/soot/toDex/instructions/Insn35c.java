 ...
 * for method/type items (hence the "c" for "constant pool").<br>
 * <br>
 * It is used by the "filled-new-array" opcode and the various "invoke-" opcodes.<br>
 * <br>
 * IMPLEMENTATION NOTE: the wide args for "35c" must be explicitly stated - internally, such args
 * are implicitly represented by e.g. "regD = wide, regE = emptyReg" to avoid using null and to
 * distinguish the first "half" of a wide reg from the second one. this is made explicit ("regD.num,
...
public class Insn35c extends AbstractInsn implements FiveRegInsn {
  ...
  protected BuilderInstruction getRealInsn0(LabelAssigner assigner) {
    ...
    return new BuilderInstruction35c(
        opc, regCount, regDNumber, regENumber, regFNumber, regGNumber, regANumber, referencedItem);
  }
