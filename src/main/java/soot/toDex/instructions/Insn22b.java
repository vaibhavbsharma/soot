...
/**
 * The "22b" instruction format: It needs two 16-bit code units, has two registers and is used for a
 * 8-bit literal (hence the "b" for "byte").<br>
 * <br>
...
public class Insn22b extends AbstractInsn implements TwoRegInsn {
  ...
  protected BuilderInstruction getRealInsn0(LabelAssigner assigner) {
    return new BuilderInstruction22b(
        opc, (short) getRegA().getNumber(), (short) getRegB().getNumber(), getLitC());
  }
