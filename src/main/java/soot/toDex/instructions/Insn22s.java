...
/**
 * The "22s" instruction format: It needs two 16-bit code units, has two registers and is used for a
 * 16-bit literal (hence the "s" for "short").<br>
 * <br>
...
public class Insn22s extends AbstractInsn implements TwoRegInsn {
  ...
  protected BuilderInstruction getRealInsn0(LabelAssigner assigner) {
    return new BuilderInstruction22s(
        opc, (byte) getRegA().getNumber(), (byte) getRegB().getNumber(), getLitC());
  }
