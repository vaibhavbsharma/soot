...
/**
 * Inspired by com.android.dx.dex.code.CodeAddress: pseudo instruction for use as jump target or
 * start/end of an exception handler range. It has size zero, so that its offset is the same as the
