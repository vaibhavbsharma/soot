...
/**
 * The "21t" instruction format: It needs two 16-bit code units, has one register and is used for
...
public class Insn21t extends InsnWithOffset implements OneRegInsn {
  ...
  protected BuilderInstruction getRealInsn0(LabelAssigner assigner) {
    return new BuilderInstruction21t(
        opc, (short) getRegA().getNumber(), assigner.getOrCreateLabel(target));
  }
