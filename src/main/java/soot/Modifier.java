...
/**
 * A class that provides static methods and constants to represent and work with with Java modifiers
 * (ie public, final,...) Represents Java modifiers as int constants that can be packed and combined
 * by bitwise operations and methods to query these.
 */
