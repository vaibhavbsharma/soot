...
class MethodBuilder extends JSRInlinerAdapter {
  ...
  public AnnotationVisitor visitParameterAnnotation(
      int parameter, final String desc, boolean visible) {
  ...
  public void visitMethodInsn(
      int opcode, String owner, String name, String desc, boolean isInterf) {
  ...
  public void visitEnd() {
    ...
    if (invisibleParamAnnotations != null) {
      VisibilityParameterAnnotationTag tag =
          new VisibilityParameterAnnotationTag(
              invisibleParamAnnotations.length, AnnotationConstants.RUNTIME_INVISIBLE);
    ...
    if (method.isConcrete()) {
      method.setSource(
          new AsmMethodSource(maxLocals, instructions, localVariables, tryCatchBlocks));
    }
  }
}
