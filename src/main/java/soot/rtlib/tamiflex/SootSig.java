...
public class SootSig {
  ...
  public static String sootSignature(Object receiver, Method m) {
    Class<?> receiverClass =
        Modifier.isStatic(m.getModifiers()) ? m.getDeclaringClass() : receiver.getClass();
    try {
      ...
      if (resolved == null) {
        Error error =
            new Error(
                "Method not found : " + m + " in class " + receiverClass + " and super classes.");
      ...
      if (res == null) {
        ...
        res =
            sootSignature(
                ...
                getTypeName(resolved.getReturnType()),
                resolved.getName(),
                paramTypes);
  ...
  private static String sootSignature(
      String declaringClass, String returnType, String name, String... paramTypes) {
