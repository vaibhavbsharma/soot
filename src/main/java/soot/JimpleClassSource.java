...
public class JimpleClassSource extends ClassSource {
  ...
  public Dependencies resolve(SootClass sc) {
    ...
    try {
      ...
      // set outer class if not set (which it should not be) and class name contains outer
      // class indicator
      ...
      // The method documentation states it returns RefTypes only, so this is a transformation
      // safe
      ...
      throw new RuntimeException(
          "Error: Failed to create JimpleAST from source input stream for class " + className + ".",
          e);
