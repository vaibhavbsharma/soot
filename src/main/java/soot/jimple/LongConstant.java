...
public class LongConstant extends ArithmeticConstant {
  ...
  public NumericConstant add(NumericConstant c) {
    if (!(c instanceof LongConstant)) throw new IllegalArgumentException("LongConstant expected");
  ...
  public IntConstant cmp(LongConstant c) {
    if (this.value > c.value) return IntConstant.v(1);
    else if (this.value == c.value) return IntConstant.v(0);
    else return IntConstant.v(-1);
  }
