...
public class CastCheckEliminator extends ForwardBranchedFlowAnalysis<LocalTypeSet> {
  ...
  /**
   * Find all the locals of reference type and all the types used in casts to initialize the mapping
   * from locals and types to bits in the bit vector in LocalTypeSet.
   */
  ...
  protected void flowThrough(
      LocalTypeSet in,
      Unit unit,
      List<LocalTypeSet> outFallValues,
