    ...
    if (fields != null && other.fields != null && !fields.isEmpty() && !other.fields.isEmpty()) {
      for (Object element : other.fields.keySet()) {
        ...
        if (fields.containsKey(field)) {
          ...
          if (pts1 instanceof FullObjectSet) ret.addFieldRef(pts2, field);
          else if (pts2 instanceof FullObjectSet) ret.addFieldRef(pts1, field);
            ...
            if ((pts1 instanceof PointsToSetInternal) && (pts2 instanceof PointsToSetInternal)) {
              ...
              final PointsToSetInternal newpti =
                  new HashPointsToSet(pti1.getType(), (PAG) Scene.v().getPointsToAnalysis());
  ...
  public boolean addFieldRef(PointsToSet otherBase, Object field) {
    ...
    if (base == null) {
      ...
      PointsToSetInternal newpti =
          new HashPointsToSet(
              ((PointsToSetInternal) otherBase).getType(), (PAG) Scene.v().getPointsToAnalysis());
      base = newpti;
