...
public class JavaLangRuntimeNative extends NativeMethodClass {
   ...
   */
  public void java_lang_Runtime_execInternal(
      SootMethod method,
      ReferenceVariable thisVar,
      ReferenceVariable returnVar,
      ReferenceVariable params[]) {
   ...
   *
   * <p>public native long freeMemory(); public native long totalMemory(); public native void gc();
   * private static native void runFinalization0(); public native void traceInstructions(boolean);
