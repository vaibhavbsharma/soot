...
public class JavaIoObjectInputStreamNative extends NativeMethodClass {
  ...
  /**
   * Following methods have NO side effect, (the last one?????) to be verified with serialization
   * and de-serialization.
   *
   * <p>private static native void bytesToFloats(byte[], int, float[], int, int); private static
   * native void bytesToDoubles(byte[], int, double[], int, int); private static native void
   * setPrimitiveFieldValues(java.lang.Object, long[], char[], byte[]); private static native void
