...
public class JavaLangSecurityManagerNative extends NativeMethodClass {
  ...
  /**
   * Returns the class loader of the most recently executing method from a class defined using a
   ...
   *
   * <p>protected native int classDepth(java.lang.String); private native int classLoaderDepth0();
   */
}
