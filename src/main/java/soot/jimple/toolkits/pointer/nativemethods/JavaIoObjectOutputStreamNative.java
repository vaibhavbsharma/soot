...
public class JavaIoObjectOutputStreamNative extends NativeMethodClass {
   ...
   *
   * <p>private static native void floatsToBytes(float[], int, byte[], int, int); private static
   * native void doublesToBytes(double[], int, byte[], int, int); private static native void
   * getPrimitiveFieldValues(java.lang.Object, long[], char[], byte[]);
   *
   * @see default(...)
   */
}
