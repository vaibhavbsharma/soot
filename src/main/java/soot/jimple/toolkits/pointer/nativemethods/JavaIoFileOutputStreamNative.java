...
public class JavaIoFileOutputStreamNative extends NativeMethodClass {
   ...
   *
   * <p>private native void open(java.lang.String) throws java.io.FileNotFoundException; private
   * native void openAppend(java.lang.String) throws java.io.FileNotFoundException; public native
   * void write(int) throws java.io.IOException; private native void writeBytes(byte[], int, int)
   * throws java.io.IOException; public native void close() throws java.io.IOException; private
