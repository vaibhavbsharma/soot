...
public class JavaLangDoubleNative extends NativeMethodClass {
  ...
  /** ************************ java.lang.Double ********************* */
  /**
   * Following methods have no side effects. public static native long doubleToLongBits(double);
   * public static native long doubleToRawLongBits(double); public static native double
