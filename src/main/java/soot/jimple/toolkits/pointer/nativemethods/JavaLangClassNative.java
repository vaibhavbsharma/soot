...
public class JavaLangClassNative extends NativeMethodClass {
  ...
  public void simulateMethod(
    ...
    if (subSignature.equals(
      ...
      return;
        ...
        "java.lang.reflect.Method getMethod0(java.lang.String,java.lang.Class[],int)")) {
      java_lang_Class_getMethod0(method, thisVar, returnVar, params);
      return;

    } else if (subSignature.equals(
        "java.lang.reflect.Constructor getConstructor0(java.lang.Class[],int)")) {
      ...
      return;
        ...
        "java.lang.reflect.Constructor[] getDeclaredConstructors0(boolean)")) {
   ...
   */
  public void java_lang_Class_forName0(
      SootMethod method,
      ReferenceVariable thisVar,
      ReferenceVariable returnVar,
      ReferenceVariable params[]) {
   ...
   */
  public void java_lang_Class_newInstance0(
      SootMethod method,
      ReferenceVariable thisVar,
      ReferenceVariable returnVar,
      ReferenceVariable params[]) {
   ...
   * int);
   */
  public void java_lang_Class_getMethod0(
      SootMethod method,
      ReferenceVariable thisVar,
      ReferenceVariable returnVar,
      ReferenceVariable params[]) {
   ...
   *
   * <p>private static native void registerNatives(); public native boolean
   * isInstance(java.lang.Object); public native boolean isAssignableFrom(java.lang.Class); public
   * native boolean isInterface(); public native boolean isArray(); public native boolean
   * isPrimitive(); public native int getModifiers();
   */
}
