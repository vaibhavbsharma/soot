...
public class JavaLangThreadNative extends NativeMethodClass {
   ...
   *
   * <p>private static native void registerNatives(); public static native void yield(); public
   * static native void sleep(long) throws java.lang.InterruptedException; public native
   * synchronized void start(); private native boolean isInterrupted(boolean); public final native
   * boolean isAlive(); public native int countStackFrames(); private native void setPriority0(int);
   * private native void stop0(java.lang.Object); private native void suspend0(); private native
   * void resume0(); private native void interrupt0();
   */
}
