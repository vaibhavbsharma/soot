 ...
 * {@link StrongLocalMustAliasAnalysis}, is guaranteed to represent a single runtime object within a
 * its declared method. If based on a (non-strong) {@link
...
public class InstanceKey {
  ...
  /**
   * Creates a new instance key representing the value stored in local, just before stmt. The
   * identity of the key is defined via lmaa, and its must-not-alias relationship to other keys via
   * lmna.
   *
  ...
  public InstanceKey(
    ...
    this.pts =
        new PointsToSetEqualsWrapper((EqualsSupportingPointsToSet) pta.reachingObjects(local));
  ...
  public String toString() {
    String instanceKeyString =
        stmtAfterAssignStmt != null
            ? lmaa.instanceKeyString(assignedLocal, stmtAfterAssignStmt)
            : "pts(" + hashCode + ")";
  ...
  protected int computeHashCode() {
    ...
    if (stmtAfterAssignStmt != null && (assignedLocal.getType() instanceof RefLikeType)) {
      ...
      result =
          prime * result + lmaa.instanceKeyString(assignedLocal, stmtAfterAssignStmt).hashCode();
  ...
  public boolean equals(Object obj) {
    ...
    return (stmtAfterAssignStmt == null
        && other.stmtAfterAssignStmt == null
