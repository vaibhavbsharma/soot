...
public class LocalMustNotAliasAnalysis
  ...
  /**
   * Returns true if this analysis has any information about local l at statement s (i.e. it is not
   * {@link #UNKNOWN}). In particular, it is safe to pass in locals/statements that are not even
   * part of the right method. In those cases <code>false</code> will be returned. Permits s to be
  ...
  /**
   * If the given local at the given statement was initialized with a single, concrete
   * new-expression then the type of this expression is returned. Otherwise this method returns
   * null.
   */
