...
public abstract class NativeHelper {
  ...
  /**
   * Returns a reference variable representing the array element of this variable. Now it does not
   * look at the array index.
   */
  ...
  /**
   * Returns a reference variable representing a static Java field. The implementation must ensure
   * that there is only one such representation for each static field.
   *
