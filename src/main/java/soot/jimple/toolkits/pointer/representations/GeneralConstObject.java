...
/**
 * A general constant object represents one of following environment objects: ClassLoader, Process,
 * Thread, ... Such environment constants are distinguished by name and managed by Environment.
 *
 * @author Feng Qian
 */
