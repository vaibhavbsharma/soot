...
/**
 * Environment simulates the VM environment such as objects representing classes, methods, fields,
 * and so on. There is only one:
 *
 * <p>java.lang.ClassLoader object, java.lang.Class object, java.lang.Field object, java.lang.Method
 * object, java.lang.Constructor object, java.lang.Process object, java.lang.Thread object,
 * java.io.FileSystem object
 *
 * <p>String objects are special, since there are other string constants. An unknown object has the
 * least type, same as array.
 *
 * <p>This class defines all abstract object as constants. Temporary variables can be obtained from
 * NativeHelper.
 *
 * @author Feng Qian
 */
