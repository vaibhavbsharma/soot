      ...
      if (s instanceof NopStmt) {
        ...
        if (lhs instanceof Local
          ...
          if (rhs instanceof CastExpr) {
            // CastExpr          : can trigger ClassCastException, but null-casts never
            // fail
            ...
            // ArrayRef          : can have side effects (like throwing a null pointer
            // exception)
            // InvokeExpr        : can have side effects (like throwing a null pointer
            // exception)
            ...
            isEssential =
                t2Int
                    || t1 instanceof IntType
                    || t1 instanceof LongType
                    || t2 instanceof LongType
                    || t1 instanceof UnknownType
