 ...
 * element of a lattice; this lattice might be described by a FlowUniverse. If add, remove, size,
 * isEmpty, toList and contains are implemented, the lattice must be the powerset of some set.
 */
