...
public final class CallGraphBuilder {
  ...
  /**
   * This constructor builds the incomplete hack call graph for the Dava ThrowFinder. It uses all
   * application class methods as entry points, and it ignores any calls by non-application class
   * methods. Don't use this constructor if you need a real call graph.
   */
  public CallGraphBuilder() {
    G.v()
        .out
        .println("Warning: using incomplete callgraph containing " + "only application classes.");
