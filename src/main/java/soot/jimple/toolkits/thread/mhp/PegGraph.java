 ...
 * node to peg June 18, 2003 modify the iterator() to be iterator for all nodes of PEG and
 * mainIterator() to be the iterator for main chain. June 12, 2003 add monitor Map, notifyAll Map,
 * waitingNodes Map.
 */
  ...
  */
  ...
  private boolean removeBeginNode() {
    ...
    if (heads.size() != 1) {
      ...
      heads.remove(0);
      // set the preds list of the succs of head to a new list and put succs of head into
      // heads
          ...
          if (predListOfSucc == null) {
            ...
            if (predListOfSucc.size() != 0) {
              ...
              if (pos > 0 || pos == 0) {
                ...
                //	System.out.println("remove stmt: "+stmt+" from the preds
                // list"+predListOfSucc+" of the succ");
  ...
  public List getPredsOf(Object s) {
    if (!unitToPreds.containsKey(s)) throw new RuntimeException("Invalid stmt" + s);
