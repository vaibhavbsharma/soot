...
public class MethodInliner {
  ...
  private static void inline(
      JPegStmt invokeStmt, Chain chain, PegGraph container, PegGraph inlinee) {
    // System.out.println("==inside inline===");
    //		PegToDotFile printer = new PegToDotFile(inlinee, false,
    // "before_addPeg_inlinee"+invokeStmt.getName());
