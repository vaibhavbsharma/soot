 ...
 * information collected by UnsynchronizedMhpAnalysis. A set of threads started from the same
 * location will be represented by one AbstractRuntimeThread, with runsMany set to true.
 */
public class AbstractRuntimeThread {
  ...
  public AbstractRuntimeThread() {
    ...
    // How we determined the parallelism - this is set unsafely, so analysis MUST set it
    // correctly
