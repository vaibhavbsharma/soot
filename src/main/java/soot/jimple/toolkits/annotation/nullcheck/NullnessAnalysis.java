...
public class NullnessAnalysis extends ForwardBranchedFlowAnalysis<NullnessAnalysis.AnalysisInfo> {
  ...
  private void handleIfStmt(
      JIfStmt ifStmt, AnalysisInfo in, AnalysisInfo out, AnalysisInfo outBranch) {
  ...
  private void handleEqualityOrNonEqualityCheck(
      AbstractBinopExpr eqExpr, AnalysisInfo in, AnalysisInfo out, AnalysisInfo outBranch) {
  ...
  private void handleInstanceOfExpression(
      JInstanceOfExpr expr, AnalysisInfo in, AnalysisInfo out, AnalysisInfo outBranch) {
    Value op = expr.getOp();
  ...
  private void handleRefTypeAssignment(DefinitionStmt assignStmt, AnalysisInfo out) {
    ...
    if (isAlwaysNonNull(right)
        ...
        || right instanceof ClassConstant
  ...
  /**
   * Returns <code>true</code> if the analysis could determine that i is always null before the
   * statement s.
   *
  ...
  /**
   * Returns <code>true</code> if the analysis could determine that i is always non-null before the
   * statement s.
   *
   * @param s a statement of the respective body
