 ...
 * this case h is the header and the loop consists of all statements s which reach t without passing
 * through h.
 *
 * @author Eric Bodden
 */
public class Loop {
  ...
  /**
   * Creates a new loop. Expects that the last statement in the list is the loop head and the
  ...
  /**
   * Returns all loop exists. A loop exit is a statement which has a successor that is not contained
   * in the loop.
   */
  ...
  /**
   * Computes all targets of the given loop exit, i.e. statements that the exit jumps to but which
