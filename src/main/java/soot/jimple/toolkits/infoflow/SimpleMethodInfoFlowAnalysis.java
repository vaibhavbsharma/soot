...
public class SimpleMethodInfoFlowAnalysis
  ...
  protected List<Value> handleInvokeExpr(
      InvokeExpr ie, Stmt is, FlowSet<Pair<EquivalentValue, EquivalentValue>> fs) {
    // get the data flow graph
    MutableDirectedGraph<EquivalentValue> dataFlowGraph =
