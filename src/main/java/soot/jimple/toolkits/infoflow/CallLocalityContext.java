 ...
 * information collected about a call site by one of the Local Objects Analyses.
 */
public class CallLocalityContext {
  ...
  // merges two contexts into one... shared fields in either context are shared in the merged
  // context
