...
public class AugHierarchy implements IHierarchy {
  ...
  public static Collection<Type> lcas_(Type a, Type b) {
    if (TypeResolver.typesEqual(a, b)) return Collections.<Type>singletonList(a);
      ...
      if (a instanceof Integer1Type) return Collections.<Type>singletonList(b);
      else if (b instanceof Integer1Type) return Collections.<Type>singletonList(a);
      ...
      else if (ancestor_(a, b)) return Collections.<Type>singletonList(a);
  ...
  public static boolean ancestor_(Type ancestor, Type child) {
    if (TypeResolver.typesEqual(ancestor, child)) return true;
      ...
      if (child instanceof BottomType
          ...
          || child instanceof Integer127Type) return true;
      else return false;
    } else if (ancestor instanceof CharType) {
      if (child instanceof BottomType
          || child instanceof Integer1Type
          || child instanceof Integer127Type
          || child instanceof Integer32767Type) return true;
      else return false;
      ...
      if (child instanceof BottomType
          ...
          || child instanceof ByteType) return true;
      else return false;
      ...
      if (child instanceof BottomType
          ...
          || child instanceof ShortType) return true;
      else return false;
