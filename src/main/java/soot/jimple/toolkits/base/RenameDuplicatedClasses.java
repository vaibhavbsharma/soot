 ...
 * classes are missing and consequently case problems for other analysis tools that relay on Soot
 * (e.g., Error: class com.adwo.adsdk.s read in from a classfile in which com.adwo.adsdk.S was
 * expected).
 */
