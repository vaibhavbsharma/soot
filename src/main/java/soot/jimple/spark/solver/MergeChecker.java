...
/**
 * Checks points-to sets with pointer assignment graph to make sure everything has been correctly
 * propagated.
 *
  ...
  protected void checkNode(Node container, Node n, Node upstream) {
    ...
    if (!p2set.contains(n)
      ...
      G.v()
          .out
          .println(
              "Check failure: " + container + " does not have " + n + "; upstream is " + upstream);
    }
  }
