...
/**
 * Implementation of a points-to set as a sorted list of elements, but where similar lists share
 * parts of their data.
 */
public class SharedListSet extends PointsToSetInternal {
  ...
  private ListNode union(
      ListNode first, ListNode other, ListNode exclude, BitVector mask, boolean detachChildren) {
