...
public class GlobalNodeFactory {
  ...
  public final Node caseDefaultClassLoader() {
    ...
    VarNode v =
        pag.makeGlobalVarNode(
            PointsToAnalysis.DEFAULT_CLASS_LOADER_LOCAL, RefType.v("java.lang.ClassLoader"));
    pag.addEdge(a, v);
    return v;
  }
  ...
  public final Node caseMainClassNameString() {
    AllocNode a =
        pag.makeAllocNode(
            PointsToAnalysis.MAIN_CLASS_NAME_STRING, RefType.v("java.lang.String"), null);
    VarNode v =
        pag.makeGlobalVarNode(
            PointsToAnalysis.MAIN_CLASS_NAME_STRING_LOCAL, RefType.v("java.lang.String"));
    pag.addEdge(a, v);
    return v;
  }
  ...
  public final Node caseMainThreadGroup() {
    AllocNode threadGroupNode =
        pag.makeAllocNode(
            PointsToAnalysis.MAIN_THREAD_GROUP_NODE, RefType.v("java.lang.ThreadGroup"), null);
    VarNode threadGroupNodeLocal =
        pag.makeGlobalVarNode(
            PointsToAnalysis.MAIN_THREAD_GROUP_NODE_LOCAL, RefType.v("java.lang.ThreadGroup"));
  ...
  public final Node caseCanonicalPath() {
    AllocNode a =
        pag.makeAllocNode(PointsToAnalysis.CANONICAL_PATH, RefType.v("java.lang.String"), null);
    VarNode v =
        pag.makeGlobalVarNode(PointsToAnalysis.CANONICAL_PATH_LOCAL, RefType.v("java.lang.String"));
    pag.addEdge(a, v);
    return v;
  }

  public final Node caseMainThread() {
    AllocNode threadNode =
        pag.makeAllocNode(PointsToAnalysis.MAIN_THREAD_NODE, RefType.v("java.lang.Thread"), null);
    VarNode threadNodeLocal =
        pag.makeGlobalVarNode(
            PointsToAnalysis.MAIN_THREAD_NODE_LOCAL, RefType.v("java.lang.Thread"));
  ...
  public final Node caseArgv() {
    ...
    VarNode sanl =
        pag.makeGlobalVarNode(
            ...
            ArrayType.v(RefType.v("java.lang.String"), 1));
    AllocNode stringNode =
        pag.makeAllocNode(PointsToAnalysis.STRING_NODE, RefType.v("java.lang.String"), null);
    VarNode stringNodeLocal =
        pag.makeGlobalVarNode(PointsToAnalysis.STRING_NODE_LOCAL, RefType.v("java.lang.String"));
  ...
  public Node caseThrow() {
    VarNode ret =
        pag.makeGlobalVarNode(PointsToAnalysis.EXCEPTION_NODE, RefType.v("java.lang.Throwable"));
