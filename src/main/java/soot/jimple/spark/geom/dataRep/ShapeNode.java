...
/**
 * It is the the abstract super type of geometric figures and the manager of all the generated
 * sub-type figures. It is not used currently and we leave it here as an extensible point in future.
 *
 * @author xiao
 */
public abstract class ShapeNode {
  ...
  // E1: the end coordinate of the X or Y axis depending on the value of I1 and I2 (I1 != 0, then
  // E1 is associated with I1)
  public long I1;
  public long I2;
  public long E1;
