 ...
 * permit the deletion of objects from the array container. And most importantly, we permits the
 * search for a particular object efficiently. Therefore, this class supports efficiently insert,
...
public class ZArrayNumberer<E extends Numberable> implements IterableNumberer<E>, Iterable<E> {
  ...
  /**
   * The removed objects cause some empty slots. We shift the objects to the empty slots in order to
   * ensure ids of the objects are less than the filledCells.
   */
