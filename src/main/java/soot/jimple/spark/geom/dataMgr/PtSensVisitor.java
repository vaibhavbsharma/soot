...
public abstract class PtSensVisitor<VarType extends ContextVar> {
  ...
  /**
   * We use visitor pattern to collect contexts. Derived classes decide how to deal with the
   * variable with the contexts [L, R). Returning false means this interval [L, R) is covered by
   * other intervals.
   *
   * @param var
   * @param L
