...
public class FullSensitiveNodeGenerator extends IEncodingBroker {
  ...
  public void initFlowGraph(GeomPointsTo ptAnalyzer) {
      ...
      switch (cons.type) {
        case Constants.NEW_CONS:
          ...
          if (code == 0) {
            ...
            my_rhs.add_points_to_3(
                (AllocNode) my_lhs.getWrappedNode(), 1, 1, ptAnalyzer.context_size[nf1]);
          } else {
            // Assigned to a global or the object itself is a global
            my_rhs.add_points_to_4(
        ...
        case Constants.ASSIGN_CONS:
          ...
          if (cons.interCallEdges != null) {
              ...
              if (nf2 == q.t) {
                ...
                if (nf1 == Constants.SUPER_MAIN) {
                  my_lhs.add_simple_constraint_4(
                      my_rhs, 1, q.map_offset, 1, ptAnalyzer.max_context_size_block[q.s]);
                } else {
                  // nf1 == q.s
            ...
            // And, the assignments involving the global variables go here. By our
            // definition, the global variables belong to SUPER_MAIN.
            ...
            if (code == 0) {
              ...
              my_lhs.add_simple_constraint_4(
                  my_rhs, 1, 1, ptAnalyzer.context_size[nf1], ptAnalyzer.context_size[nf2]);
            }
          }
          break;
    ...
    ptAnalyzer.ps.printf(
        "Only %d (%.1f%%) constraints are needed for this run.\n",
