...
/**
 * The figure manager for the PtIns descriptors. The implementation is almost same to the HeapIns
 * manager, please refer to HeapInsIntervalManager for more detailed comments.
 *
 * @author xiao
 */
public class PtInsIntervalManager extends IFigureManager {
  ...
  private SegmentNode generate_many_to_all(SegmentNode mp) {
    ...
    // Note, left could be 0. In that case, the propagation along this edge becomes totally
    // insensitive
    mp.I1 = left;
    mp.I2 = 0;
    mp.L = right - left;
