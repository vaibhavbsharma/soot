...
/**
 * A FIFO queue of objects, implemented as a circular buffer. NOTE: elements stored in the buffer
 * should be non-null; this is not checked for performance reasons.
 *
...
public final class FIFOQueue {
  ...
  /**
   * point to current bottom of buffer, where things will be added invariant: after call to add /
   * remove, should always point to an empty slot in the buffer
   */
  private int _bottom;
