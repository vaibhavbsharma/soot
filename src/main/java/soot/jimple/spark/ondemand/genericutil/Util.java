...
public class Util {
  ...
  /**
   * Filter a collection: generate a new list from an existing collection, consisting of the
   * elements satisfying some predicate. The new list is always an {@link ArrayList}; it would have
   * been more precise to use {@link java.lang.reflect reflection} to create a list of the same type
   * as 'srcList', but reflection works really slowly in some implementations, so it's best to avoid
   * it.
   */
