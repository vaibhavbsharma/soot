...
public final class AllocAndContextSet extends ArraySet<AllocAndContext>
  ...
  public boolean hasNonEmptyIntersection(PointsToSet other) {
    if (other instanceof AllocAndContextSet) {
      ...
      return ((PointsToSetInternal) other)
          .forall(
              new P2SetVisitor() {
    ...
    throw new UnsupportedOperationException(
        "can't check intersection with set of type " + other.getClass());
  }
  ...
  /**
   * Returns <code>true</code> if <code>onePts</code> is a (non-strict) superset of <code>otherPts
   * </code>.
   */
