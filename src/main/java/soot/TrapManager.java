...
public class TrapManager {
  ...
  /**
   * Splits all traps so that they do not cross the range rangeStart - rangeEnd. Note that
  ...
  /**
   * Given a body and a unit handling an exception, returns the list of exception types possibly
