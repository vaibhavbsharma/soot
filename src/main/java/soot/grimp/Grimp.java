...
public class Grimp {
  ...
  /**
   * Constructs a new Trap for the given exception on the given Stmt range with the given Stmt
   * handler.
   */
  ...
  public Trap newTrap(Trap trap) {
    return new GTrap(
        trap.getException(), trap.getBeginUnit(),
