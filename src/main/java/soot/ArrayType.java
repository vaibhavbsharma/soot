...
/**
 * A class that models Java's array types. ArrayTypes are parametrized by a Type and and an integer
 * representing the array's dimension count.. Two ArrayType are 'equal' if they are parametrized
 * equally.
 */
...
public class ArrayType extends RefLikeType {
  ...
  /**
   * Two ArrayType are 'equal' if they are parametrized identically. (ie have same Type and
   * dimension count.
   *
