 ...
 * (possibly) exceptional control flow between <tt>Unit</tt>s.
 *
...
public abstract class UnitGraph implements DirectedGraph<Unit> {
   ...
   * tails to include all <tt>Unit</tt>s with no successors. Subclasses of <code>UnitGraph
   * </code> may override this method to change the criteria for classifying a node as a head or
   * tail.
   */
