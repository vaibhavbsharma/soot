...
public class BlockGraphConverter {
  /**
   * Transforms a multi-headed and/or multi-tailed BlockGraph to a single-headed singled-tailed
   * BlockGraph by inserting a dummy start and stop nodes.
   */
  ...
  /**
   * Reverses a BlockGraph by making the heads tails, the tails heads and reversing the edges. It
   * does not change the ordering of Units in individual blocks, nor does it change the Block
   * labels. This utility could be useful when calculating control dependences with a dominators
   * algorithm.
   */
