 ...
 *
 * <p>Note that this interface should evolve based on the need.
 *
...
public interface ProgramDependenceGraph extends MutableEdgeLabelledDirectedGraph<PDGNode, String> {
  ...
  /**
   * @return A List of weak regions, generated by RegionAnalysis for the corresponding control flow
   *     graph (These are Regions and not PDGRegions.)
   */
  ...
  /**
   * @return The root node of the PDG, which is essentially the same as the start region but
   *     packaged in its PDGNode, which can be used to traverse the graph, etc.
   */
  ...
  /**
   * This method returns the PDGNode in the PDG corresponding to the given CFG node. Note that
   * currently the CFG node has to be a Block.
   *
