...
public class DominatorTree<N> implements Iterable<DominatorNode<N>> {
  ...
  /**
   * Gets the first head of the dominator tree. This function is implemented for single-headed trees
   * and mainly for backwards compatibility.
   *
  ...
  public DominatorNode<N> getDode(N gode) {
    ...
    if (dode == null) {
      throw new RuntimeException(
          "Assertion failed: Dominator tree does not have a corresponding dode for gode ("
              + gode
              + ")");
    }
