 ...
 * control flow. Control flow associated with exceptions is ignored, so the graph will be a forest
...
public class BriefBlockGraph extends BlockGraph {
  ...
  /**
   * Constructs a {@link BriefBlockGraph} representing the <tt>Unit</tt>-level control flow
