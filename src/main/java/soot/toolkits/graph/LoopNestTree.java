 ...
 * and the respective loop. The iterator over this collection returns the loop in such an order that
...
public class LoopNestTree extends TreeSet<Loop> {
  ...
  /**
   * Comparator, stating that a loop l1 is smaller than a loop l2 if l2 contains all statements of
   * l1.
   *
   * @author Eric Bodden
   */
