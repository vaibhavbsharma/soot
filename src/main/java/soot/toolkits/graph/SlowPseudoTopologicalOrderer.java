 ...
 * PseudoTopologicalOrderer; however, this class considers the order of successors. It runs slower
 * but more precise. Currently it was only used by ArrayBoundsCheckerAnalysis to reduce the
 * iteration numbers.
 *
