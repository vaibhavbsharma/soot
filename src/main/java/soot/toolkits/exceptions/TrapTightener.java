 ...
 * an exception caught by the {@link Trap} and ends just after the last {@link Unit} which might
 * throw an exception caught by the {@link Trap}. In the case where none of the {@link Unit}s
...
public final class TrapTightener extends TrapTransformer {
  ...
  /**
   * A utility routine which determines if a particular {@link Unit} might throw an exception to a
   * particular {@link Trap}, according to the information supplied by a particular control flow
   * graph.
   *
