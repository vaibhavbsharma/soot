 ...
 * implicit exceptions are possible for bytecode instructions other than <code>athrow</code>). The
 * <code>mightThrowExplicitly()</code> and <code>mightThrowImplicitly()</code> methods allow
 * analyses to exploit any extra precision that may be gained by distinguishing between an <code>
 * athrow</code>'s implicit and explicit exceptions.
 */
public interface ThrowAnalysis {
  ...
  /**
   * Returns a set representing the {@link Throwable} types that the specified throw instruction
   * might throw explicitly, that is, the possible types for its <code>Throwable</code> argument.
   *
  ...
  /**
   * Returns a set representing the {@link Throwable} types that the specified throw statement might
   * throw explicitly, that is, the possible types for its <code>Throwable</code> argument.
   *
  ...
  /**
   * Returns a set representing the {@link Throwable} types that the specified throw instruction
   * might throw implicitly, that is, the possible types of errors which might arise in the course
   * of executing the <code>throw</code> instruction, rather than the type of the <code>throw
   * </code>'s operand.
   *
   * @param t {@link ThrowStmt} whose implicit exceptions are to be returned.
  ...
  /**
   * Returns a set representing the {@link Throwable} types that the specified throw statement might
   * throw implicitly, that is, the possible types of errors which might arise in the course of
   * executing the <code>throw</code> statement, rather than the type of the <code>throw</code> 's
   * operand.
   *
   * @param t {@link ThrowStmt} whose implicit exceptions are to be returned.
   * @return a representation of the types of exceptions that <code>t</code> might throw implicitly.
