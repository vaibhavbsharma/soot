...
/**
 * Represents bounded information for flow analysis. Just like FlowSet, but also provides
 * complementation. Some implementations of BoundedFlowSet may require a FlowUniverse for
 * construction.
 *
 * @see: FlowUniverse
 */
