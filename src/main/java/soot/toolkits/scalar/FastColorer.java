...
public class FastColorer {
  /**
   * Provides a coloring for the locals of <code>unitBody</code>, attempting to not split locals
   * assigned the same name in the original Jimple.
   */
  public static void unsplitAssignColorsToLocals(
      Body unitBody,
    ...
    ExceptionalUnitGraph unitGraph =
        new ExceptionalUnitGraph(
            unitBody, PedanticThrowAnalysis.v(), Options.v().omit_excepting_unit_edges());
