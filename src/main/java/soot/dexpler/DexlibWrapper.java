...
public class DexlibWrapper {
  ...
  public DexlibWrapper(File dexSource) {
    try {
      List<DexFileProvider.DexContainer> containers =
          DexFileProvider.v().getDexFromSource(dexSource);
  ...
  public void initialize() {
    ...
    // It is important to first resolve the classes, otherwise we will produce an error during
    // type resolution.
    for (DexBackedDexFile dexFile : dexFiles) {
