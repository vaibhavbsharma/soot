 ...
 * parameter types as well as the encoded method itself.
 */
public class DexMethod {
  ...
  public static SootMethod makeSootMethod(
    ...
    if (sm == null) {
      sm =
          Scene.v().makeSootMethod(name, parameterTypes, returnType, accessFlags, thrownExceptions);
    }
