...
public class DexReturnInliner extends DexTransformer {
  ...
  /**
   * Gets the set of return statements that can be reached via fall-throughs, i.e. normal sequential
   * code execution. Dually, these are the statements that can be reached without jumping there.
   *
