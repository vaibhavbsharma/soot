...
public class Util {
  ...
  /**
   * Insert a runtime exception before unit u of body b. Useful to analyze broken code (which make
   * reference to inexisting class for instance) exceptionType: e.g., "java.lang.RuntimeException"
   */
