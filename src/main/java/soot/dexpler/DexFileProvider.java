...
public class DexFileProvider {
  ...
  private static final Comparator<DexContainer> DEFAULT_PRIORITIZER =
      new Comparator<DexContainer>() {
   ...
   * @return List of dex files derived from source
   */
  public List<DexContainer> getDexFromSource(File dexSource, Comparator<DexContainer> prioritizer)
      throws IOException {
  ...
  public DexContainer getDexFromSource(File dexSource, String dexName) throws IOException {
    ...
    throw new CompilationDeathException(
        "Dex file with name '" + dexName + "' not found in " + dexSource);
  }
  ...
  private Map<String, DexContainer> mappingForFile(File dexSourceFile) throws IOException {
    ...
    // classes.dex file in single dex mode
