...
public class ValueTemplatePrinter implements JimpleValueSwitch {
  ...
  public void caseMethodHandle(MethodHandle handle) {
    throw new UnsupportedOperationException(
        "we have not yet determined how to print Java 7 method handles");
  }
  ...
  public void caseInstanceOfExpr(InstanceOfExpr v) {
    ...
    p.println(
        "Value " + oldName + " = Jimple.v().newInstanceOfExpr(" + lhsName + "," + rhsName + ");");
  ...
  public void caseNewArrayExpr(NewArrayExpr v) {
    ...
    p.println(
        "Value " + oldName + " = Jimple.v().newNewArrayExpr(" + lhsName + ", " + sizeName + ");");
    varName = oldName;
  }
  ...
  public void caseArrayRef(ArrayRef v) {
    ...
    p.println(
        "Value " + oldName + " = Jimple.v().newArrayRef(" + baseName + ", " + indexName + ");");
    varName = oldName;
  }
