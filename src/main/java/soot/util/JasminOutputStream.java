...
/**
 * An output stream that wraps an existing output stream, and converts Jasmin code written into a
 * class file that gets written to the original output stream. (Write Jasmin into this stream, and
 * .class will come out.)
 */
