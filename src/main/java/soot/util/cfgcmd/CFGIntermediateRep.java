...
/**
 * An enumeration type for representing the varieties of intermediate representation available, for
 * use in tools that compare or display control flow graphs.
 */
public abstract class CFGIntermediateRep extends CFGOptionMatcher.CFGOption {
  ...
  /**
   * Returns a string containing the names of all the available <code>CFGIntermediateRep</code>s,
