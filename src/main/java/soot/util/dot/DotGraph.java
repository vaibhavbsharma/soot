...
public class DotGraph implements Renderable {
   ...
   *
   * @param filename the name for the output file. By convention, it should end with DOT_EXTENSION,
  ...
  /**
   * Draws a directed edge (including the source and end nodes, if they have not already been
   * drawn).
   *
   ...
   * @return the node with the specified name, adding a new node to the graph if there is no such
   *     node.
   */
   ...
   * sets any general attributes
   *
   * @param attr a {@link DotGraphAttribute} specifying the attribute name and value.
   */
