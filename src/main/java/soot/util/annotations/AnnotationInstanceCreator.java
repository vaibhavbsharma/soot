 ...
 * annotation interface represented by the given {@link AnnotationTag}.
 *
...
public class AnnotationInstanceCreator {
   ...
   *
   * @param tag the soot internal representation of the annotation to be created.
   * @return an Object extending {@link Proxy} and implementing the type of <code>tag</code>
   * @throws RuntimeException if
   *                          <ul>
   *                          <li>the class defined in {@link AnnotationTag#getType()} of <code>tag</code> could not be
   *                          loaded.
   *                          <li><code>tag</code> does not define all required methods of the annotation loaded.
   *                          <li>a class defined within a {@link AnnotationElem} could not be loaded.
   *                          <li>the enum defined in {@link AnnotationEnumElem} is no instance of {@link Enum}.
   *                          </ul>
   */
              ...
              new AbstractInvocationHandler() {
                ...
                protected Object handleInvocation(Object proxy, Method method, Object[] args)
                  ...
                  throw new RuntimeException(
                      "No value for " + name + " declared in the annotation " + clazz);
                }
              });
