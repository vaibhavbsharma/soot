...
public class ASTIfElseNode extends ASTControlFlowNode {
  ...
  public ASTIfElseNode(
      SETNodeLabel label, ConditionExpr condition, List<Object> ifBody, List<Object> elseBody) {
  ...
  */
  public ASTIfElseNode(
      SETNodeLabel label, ASTCondition condition, List<Object> ifBody, List<Object> elseBody) {
    super(label, condition);
    this.ifBody = ifBody;
    this.elseBody = elseBody;
