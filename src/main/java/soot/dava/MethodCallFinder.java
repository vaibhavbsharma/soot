...
public class MethodCallFinder extends DepthFirstAdapter {
      ...
      if (replaced) {
        ...
        if (defFinder.anyFinalFieldDefined()) {
          ...
          if (runtime.declaresMethod("void <init>(java.lang.String)")) {
            ...
            StringConstant tempString =
                StringConstant.v(
                    "This method used to have a definition of a final variable. "
  ...
  public boolean replaceSubBody(
      InvokeStmt s, List<ASTStatementSequenceNode> newChangedBodyPart, ASTParentNodeFinder finder) {
  ...
  public List<ASTStatementSequenceNode> createChangedBodyPart(
      InvokeStmt s, List body, ASTParentNodeFinder finder) {
