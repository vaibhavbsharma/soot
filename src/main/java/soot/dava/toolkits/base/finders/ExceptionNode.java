...
public class ExceptionNode {
  ...
  public ExceptionNode(
      IterableSet<AugmentedStmt> tryBody, SootClass exception, AugmentedStmt handlerAugmentedStmt) {
  ...
  public void splitOff_ExceptionNode(
    ...
    for (ExceptionNode en : enlist) {
      ...
      if (catchBody.isSupersetOf(en.get_Body())) {
        ...
        enlist.addLast(
            new ExceptionNode(
                clonedTryBody, en.exception, asg.get_CloneOf(en.handlerAugmentedStmt)));
      }
    }
