...
public class CycleFinder implements FactFinder {
  ...
  private AugmentedStmt find_CharacterizingStmt(
      AugmentedStmt entry_point, IterableSet<AugmentedStmt> sc_component, AugmentedStmtGraph asg) {
    /*
  ...
  private IterableSet<AugmentedStmt> get_CycleBody(
      AugmentedStmt entry_point,
  ...
  private void fix_MultiEntryPoint(
      DavaBody body,
      AugmentedStmtGraph asg,
      LinkedList<AugmentedStmt> entry_points,
  ...
  private void DFS(
      AugmentedStmt as,
      HashSet<AugmentedStmt> touchSet,
