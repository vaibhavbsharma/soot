...
public class EmptyElseRemover {
  ...
  public static void removeElseBody(
      ASTNode node, ASTIfElseNode ifElseNode, int subBodyNumber, int nodeNumber) {
  ...
  public static List<Object> createNewNodeBody(
    ...
    if (!(toRemove instanceof ASTIfElseNode)) {
      ...
      ASTIfNode newNode =
          new ASTIfNode(
              toRemoveNode.get_Label(), toRemoveNode.get_Condition(), toRemoveNode.getIfBody());
