...
public class SuperFirstStmtHandler extends DepthFirstAdapter {
  ...
  public boolean changeOriginalAST() {
    ...
    DStaticInvokeExpr newInvokeExpr =
        new DStaticInvokeExpr(newSootPreInitMethod.makeRef(), argsOneValues);
    ...
    InstanceInvokeExpr tempExpr =
        new DSpecialInvokeExpr(
            originalConstructorExpr.getBase(), newConstructor.makeRef(), thisArgList);
  ...
  private boolean createCallToSuper() {
    ...
    DVirtualInvokeExpr virtualInvoke =
        new DVirtualInvokeExpr(
            originalConstructorExpr.getBase(),
    ...
    if (tempType instanceof RefType) {
      ...
      if (t == BooleanType.v()) {
        ...
        SootMethod tempMethod =
            Scene.v().makeSootMethod("booleanValue", new ArrayList(), BooleanType.v());
        ...
        return new DVirtualInvokeExpr(
            tempExpr, tempMethodRef, new ArrayList(), new HashSet<Object>());
      } else if (t == ByteType.v()) {
        Value tempExpr = new GCastExpr(tempInvokeExpr, RefType.v("java.lang.Byte"));
        // byteValue

        SootMethod tempMethod =
            Scene.v().makeSootMethod("byteValue", new ArrayList(), ByteType.v());
        ...
        SootMethod tempMethod =
            Scene.v().makeSootMethod("charValue", new ArrayList(), CharType.v());
        ...
        SootMethod tempMethod =
            Scene.v().makeSootMethod("doubleValue", new ArrayList(), DoubleType.v());
        ...
        SootMethod tempMethod =
            Scene.v().makeSootMethod("floatValue", new ArrayList(), FloatType.v());
        ...
        SootMethod tempMethod =
            Scene.v().makeSootMethod("longValue", new ArrayList(), LongType.v());
        ...
        SootMethod tempMethod =
            Scene.v().makeSootMethod("shortValue", new ArrayList(), ShortType.v());
  ...
  private boolean finalizePreInitMethod() {
    ...
    if (subBodies.size() != 1) return false;
  ...
  public void createNewASTConstructor(ASTStatementSequenceNode initNode) {
    ...
    for (AugmentedStmt as : originalASTMethod.getDeclarations().getStatements()) {
      ...
      newConstructorDeclarations.add(
          new AugmentedStmt((DVariableDeclarationStmt) varDecStmt.clone()));
    }
  ...
  private void createSootPreInitMethod() {
    ...
    newSootPreInitMethod =
        Scene.v()
            .makeSootMethod(
                uniqueName, argsOneTypes, (new SootClass("DavaSuperHandler")).getType());
  ...
  private String getUniqueName() {
    ...
    while (!done) { // as long as name not found
      ...
      while (it.hasNext()) {
        ...
        } else throw new DecompilationException("SootClass returned a non SootMethod method");
      }
  ...
  private void createDavaStoreStmts() {
    ...
    while (localIt.hasNext()) {
      ...
      AugmentedStmt toAdd =
          createStmtAccordingToType(local.getType(), local, newLocal, getMethodRef);
      davaHandlerStmts.add(toAdd);
    }
  ...
  public AugmentedStmt createStmtAccordingToType(
      Type tempType, Value tempVal, Local newLocal, SootMethodRef getMethodRef) {
    if (tempType instanceof RefType) {
      ...
      if (t == BooleanType.v()) {
        ...
        DNewInvokeExpr argForStore =
            new DNewInvokeExpr(
                RefType.v("java.lang.Boolean"), makeMethodRef("Boolean", typeList), argList);
        ...
        DNewInvokeExpr argForStore =
            new DNewInvokeExpr(
                RefType.v("java.lang.Byte"), makeMethodRef("Byte", typeList), argList);
        ...
        DNewInvokeExpr argForStore =
            new DNewInvokeExpr(
                RefType.v("java.lang.Character"), makeMethodRef("Character", typeList), argList);
        ...
        DNewInvokeExpr argForStore =
            new DNewInvokeExpr(
                RefType.v("java.lang.Double"), makeMethodRef("Double", typeList), argList);
        ...
        DNewInvokeExpr argForStore =
            new DNewInvokeExpr(
                RefType.v("java.lang.Float"), makeMethodRef("Float", typeList), argList);
        ...
        DNewInvokeExpr argForStore =
            new DNewInvokeExpr(
                RefType.v("java.lang.Integer"), makeMethodRef("Integer", typeList), argList);
        ...
        DNewInvokeExpr argForStore =
            new DNewInvokeExpr(
                RefType.v("java.lang.Long"), makeMethodRef("Long", typeList), argList);
        ...
        DNewInvokeExpr argForStore =
            new DNewInvokeExpr(
                RefType.v("java.lang.Short"), makeMethodRef("Short", typeList), argList);
      ...
      throw new DecompilationException(
          "The type:" + tempType + " is neither a reftype or a primtype");
    }
  }
  ...
  private AugmentedStmt createAugmentedStmtToAdd(
      Local newLocal, SootMethodRef getMethodRef, Value tempVal) {
    ArrayList tempArgList = new ArrayList();
