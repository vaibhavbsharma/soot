...
public class UselessAbruptStmtRemover extends DepthFirstAdapter {
  ...
  public void caseASTStatementSequenceNode(ASTStatementSequenceNode node) {
    ...
    while (it.hasNext()) {
      ...
      if (temp == null) {
        continue;
        // throw new DecompilationException("Could not find target for abrupt
        // stmt"+abrupt.toString());
      }
      ...
      while (ancestor != target) {
        ...
        if (ancestorsParent instanceof ASTWhileNode
            || ancestorsParent instanceof ASTDoWhileNode
