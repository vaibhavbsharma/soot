...
public class OrAggregatorThree {
  ...
  public static void checkAndTransform(
  ...
  public static List<Object> createNewNodeBody(
      List<Object> oldSubBody, int nodeNumber, ASTIfNode ifOne, ASTIfNode ifTwo) {
  ...
  */
  private static boolean matchPattern(ASTIfNode one, ASTIfNode two) {
    ...
    if (!(onlyASTNodeOne instanceof ASTStatementSequenceNode)
        || !(onlyASTNodeTwo instanceof ASTStatementSequenceNode)) {
