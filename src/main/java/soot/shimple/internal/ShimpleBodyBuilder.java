...
public class ShimpleBodyBuilder {
   ...
   * by the next functions. Must be called after trivial nodes have been added.
   */
  ...
  /**
   * Clever convenience function to fetch or create new Local's given a Local and the desired
   * subscript.
   */
  ...
  /**
   * Convenient function that maps new Locals to the originating Local, and finds the appropriate
   * array index into the naming structures.
   */
  ...
  /**
   * Make sure the locals in the given body all have unique String names. Renaming is done if
   * necessary.
   */
