...
public class SPatchingChain extends PatchingChain<Unit> {
  ...
  /**
   * NOTE: This will *miss* all the Phi nodes outside a chain. So make sure you know what you are
   * doing if you remove a Phi node from a chain and don't put it back or call clearUnitBoxes() on
   * it.
   */
  ...
  protected class SPatchingIterator extends PatchingIterator {
    ...
    public void remove() {
      ...
      if ((successor = (Unit) getSuccOf(victim)) == null) successor = (Unit) getPredOf(victim);
