...
public class ShimpleLocalDefs implements LocalDefs {
  ...
  /**
   * Build a LocalDefs interface from a ShimpleBody. Proper SSA form is required, otherwise correct
  ...
  /**
   * Returns the definition site for a Local at a certain point (Unit) in a method as a singleton
   * list.
   *
