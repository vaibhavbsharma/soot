 ...
 * for classes that wish to transform a Body. Subclasses provide the actual Body transformation
 * implementation.
 */
public abstract class BodyTransformer extends Transformer {
  ...
  /**
   * Called by clients of the transformation. Acts as a generic interface for BodyTransformers.
