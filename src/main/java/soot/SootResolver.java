...
public class SootResolver {
  ...
  /**
   * Returns a (possibly not yet resolved) SootClass to be used in references to a class. If/when
  ...
  /**
   * Resolves the given class. Depending on the resolver settings, may decide to resolve other
   * classes as well. If the class has already been resolved, just returns the class that was
   * already resolved.
   */
      ...
      if (modelAsPhantomRef) {
        if (!Scene.v().allowsPhantomRefs()) {
          ...
          if (className.equals("java.lang.Object")) {
            suffix =
                " Try adding rt.jar to Soot's classpath, e.g.:\n"
  ...
  /**
   * Bodies - we can now start loading the bodies of methods for all referred to methods and fields
   * in the bodies, requires signatures for the method receiver and field container, and hierarchy
   * for all other classes referenced in method references. Current implementation does not
   * distinguish between the receiver and other references. Therefore, it is conservative and brings
