...
/**
 * An enumeration of a Utf8 allows one to run through the characters in a unicode string; used
 * primarily for comparing unicode strings. Note that unlike regular enumerations, and to be
...
public class Utf8_Enumeration implements Enumeration {
  ...
  /**
   * For creating an empty enumeration; you must use reset() after this to initialize the
   * enumeration.
   *
