...
class exception_table_entry {
  ...
  /**
   * Constant pool index of a CONSTANT_Class entry describing the exception this handler handles; if
   * 0, this handler catches all exceptions.
   *
   * @see CONSTANT_Class
   */
  ...
  /**
   * First Instruction object (after parsing) of code not protected by this handler (or <i>null</i>
   * for the end of code).
   *
