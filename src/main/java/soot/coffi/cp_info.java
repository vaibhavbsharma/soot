...
abstract class cp_info {
  ...
  /**
   * Locates the name of the corresponding class, given the constant pool index of either a
  ...
  /**
   * Returns the name of the given constant pool object, assuming it is of type
  ...
  /**
   * Returns the type descriptor for the given constant pool object, which must be a CONSTANT_Utf8,
   ...
   * assumed to point to static fields/methods.
   */
