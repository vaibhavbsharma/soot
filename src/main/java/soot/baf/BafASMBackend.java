        ...
        new InstSwitch() {
                  ...
                  new ConstantSwitch() {
                    ...
                    public void caseMethodHandle(MethodHandle handle) {
                      ...
                      argsArray[j] =
                          new Handle(
                              handle.tag,
                              slashify(methodRef.declaringClass().getName()),
                              methodRef.name(),
          ...
          public void caseIncInst(IncInst i) {
            ...
            if (i.getConstant() instanceof IntConstant) {
              mv.visitIincInsn(
                  localToSlot.get(i.getLocal()), ((IntConstant) i.getConstant()).value);
            } else {
          ...
          public void caseTableSwitchInst(TableSwitchInst i) {
            ...
            mv.visitTableSwitchInsn(
                i.getLowIndex(),
                i.getHighIndex(),
                branchTargetLabels.get(i.getDefaultTarget()),
                labels);
          }
