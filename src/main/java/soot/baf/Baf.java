...
public class Baf {
  ...
  /**
   * Constructs a new BTrap for the given exception on the given Unit range with the given Unit
   * handler.
   */
  ...
  public DynamicInvokeInst newDynamicInvokeInst(
      SootMethodRef bsmMethodRef, List<Value> bsmArgs, SootMethodRef methodRef, int tag) {
  ...
  public Dup2_x2Inst newDup2_x2Inst(
      Type aOp1Type, Type aOp2Type, Type aUnder1Type, Type aUnder2Type) {
  ...
  public LookupSwitchInst newLookupSwitchInst(
      Unit defaultTarget, List<IntConstant> lookupValues, List targets) {
    return new BLookupSwitchInst(defaultTarget, lookupValues, targets);
  }

  public TableSwitchInst newTableSwitchInst(
      Unit defaultTarget, int lowIndex, int highIndex, List targets) {
