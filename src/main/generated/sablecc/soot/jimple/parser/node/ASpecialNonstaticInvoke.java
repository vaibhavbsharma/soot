...
public final class ASpecialNonstaticInvoke extends PNonstaticInvoke {
  ...
  public ASpecialNonstaticInvoke(@SuppressWarnings("hiding") TSpecialinvoke _specialinvoke_) {
    // Constructor
  ...
  @Override
  public Object clone() {
    return new ASpecialNonstaticInvoke(cloneNode(this._specialinvoke_));
  }
