...
public class Options extends OptionsBase {
  ...
  public boolean parse(String[] argv) {
    ...
    while (hasMoreOptions()) {
      ...
      if (false) ;
      else if (false || option.equals("coffi")) coffi = true;
      else if (false || option.equals("asm-backend")) asm_backend = true;
        ...
        if (phase_help == null) phase_help = new LinkedList<String>();
      ...
      else if (false || option.equals("fly") || option.equals("on-the-fly")) on_the_fly = true;
      ...
      else if (false || option.equals("ignore-resolving-levels")) ignore_resolving_levels = true;
      else if (false
          || option.equals("cp")
      ...
      else if (false || option.equals("process-multiple-dex")) process_multiple_dex = true;
      else if (false || option.equals("search-dex-in-archives")) search_dex_in_archives = true;
        ...
        if (process_dir == null) process_dir = new LinkedList<String>();

        process_dir.add(value);

      } else if (false || option.equals("oaat")) oaat = true;
        ...
        if (android_jars.length() == 0) android_jars = value;
        else {
          G.v()
              .out
              .println(
                  "Duplicate values " + android_jars + " and " + value + " for option -" + option);
          return false;
        }
        ...
        if (force_android_jar.length() == 0) force_android_jar = value;
        else {
          G.v()
              .out
              .println(
        ...
        if (android_api_version == -1) android_api_version = Integer.valueOf(value);
        else {
          G.v()
              .out
              .println(
        ...
        if (main_class.length() == 0) main_class = value;
          ...
          G.v()
              .out
              .println(
                  "Duplicate values " + main_class + " and " + value + " for option -" + option);
          return false;
        }
      } else if (false || option.equals("polyglot")) polyglot = true;
      else if (false || option.equals("permissive-resolving")) permissive_resolving = true;
      else if (false || option.equals("no-drop-bodies-after-load")) drop_bodies_after_load = false;
        ...
        if (output_dir.length() == 0) output_dir = value;
          ...
          G.v()
              .out
              .println(
                  "Duplicate values " + output_dir + " and " + value + " for option -" + option);
          return false;
        }
        ...
        if (dump_body == null) dump_body = new LinkedList<String>();
        ...
        if (dump_cfg == null) dump_cfg = new LinkedList<String>();

        dump_cfg.add(value);

      } else if (false || option.equals("no-show-exception-dests")) show_exception_dests = false;
      else if (false || option.equals("gzip")) gzip = true;
      else if (false || option.equals("force-overwrite")) force_overwrite = true;
        ...
        if (plugin == null) plugin = new LinkedList<String>();
        ...
        if (include == null) include = new LinkedList<String>();
        ...
        if (exclude == null) exclude = new LinkedList<String>();
        ...
        if (dynamic_class == null) dynamic_class = new LinkedList<String>();
        ...
        if (dynamic_dir == null) dynamic_dir = new LinkedList<String>();
        ...
        if (dynamic_package == null) dynamic_package = new LinkedList<String>();
        ...
        keep_offset = true;
      else if (false || option.equals("write-local-annotations")) write_local_annotations = true;
  ...
  public List<String> phase_help() {
    if (phase_help == null) return java.util.Collections.emptyList();
    else return phase_help;
  }
  ...
  public List<String> process_dir() {
    if (process_dir == null) return java.util.Collections.emptyList();
    else return process_dir;
  }
  ...
  public List<String> dump_body() {
    if (dump_body == null) return java.util.Collections.emptyList();
    else return dump_body;
  }
  ...
  public List<String> dump_cfg() {
    if (dump_cfg == null) return java.util.Collections.emptyList();
    else return dump_cfg;
  }
  ...
  public List<String> include() {
    if (include == null) return java.util.Collections.emptyList();
    else return include;
  }
  ...
  public List<String> exclude() {
    if (exclude == null) return java.util.Collections.emptyList();
    else return exclude;
  }
  ...
  public List<String> dynamic_class() {
    if (dynamic_class == null) return java.util.Collections.emptyList();
    else return dynamic_class;
  }
  ...
  public List<String> dynamic_dir() {
    if (dynamic_dir == null) return java.util.Collections.emptyList();
    else return dynamic_dir;
  }
  ...
  public List<String> dynamic_package() {
    if (dynamic_package == null) return java.util.Collections.emptyList();
    else return dynamic_package;
  }
  ...
  public String getUsage() {
    return ""
        ...
        + padOpt(
            " -asm-backend",
            "Use the ASM back end for generating Java bytecode (instead of using Jasmin).")
        ...
        + padOpt(
            " -pp -prepend-classpath", "Prepend the given soot classpath to the default classpath.")
        ...
        + padVal(
            " apk-class-jimple apk-c-j", "Favour APK files as Soot source, disregard Java files")
        ...
        + padVal(
            " fixstrict (default)",
            "Transparently fix staticness errors, but do not ignore remaining errors")
        + padOpt(
  ...
  public String getPhaseList() {
    return ""
        ...
        + padVal(
            "wjpp.cimbt",
            "Replaces base objects of calls to Method.invoke() that are string constants by locals")
  ...
  public String getPhaseHelp(String phaseName) {
    ...
    if (phaseName.equals("cg"))
      return "Phase "
          ...
          + padOpt(
              "all-reachable (false)", "Assume all methods of application classes are reachable.")
          + padOpt(
              "implicit-entry (true)",
          ...
          + padOpt(
              "guards (ignore)", "Describes how to guard the program from unsound assumptions.")
          + padOpt(
    ...
    if (phaseName.equals("cg.spark"))
      return "Phase "
          ...
          + padOpt(
              "ignore-types (false)", "Make Spark completely ignore declared types of variables")
          ...
          + padOpt(
              "field-based (false)", "Use a field-based rather than field-sensitive representation")
          + padOpt(
              "types-for-sites (false)",
              "Represent objects by their actual type rather than allocation site")
          + padOpt("merge-stringbuffer (true)", "Represent all StringBuffers as one object")
          + padOpt(
              "string-constants (false)", "Propagate all string constants, not just class names")
          + padOpt(
          ...
          + padOpt(
              "add-tags (false)", "Output points-to results in tags for viewing with the Jimple")
          + padOpt("set-mass (false)", "Calculate statistics about points-to set sizes")
          + padOpt(
              "cs-demand (false)",
              "After running Spark, refine points-to sets on demand with context information")
          + padOpt(
              "lazy-pts (true)",
              "Create lazy points-to sets that create context information only when needed.")
          + padOpt(
              "traversal (75000)",
          ...
          + padOpt(
              "geom-frac-base (40)", "Fractional parameter for precision/performance trade-off")
          + padOpt("geom-blocking (true)", "Enable blocking strategy for recursive calls")
          + padOpt("geom-runs (1)", "Iterations of analysis")
          + padOpt(
              "geom-app-only (true)",
              "Processing pointers that impact pointers in application code only");
    ...
    if (phaseName.equals("cg.paddle"))
      return "Phase "
          ...
          + padOpt(
              "ignore-types (false)", "Make Paddle completely ignore declared types of variables")
          ...
          + padOpt(
              ...
              "Use global node to model variables in simulations of native methods")
          + padOpt(
              "simple-edges-bidirectional (false)",
              "Equality-based analysis between variable nodes")
    ...
    if (phaseName.equals("wjtp.tn"))
      return "Phase "
          ...
          + padVal(
              "medium-grained (default)", "Use a runtime object for synchronization where possible")
          + padVal("coarse-grained", "Use static objects for synchronization")
          + padVal(
              "single-static",
              "Use just one static synchronization object for all transactional regions")
    ...
    if (phaseName.equals("sop.cpf"))
      return "Phase "
          ...
          + padOpt("enabled (true)", "")
          + padOpt(
              "prune-cfg (true)", "Take advantage of CFG optimization             opportunities.");
    ...
    if (phaseName.equals("jap.abc"))
      return "Phase "
          ...
          + padOpt(
              "add-color-tags (false)", "Add color tags to results of array bound check analysis.");
  ...
  public static String getDeclaredOptionsForPhase(String phaseName) {
    ...
    if (phaseName.equals("jb.dtr")) return "" + "enabled ";

    if (phaseName.equals("jb.ese")) return "" + "enabled ";
    ...
    if (phaseName.equals("jb.lns")) return "" + "enabled " + "only-stack-locals " + "sort-locals ";
    ...
    if (phaseName.equals("wjpp.cimbt")) return "" + "enabled " + "verbose ";
    ...
    if (phaseName.equals("cg.cha")) return "" + "enabled " + "verbose " + "apponly ";
    ...
    if (phaseName.equals("wjtp.rdc")) return "" + "enabled " + "fcn ";
    ...
    if (phaseName.equals("shimple"))
      return "" + "enabled " + "node-elim-opt " + "standard-local-names " + "extended " + "debug ";
    ...
    if (phaseName.equals("bb.sco")) return "" + "enabled ";
  ...
  public static String getDefaultOptionsForPhase(String phaseName) {
    ...
    if (phaseName.equals("jb.dtr")) return "" + "enabled:true ";

    if (phaseName.equals("jb.ese")) return "" + "enabled:true ";
    ...
    if (phaseName.equals("jb.uce")) return "" + "enabled:true " + "remove-unreachable-traps:true ";
    ...
    if (phaseName.equals("wjpp")) return "" + "enabled:true ";

    if (phaseName.equals("wjpp.cimbt")) return "" + "enabled:false " + "verbose:false ";

    if (phaseName.equals("wspp")) return "" + "enabled:true ";
    ...
    if (phaseName.equals("wjtp.rdc")) return "" + "enabled:false ";
    ...
    if (phaseName.equals("bb.sco")) return "" + "enabled:true ";
  ...
  public void warnForeignPhase(String phaseName) {
    ...
    G.v()
        .out
        .println(
            "Warning: Phase " + phaseName + " is not a standard Soot phase listed in XML files.");
  }
