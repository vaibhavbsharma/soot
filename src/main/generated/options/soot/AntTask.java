...
public class AntTask extends MatchingTask {
  ...
  public void setphase_help(Path arg) {
    if (phase_help == null) phase_help = new Path(getProject());
  ...
  public void setprocess_dir(Path arg) {
    if (process_dir == null) process_dir = new Path(getProject());
  ...
  public void setdump_body(Path arg) {
    if (dump_body == null) dump_body = new Path(getProject());
  ...
  public void setdump_cfg(Path arg) {
    if (dump_cfg == null) dump_cfg = new Path(getProject());
  ...
  public void setplugin(Path arg) {
    if (plugin == null) plugin = new Path(getProject());
  ...
  public void setfield_type_mismatches(String arg) {
    if (false || arg.equals("fail") || arg.equals("ignore") || arg.equals("null")) {
  ...
  public void setthrow_analysis(String arg) {
    if (false || arg.equals("pedantic") || arg.equals("unit") || arg.equals("dalvik")) {
  ...
  public void setinclude(Path arg) {
    if (include == null) include = new Path(getProject());
  ...
  public void setexclude(Path arg) {
    if (exclude == null) exclude = new Path(getProject());
  ...
  public void setdynamic_class(Path arg) {
    if (dynamic_class == null) dynamic_class = new Path(getProject());
  ...
  public void setdynamic_dir(Path arg) {
    if (dynamic_dir == null) dynamic_dir = new Path(getProject());
  ...
  public void setdynamic_package(Path arg) {
    if (dynamic_package == null) dynamic_package = new Path(getProject());
