...
/**
 * @production BoundTypeAccess : {@link TypeAccess} ::= <span
 *     class="component">&lt;TypeDecl:TypeDecl&gt;</span>;
 * @ast node
...
public class BoundTypeAccess extends TypeAccess implements Cloneable {
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:333
   */
   ...
   * @aspect BoundNames
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/BoundNames.jrag:93
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  public String dumpString() {
    ASTNode$State state = state();
    try {
      return getClass().getName() + " [" + getTypeDecl().fullName() + "]";
    } finally {
    }
  }
  /** @apilevel internal */
