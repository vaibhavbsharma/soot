...
/**
 * @production LUBType : {@link ReferenceType} ::= <span class="component">{@link Modifiers}</span>
 *     <span class="component">&lt;ID:String&gt;</span> <span class="component">{@link
 *     BodyDecl}*</span> <span class="component">TypeBound:{@link Access}*</span>;
 * @ast node
...
public class LUBType extends ReferenceType implements Cloneable {
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericMethodsInference.jrag:668
   */
   ...
   * @aspect GenericMethodsInference
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericMethodsInference.jrag:690
   */
  public static HashSet MEC(ArrayList list) {
    HashSet EC = LUBType.EC(list);
    if (EC.size() == 1) return EC;
    ...
    for (Iterator iter = EC.iterator(); iter.hasNext(); ) {
      ...
      for (Iterator i2 = EC.iterator(); i2.hasNext(); ) {
        ...
        if (!(V instanceof TypeVariable) && V != W && W.instanceOf(V)) keep = false;
      }
      if (keep) MEC.add(V);
    }
    return MEC;
   ...
   * @aspect GenericMethodsInference
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericMethodsInference.jrag:714
   */
   ...
   * @aspect GenericMethodsInference
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericMethodsInference.jrag:730
   */
  public TypeDecl lci(HashSet set, TypeDecl G) {
    ...
    for (Iterator iter = set.iterator(); iter.hasNext(); ) {
      ...
      if (first) {
        first = false;
        for (int i = 0; i < decl.getNumArgument(); i++) list.add(decl.getArgument(i).type());
      } else {
   ...
   * @aspect GenericMethodsInference
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericMethodsInference.jrag:751
   */
  public TypeDecl lcta(TypeDecl X, TypeDecl Y) {
    ...
    if (!X.isWildcard() && !Y.isWildcard()) {
      ...
      throw new Error(
          "lcta not defined for (" + X.getClass().getName() + ", " + Y.getClass().getName());
  }
  /**
   * @ast method
   * @aspect GenericMethodsInference
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericMethodsInference.jrag:793
   */
   ...
   * @aspect GenericMethodsInference
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericMethodsInference.jrag:800
   */
   ...
   * @aspect GenericMethodsInference
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericMethodsInference.jrag:805
   */
  public static HashSet EST(TypeDecl t) {
    HashSet result = new HashSet();
    for (Iterator iter = LUBType.ST(t).iterator(); iter.hasNext(); ) {
      TypeDecl typeDecl = (TypeDecl) iter.next();
      if (typeDecl instanceof TypeVariable) result.add(typeDecl);
      else result.add(typeDecl.erasure());
    }
    return result;
  }
  /**
   ...
   * @aspect GenericMethodsInference
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericMethodsInference.jrag:820
   */
   ...
   * @aspect GenericMethodsInference
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericMethodsInference.jrag:826
   */
  public static void addSupertypes(HashSet set, TypeDecl t) {
    ...
    if (t instanceof ClassDecl) {
      ...
      if (type.getNumSuperInterfaceId() == 0) set.add(type.typeObject());
    } else if (t instanceof TypeVariable) {
      TypeVariable type = (TypeVariable) t;
      for (int i = 0; i < type.getNumTypeBound(); i++) {
        addSupertypes(set, type.getTypeBound(i).type());
      }
      if (type.getNumTypeBound() == 0) set.add(type.typeObject());
      ...
      throw new Error(
          "Operation not supported for " + t.fullName() + ", " + t.getClass().getName());
  }
  /**
   * @ast method
   * @aspect LookupParTypeDecl
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:1444
   */
   ...
   * @aspect GenericMethodsInference
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericMethodsInference.jrag:650
   */
  @SuppressWarnings({"unchecked", "cast"})
  public TypeDecl lub() {
    if (lub_computed) {
  ...
  private TypeDecl lub_compute() {
    ...
    if (bounds.size() == 1) return (TypeDecl) bounds.iterator().next();
   ...
   * @aspect LookupParTypeDecl
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:1434
   */
  public String typeName() {
    ASTNode$State state = state();
    try {
      if (getNumTypeBound() == 0) return "<NOTYPE>";
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericsSubtype.jrag:346
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/Jimple1.5Backend/GenericsCodegen.jrag:422
   */
  @SuppressWarnings({"unchecked", "cast"})
