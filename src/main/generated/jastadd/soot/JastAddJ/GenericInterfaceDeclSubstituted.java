...
/**
 * @production GenericInterfaceDeclSubstituted : {@link GenericInterfaceDecl} ::= <span
 ...
 */
public class GenericInterfaceDeclSubstituted extends GenericInterfaceDecl
  ...
  /** @ast method */
  public GenericInterfaceDeclSubstituted(
      Modifiers p0, String p1, List<Access> p2, List<TypeVariable> p3, TypeDecl p4) {
    setChild(p0, 0);
    setID(p1);
    setChild(p2, 1);
    setChild(p3, 2);
  ...
  /** @ast method */
  public GenericInterfaceDeclSubstituted(
      Modifiers p0, beaver.Symbol p1, List<Access> p2, List<TypeVariable> p3, TypeDecl p4) {
    setChild(p0, 0);
    setID(p1);
    setChild(p2, 1);
    setChild(p3, 2);
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:1053
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:1509
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericsSubtype.jrag:489
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect GenericsSubtype
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericsSubtype.jrag:521
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  private boolean subtype_compute(TypeDecl type) {
    return type.supertypeGenericInterfaceDeclSubstituted(this);
  }
  /**
   * @attribute syn
   * @aspect GenericsSubtype
  ...
  public boolean supertypeGenericInterfaceDecl(GenericInterfaceDecl type) {
    ASTNode$State state = state();
    try {
      return super.supertypeGenericInterfaceDecl(type)
          || original().supertypeGenericInterfaceDecl(type);
    } finally {
    }
  }
  /** @apilevel internal */
