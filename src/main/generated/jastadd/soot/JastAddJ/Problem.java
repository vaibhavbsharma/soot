...
public class Problem extends java.lang.Object implements Comparable {
  ...
  public int compareTo(Object o) {
    if (o instanceof Problem) {
      ...
      if (!fileName.equals(other.fileName)) return fileName.compareTo(other.fileName);
  ...
  public Problem(
      String fileName, String message, int line, int column, Severity severity, Kind kind) {
    this(fileName, message);
    this.line = line;
    this.column = column;
    this.kind = kind;
  ...
  public String toString() {
    String location = "";
    if (line != -1 && column != -1) location = line + "," + column + ":";
    else if (line != -1) location = line + ":";
    String s = "";
    if (this.kind == Kind.LEXICAL) s = "Lexical Error: ";
    else if (this.kind == Kind.SYNTACTIC) s = "Syntactic Error: ";
    else if (this.kind == Kind.SEMANTIC) s = "Semantic Error: ";
