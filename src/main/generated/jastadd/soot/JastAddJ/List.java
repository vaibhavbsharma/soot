...
public class List<T extends ASTNode> extends ASTNode<T> implements Cloneable {
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:977
   */
  public List substitute(Parameterization parTypeDecl) {
    ...
    for (int i = 0; i < getNumChild(); i++) {
      ...
      if (node instanceof Access) {
        ...
        throw new Error(
            "Can only substitute lists of access nodes but node number "
                + i
                + " is of type "
  ...
  public int getNumChild() {
    if (list$touched) {
      for (int i = 0; i < getNumChildNoTransform(); i++) getChild(i);
      list$touched = false;
    }
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/LookupConstructor.jrag:158
   */
  public boolean requiresDefaultConstructor() {
    ...
    try {
      if (getParent() instanceof ClassDecl) {
        ...
        return c.noConstructor()
            && c.getBodyDeclListNoTransform() == this
            && !(c instanceof AnonymousDecl);
      }
      return false;
    } finally {
    }
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/LookupConstructor.jrag:186
   * @apilevel internal
   */
  private List rewriteRule0() {
    {
      ...
      ConstructorDecl constructor =
          new ConstructorDecl(m, c.name(), new List(), new List(), new Opt(), new Block());
