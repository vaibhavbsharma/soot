...
/**
 * @production ClassDeclSubstituted : {@link ClassDecl} ::= <span
...
public class ClassDeclSubstituted extends ClassDecl implements Cloneable, MemberSubstitutor {
  ...
  /** @ast method */
  public ClassDeclSubstituted(
      Modifiers p0, String p1, Opt<Access> p2, List<Access> p3, TypeDecl p4) {
    setChild(p0, 0);
    setID(p1);
    setChild(p2, 1);
    setChild(p3, 2);
  ...
  /** @ast method */
  public ClassDeclSubstituted(
      Modifiers p0, beaver.Symbol p1, Opt<Access> p2, List<Access> p3, TypeDecl p4) {
    setChild(p0, 0);
    setID(p1);
    setChild(p2, 1);
    setChild(p3, 2);
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:1050
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:1506
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericsSubtype.jrag:486
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect GenericsSubtype
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericsSubtype.jrag:491
   */
  @SuppressWarnings({"unchecked", "cast"})
