...
/**
 * Default Java integer literal. Should only be used for numbers that can be stored in 32 bits
 * binary.
 *
...
public class IntegerLiteral extends NumericLiteral implements Cloneable {
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/NodeConstructors.jrag:48
   */
   ...
   * @aspect Expressions
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/JimpleBackend/Expressions.jrag:17
   */
  ...
  /**
   * Check for and report literal-out-of-bounds error. If the constant is error-marked, there exists
   * a literal out of bounds error.
   *
   * @ast method
   * @aspect Literals
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/Literals.jrag:120
   */
   ...
   * @aspect TypeAnalysis
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeAnalysis.jrag:300
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect Literals
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/Literals.jrag:139
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  private Constant constant_compute() {
    ...
    if (l != (0xFFFFFFFFL & ((int) l)) && l != ((long) ((int) l))) {
      c.error = true;
