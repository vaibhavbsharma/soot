...
public class BodyDeclList extends List implements Cloneable {
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:1114
   */
  @SuppressWarnings({"unchecked", "cast"})
  public BodyDecl localMethodSignatureCopy(MethodDecl originalMethod, MemberSubstitutor m) {
    ...
    if (localMethodSignatureCopy_MethodDecl_MemberSubstitutor_values.containsKey(_parameters)) {
      return (BodyDecl)
          localMethodSignatureCopy_MethodDecl_MemberSubstitutor_values.get(_parameters);
    }
    ASTNode$State state = state();
    int num = state.boundariesCrossed;
    boolean isFinal = this.is$Final();
    BodyDecl localMethodSignatureCopy_MethodDecl_MemberSubstitutor_value =
        localMethodSignatureCopy_compute(originalMethod, m);
    ...
    localMethodSignatureCopy_MethodDecl_MemberSubstitutor_list.add(
        localMethodSignatureCopy_MethodDecl_MemberSubstitutor_value);
    ...
    if (true)
      localMethodSignatureCopy_MethodDecl_MemberSubstitutor_values.put(
          _parameters, localMethodSignatureCopy_MethodDecl_MemberSubstitutor_value);
    return localMethodSignatureCopy_MethodDecl_MemberSubstitutor_value;
  }
  /** @apilevel internal */
  private BodyDecl localMethodSignatureCopy_compute(
      MethodDecl originalMethod, MemberSubstitutor m) {
   ...
   * @aspect LookupParTypeDecl
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:1148
   */
  @SuppressWarnings({"unchecked", "cast"})
  public BodyDecl localFieldCopy(FieldDeclaration originalDecl, MemberSubstitutor m) {
    ...
    int num = state.boundariesCrossed;
    boolean isFinal = this.is$Final();
    BodyDecl localFieldCopy_FieldDeclaration_MemberSubstitutor_value =
        localFieldCopy_compute(originalDecl, m);
    ...
    localFieldCopy_FieldDeclaration_MemberSubstitutor_list.add(
        localFieldCopy_FieldDeclaration_MemberSubstitutor_value);
    ...
    if (true)
      localFieldCopy_FieldDeclaration_MemberSubstitutor_values.put(
          _parameters, localFieldCopy_FieldDeclaration_MemberSubstitutor_value);
   ...
   * @aspect LookupParTypeDecl
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:1204
   */
  @SuppressWarnings({"unchecked", "cast"})
  public MemberClassDecl localClassDeclCopy(ClassDecl originalDecl, MemberSubstitutor m) {
    ...
    if (localClassDeclCopy_ClassDecl_MemberSubstitutor_values.containsKey(_parameters)) {
      return (MemberClassDecl)
          localClassDeclCopy_ClassDecl_MemberSubstitutor_values.get(_parameters);
    }
    ASTNode$State state = state();
    int num = state.boundariesCrossed;
    boolean isFinal = this.is$Final();
    MemberClassDecl localClassDeclCopy_ClassDecl_MemberSubstitutor_value =
        localClassDeclCopy_compute(originalDecl, m);
    ...
    localClassDeclCopy_ClassDecl_MemberSubstitutor_list.add(
    ...
    if (true)
      localClassDeclCopy_ClassDecl_MemberSubstitutor_values.put(
          _parameters, localClassDeclCopy_ClassDecl_MemberSubstitutor_value);
   ...
   * @aspect LookupParTypeDecl
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:1208
   */
  @SuppressWarnings({"unchecked", "cast"})
  public MemberInterfaceDecl localInterfaceDeclCopy(
      InterfaceDecl originalDecl, MemberSubstitutor m) {
    java.util.List _parameters = new java.util.ArrayList(2);
    _parameters.add(originalDecl);
    _parameters.add(m);
    ...
    if (localInterfaceDeclCopy_InterfaceDecl_MemberSubstitutor_values.containsKey(_parameters)) {
      return (MemberInterfaceDecl)
          localInterfaceDeclCopy_InterfaceDecl_MemberSubstitutor_values.get(_parameters);
    }
    ASTNode$State state = state();
    int num = state.boundariesCrossed;
    boolean isFinal = this.is$Final();
    MemberInterfaceDecl localInterfaceDeclCopy_InterfaceDecl_MemberSubstitutor_value =
        localInterfaceDeclCopy_compute(originalDecl, m);
    ...
    localInterfaceDeclCopy_InterfaceDecl_MemberSubstitutor_list.add(
        localInterfaceDeclCopy_InterfaceDecl_MemberSubstitutor_value);
    ...
    if (true)
      localInterfaceDeclCopy_InterfaceDecl_MemberSubstitutor_values.put(
          _parameters, localInterfaceDeclCopy_InterfaceDecl_MemberSubstitutor_value);
    return localInterfaceDeclCopy_InterfaceDecl_MemberSubstitutor_value;
  }
  /** @apilevel internal */
  private MemberInterfaceDecl localInterfaceDeclCopy_compute(
      InterfaceDecl originalDecl, MemberSubstitutor m) {
   ...
   * @aspect LookupParTypeDecl
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:1234
   */
  @SuppressWarnings({"unchecked", "cast"})
  public BodyDecl constructorCopy(ConstructorDecl originalDecl, MemberSubstitutor m) {
    ...
    int num = state.boundariesCrossed;
    boolean isFinal = this.is$Final();
    BodyDecl constructorCopy_ConstructorDecl_MemberSubstitutor_value =
        constructorCopy_compute(originalDecl, m);
    ...
    constructorCopy_ConstructorDecl_MemberSubstitutor_list.add(
    ...
    if (true)
      constructorCopy_ConstructorDecl_MemberSubstitutor_values.put(
          _parameters, constructorCopy_ConstructorDecl_MemberSubstitutor_value);
