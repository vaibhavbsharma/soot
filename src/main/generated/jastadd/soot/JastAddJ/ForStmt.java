...
/**
 * @production ForStmt : {@link BranchTargetStmt} ::= <span class="component">InitStmt:{@link
 *     Stmt}*</span> <span class="component">[Condition:{@link Expr}]</span> <span
 *     class="component">UpdateStmt:{@link Stmt}*</span> <span class="component">{@link
 *     Stmt}</span>;
 * @ast node
...
public class ForStmt extends BranchTargetStmt implements Cloneable, VariableScope {
   ...
   * @aspect PrettyPrint
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/PrettyPrint.jadd:604
   */
  public void toString(StringBuffer s) {
    ...
    if (getNumInitStmt() > 0) {
      if (getInitStmt(0) instanceof VariableDeclaration) {
        ...
        for (int i = minDimension; i > 0; i--) s.append("[]");

        for (int i = 0; i < getNumInitStmt(); i++) {
          if (i != 0) s.append(",");
          v = (VariableDeclaration) getInitStmt(i);
          s.append(" " + v.name());
          for (int j = v.type().dimension() - minDimension; j > 0; j--) s.append("[]");
          if (v.hasInit()) {
            s.append(" = ");
   ...
   * @aspect TypeCheck
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeCheck.jrag:334
   */
   ...
   * @aspect Statements
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/JimpleBackend/Statements.jrag:180
   */
  public void jimplify2(Body b) {
    ...
    if (getCondition().canBeTrue()) {
      ...
      for (int i = 0; i < getNumUpdateStmt(); i++) getUpdateStmt(i).jimplify2(b);
      b.setLine(this);
  ...
  /**
   * Retrieves the number of children in the InitStmt list. Calling this method will not trigger
   * rewrites..
   *
   * @return Number of children in the InitStmt list.
   * @apilevel low-level
  ...
  public void addInitStmt(Stmt node) {
    List<Stmt> list =
        (parent == null || state == null) ? getInitStmtListNoTransform() : getInitStmtList();
    list.addChild(node);
  }
  /**
   * @apilevel low-level
  ...
  /**
   * Replaces the optional node for the Condition child. This is the {@code Opt} node containing the
   * child Condition, not the actual child!
   *
  ...
  /**
   * Retrieves the optional node for child Condition. This is the {@code Opt} node containing the
   * child Condition, not the actual child!
   *
   * <p><em>This method does not invoke AST transformations.</em>
   *
  ...
  /**
   * Retrieves the number of children in the UpdateStmt list. Calling this method will not trigger
   * rewrites..
   *
   * @return Number of children in the UpdateStmt list.
   * @apilevel low-level
  ...
  public void addUpdateStmt(Stmt node) {
    List<Stmt> list =
        (parent == null || state == null) ? getUpdateStmtListNoTransform() : getUpdateStmtList();
    list.addChild(node);
  }
  /**
   * @apilevel low-level
   ...
   * @aspect BranchTarget
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/BranchTarget.jrag:71
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect BranchTarget
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/BranchTarget.jrag:79
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect DA
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:612
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  private boolean isDAafter_compute(Variable v) {
    if (!(!hasCondition() || getCondition().isDAafterFalse(v))) return false;
   ...
   * @aspect DA
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:625
   */
   ...
   * @aspect DU
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:1096
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  private boolean isDUafter_compute(Variable v) {
    ...
    for (Iterator iter = targetBreaks().iterator(); iter.hasNext(); ) {
      BreakStmt stmt = (BreakStmt) iter.next();
      if (!stmt.isDUafterReachedFinallyBlocks(v)) return false;
    }
   ...
   * @aspect DU
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:1116
   */
   ...
   * @aspect DU
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:1118
   */
  @SuppressWarnings({"unchecked", "cast"})
  public boolean isDUbeforeCondition(Variable v) {
    ...
    if (!state.IN_CIRCLE) {
      ...
      if (isFinal && num == state().boundariesCrossed) {
        isDUbeforeCondition_Variable_values.put(
            _parameters, new_isDUbeforeCondition_Variable_value);
      } else {
    ...
    if (!new Integer(state.CIRCLE_INDEX).equals(_value.visited)) {
      ...
      if (state.RESET_CYCLE) {
        isDUbeforeCondition_Variable_values.remove(_parameters);
      } else if (new_isDUbeforeCondition_Variable_value
  ...
  private boolean isDUbeforeCondition_compute(Variable v) {
    if (!isDUafterInit(v)) return false;
    else if (!isDUafterUpdate(v)) return false;
    return true;
  }
  /**
   * @attribute syn
   * @aspect DU
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:1129
   */
  public boolean isDUafterUpdate(Variable v) {
    ...
    try {
      if (!isDUbeforeCondition(v)) // start a circular evaluation here
      return false;
      if (getNumUpdateStmt() > 0) return getUpdateStmt(getNumUpdateStmt() - 1).isDUafter(v);
      if (!getStmt().isDUafter(v)) return false;
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/LookupVariable.jrag:91
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect VariableScope
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/LookupVariable.jrag:123
   */
  @SuppressWarnings({"unchecked", "cast"})
  public VariableDeclaration localVariableDeclaration(String name) {
    ...
    int num = state.boundariesCrossed;
    boolean isFinal = this.is$Final();
    VariableDeclaration localVariableDeclaration_String_value =
        localVariableDeclaration_compute(name);
    if (isFinal && num == state().boundariesCrossed)
      localVariableDeclaration_String_values.put(
          _parameters, localVariableDeclaration_String_value);
    return localVariableDeclaration_String_value;
  }
  /** @apilevel internal */
  private VariableDeclaration localVariableDeclaration_compute(String name) {
    for (int i = 0; i < getNumInitStmt(); i++)
      if (getInitStmt(i).declaresVariable(name)) return (VariableDeclaration) getInitStmt(i);
    return null;
  }
  /**
   * @attribute syn
   * @aspect NameCheck
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/NameCheck.jrag:401
   */
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/UnreachableStatements.jrag:102
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  private boolean canCompleteNormally_compute() {
    return reachable()
            && hasCondition()
            && (!getCondition().isConstant() || !getCondition().isTrue())
        || reachableBreak();
  }
  /**
   * @attribute syn
   ...
   * @aspect Statements
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/JimpleBackend/Statements.jrag:175
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect Statements
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/JimpleBackend/Statements.jrag:176
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect Statements
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/JimpleBackend/Statements.jrag:177
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect Statements
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/JimpleBackend/Statements.jrag:178
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  public boolean modifiedInScope(Variable var) {
    ASTNode$State state = state();
    try {
      for (Stmt stmt : getInitStmtList()) if (stmt.modifiedInScope(var)) return true;
      for (Stmt stmt : getUpdateStmtList()) if (stmt.modifiedInScope(var)) return true;
   ...
   * @aspect VariableScope
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/LookupVariable.jrag:18
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:636
   * @apilevel internal
   */
  public boolean Define_boolean_isDAbefore(ASTNode caller, ASTNode child, Variable v) {
    if (caller == getUpdateStmtListNoTransform()) {
      ...
      {
        if (!getStmt().isDAafter(v)) return false;
        for (Iterator iter = targetContinues().iterator(); iter.hasNext(); ) {
          ContinueStmt stmt = (ContinueStmt) iter.next();
          if (!stmt.isDAafterReachedFinallyBlocks(v)) return false;
        }
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:1145
   * @apilevel internal
   */
    ...
    if (caller == getUpdateStmtListNoTransform()) {
      int i = caller.getIndexOfChild(child);
      {
        ...
        if (i == 0) {
          ...
          return true;
        } else return getUpdateStmt(i - 1).isDUafter(v);
      }
    } else if (caller == getStmtNoTransform()) {
      return isDUbeforeCondition(v)
          && (hasCondition() ? getCondition().isDUafterTrue(v) : isDUafterInit(v));
    } else if (caller == getConditionOptNoTransform()) {
      return isDUbeforeCondition(v);
    } else if (caller == getInitStmtListNoTransform()) {
      int childIndex = caller.getIndexOfChild(child);
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/LookupVariable.jrag:90
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/NameCheck.jrag:299
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/NameCheck.jrag:370
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/UnreachableStatements.jrag:103
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/UnreachableStatements.jrag:151
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/JimpleBackend/BooleanExpressions.jrag:44
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/JimpleBackend/BooleanExpressions.jrag:45
   * @apilevel internal
   */
  ...
  public ASTNode rewriteTo() {
    // Declared in
    // /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag
    // at line 1163
    if (!hasCondition()) {
      state().duringDU++;
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:1163
   * @apilevel internal
   */
