...
public class DivExpr extends MultiplicativeExpr implements Cloneable {
   ...
   * @aspect Expressions
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/JimpleBackend/Expressions.jrag:814
   */
   ...
   * @aspect ConstantExpression
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/ConstantExpression.jrag:351
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  private boolean isConstant_compute() {
    return getLeftOperand().isConstant()
