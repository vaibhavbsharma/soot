...
/**
 * @production ClassInstanceExpr : {@link Access} ::= <span class="component">{@link Access}</span>
 *     <span class="component">Arg:{@link Expr}*</span> <span class="component">[{@link
 *     TypeDecl}]</span>;
 * @ast node
...
public class ClassInstanceExpr extends Access implements Cloneable {
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/AccessControl.jrag:139
   */
  public void accessControl() {
    super.accessControl();
    if (type().isAbstract()) error("Can not instantiate abstract class " + type().fullName());
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/ExceptionHandling.jrag:119
   */
   ...
   * @aspect ExceptionHandling
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/ExceptionHandling.jrag:281
   */
  protected boolean reachedException(TypeDecl catchType) {
    ...
    for (int i = 0; i < getNumArg(); i++) {
      if (getArg(i).reachedException(catchType)) return true;
    }
    return false;
  }
  /**
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/LookupType.jrag:414
   */
   ...
   * @aspect NameCheck
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/NameCheck.jrag:142
   */
  public void refined_NameCheck_ClassInstanceExpr_nameCheck() {
    ...
    if (decls().isEmpty())
      error(
          "can not instantiate "
              + type().typeName()
              + " no matching constructor found in "
              + type().typeName());
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/NodeConstructors.jrag:82
   */
   ...
   * @aspect PrettyPrint
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/PrettyPrint.jadd:327
   */
  public void toString(StringBuffer s) {
    ...
    if (hasTypeDecl()) {
      ...
      for (int i = 0; i < decl.getNumBodyDecl(); i++) {
        if (!(decl.getBodyDecl(i) instanceof ConstructorDecl)) decl.getBodyDecl(i).toString(s);
      }
   ...
   * @aspect TypeCheck
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeCheck.jrag:434
   */
  public void typeCheck() {
    ...
    if (isQualified()
        && !type().isInnerClass()
        && !((ClassDecl) type()).superclass().isInnerClass()
        && !type().isUnknown()) {
      error(
          "*** Qualified class instance creation can only instantiate inner classes and their anonymous subclasses");
    }
    if (!type().isClassDecl()) {
   ...
   * @aspect TypeCheck
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeCheck.jrag:448
   */
  public void typeCheckEnclosingInstance() {
    TypeDecl C = type();
    if (!C.isInnerClass()) return;
    ...
    if (C.isAnonymous()) {
      ...
      if (C.inStaticContext()) {
        ...
        while (nest != null && !nest.instanceOf(C.enclosingType())) nest = nest.enclosingType();
        enclosing = nest;
      }
    ...
    if (enclosing != null && !enclosing.instanceOf(type().enclosingType())) {
      ...
      error(
          "*** Can not instantiate "
              ...
              + msg
              + " due to incorrect enclosing instance");
    } else if (!isQualified()
        && C.isMemberType()
        && inExplicitConstructorInvocation()
        && enclosing == hostType()) {
      error(
          "*** The innermost enclosing instance of type "
              + enclosing.typeName()
   ...
   * @aspect TypeCheck
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeCheck.jrag:521
   */
    ...
    if (type().isAnonymous() && ((ClassDecl) type()).superclass().isInnerType()) {
      ...
      if (S.isLocalClass()) {
        if (S.inStaticContext()) {
          ...
          error(
              "*** No enclosing instance to class " + type().typeName() + " due to static context");
        } else if (inExplicitConstructorInvocation())
          error(
              "*** No enclosing instance to superclass "
                  + S.typeName()
                  + " of "
                  + type().typeName()
                  + " since this is not initialized yet");
      } else if (S.isMemberType()) {
        if (!isQualified()) {
          // 15.9.2 2nd paragraph
          if (noEnclosingInstance()) {
            error(
                "*** No enclosing instance to class "
                    + type().typeName()
                    + " due to static context");
          } else {
            TypeDecl nest = hostType();
            while (nest != null && !nest.instanceOf(S.enclosingType())) nest = nest.enclosingType();
            if (nest == null) {
              error(
                  "*** No enclosing instance to superclass "
                      + S.typeName()
   ...
   * @aspect Annotations
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Annotations.jrag:363
   */
   ...
   * @aspect InnerClasses
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Backend/InnerClasses.jrag:481
   */
   ...
   * @aspect InnerClasses
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Backend/InnerClasses.jrag:482
   */
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Backend/Transformations.jrag:127
   */
   ...
   * @aspect Expressions
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/JimpleBackend/Expressions.jrag:550
   */
   ...
   * @aspect Expressions
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/JimpleBackend/Expressions.jrag:557
   */
  private soot.Value emitInnerMemberEnclosing(Body b, TypeDecl innerClass) {
    if (hasPrevExpr()) {
      ...
      while (!enclosing.hasType(innerClass.name())) enclosing = enclosing.enclosingType();
   ...
   * @aspect Expressions
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/JimpleBackend/Expressions.jrag:579
   */
  public soot.Value eval(Body b) {
    ...
    if (type().isAnonymous()) {
      ...
      if (S.isLocalClass()) {
        if (!type().inStaticContext()) list.add(asImmediate(b, emitLocalEnclosing(b, S)));
      } else if (S.isInnerType()) {
        list.add(asImmediate(b, emitInnerMemberEnclosing(b, S)));
      }
    } else if (type().isLocalClass()) {
      if (!type().inStaticContext()) list.add(asImmediate(b, emitLocalEnclosing(b, type())));
      ...
      list.add(
          asImmediate(
              ...
              getArg(i)
                  .type()
                  .emitCastTo(
                      b, getArg(i), decl().getParameter(i).type()))); // MethodInvocationConversion
    ...
    if (decl().isPrivate() && type() != hostType()) {
      ...
      b.add(
          b.newInvokeStmt(
              b.newSpecialInvokeExpr(local, decl().createAccessor().sootRef(), list, this), this));
      return local;
    } else {
      b.setLine(this);
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/SootJastAddJ/EmitJimpleRefinements.jrag:231
   */
  ...
  /**
   * Replaces the optional node for the TypeDecl child. This is the {@code Opt} node containing the
   * child TypeDecl, not the actual child!
   *
  ...
  /**
   * Retrieves the optional node for child TypeDecl. This is the {@code Opt} node containing the
   * child TypeDecl, not the actual child!
   *
   * <p><em>This method does not invoke AST transformations.</em>
   *
  ...
  public void nameCheck() {
    ...
    else refined_NameCheck_ClassInstanceExpr_nameCheck();
  }
  /**
   * @ast method
   * @aspect VariableArityParametersCodegen
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/Jimple1.5Backend/VariableArityParametersCodegen.jrag:36
   */
   ...
   * @aspect DA
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:421
   */
  @SuppressWarnings({"unchecked", "cast"})
  public boolean isDAafterInstance(Variable v) {
    Object _parameters = v;
    if (isDAafterInstance_Variable_values == null)
      isDAafterInstance_Variable_values = new java.util.HashMap(4);
    ...
    if (isFinal && num == state().boundariesCrossed)
      isDAafterInstance_Variable_values.put(
          _parameters, Boolean.valueOf(isDAafterInstance_Variable_value));
    return isDAafterInstance_Variable_value;
  }
  /** @apilevel internal */
  private boolean isDAafterInstance_compute(Variable v) {
    if (getNumArg() == 0) return isDAbefore(v);
   ...
   * @aspect DA
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:428
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect DU
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:850
   */
  public boolean isDUafterInstance(Variable v) {
    ASTNode$State state = state();
    try {
      if (getNumArg() == 0) return isDUbefore(v);
   ...
   * @aspect DU
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:857
   */
  @SuppressWarnings({"unchecked", "cast"})
  public boolean computeDUbefore(int i, Variable v) {
    ...
    _parameters.add(Integer.valueOf(i));
    _parameters.add(v);
    if (computeDUbefore_int_Variable_values == null)
      computeDUbefore_int_Variable_values = new java.util.HashMap(4);
    ...
    if (isFinal && num == state().boundariesCrossed)
      computeDUbefore_int_Variable_values.put(
          _parameters, Boolean.valueOf(computeDUbefore_int_Variable_value));
  ...
  public boolean applicableAndAccessible(ConstructorDecl decl) {
    ASTNode$State state = state();
    try {
      return decl.applicable(getArgList())
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/MethodSignature.jrag:70
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect ConstructScope
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/LookupConstructor.jrag:78
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  private ConstructorDecl decl_compute() {
    ...
    if (decls.size() == 1) return (ConstructorDecl) decls.iterator().next();
  ...
  public SimpleSet qualifiedLookupType(String name) {
    ...
    try {
      ...
      if (type().name().equals(name)) return SimpleSet.emptySet.add(type());
   ...
   * @aspect TypeScopePropagation
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/LookupType.jrag:472
   */
  @SuppressWarnings({"unchecked", "cast"})
  public SimpleSet localLookupType(String name) {
    Object _parameters = name;
    if (localLookupType_String_values == null)
      localLookupType_String_values = new java.util.HashMap(4);
   ...
   * @aspect NameCheck
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/NameCheck.jrag:135
   */
   ...
   * @aspect TypeAnalysis
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeAnalysis.jrag:311
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect TypeCheck
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeCheck.jrag:519
   */
   ...
   * @aspect MethodSignature15
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/MethodSignature.jrag:327
   */
  public int arity() {
    ASTNode$State state = state();
    try {
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/VariableArityParameters.jrag:54
   */
   ...
   * @aspect ExceptionHandling
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/ExceptionHandling.jrag:52
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect ConstructScope
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/LookupConstructor.jrag:27
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect ConstructScope
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/LookupConstructor.jrag:84
   */
  @SuppressWarnings({"unchecked", "cast"})
  public ConstructorDecl unknownConstructor() {
    ASTNode$State state = state();
    ConstructorDecl unknownConstructor_value =
        getParent().Define_ConstructorDecl_unknownConstructor(this, null);
   ...
   * @aspect PrettyPrint
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/PrettyPrint.jadd:351
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect TypeCheck
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeCheck.jrag:504
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeHierarchyCheck.jrag:126
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/AnonymousClasses.jrag:15
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/MethodSignature.jrag:83
   * @apilevel internal
   */
  public ConstructorDecl Define_ConstructorDecl_constructorDecl(ASTNode caller, ASTNode child) {
    if (caller == getTypeDeclOptNoTransform()) {
      ...
      if (maxSpecific.size() == 1) return (ConstructorDecl) maxSpecific.iterator().next();
      return unknownConstructor();
    } else {
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:430
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:856
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/LookupType.jrag:92
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/LookupType.jrag:404
   * @apilevel internal
   */
  public SimpleSet Define_SimpleSet_lookupType(ASTNode caller, ASTNode child, String name) {
    if (caller == getTypeDeclOptNoTransform()) {
      ...
      if (c.size() == 1) {
        if (isQualified()) c = keepInnerClasses(c);
      }
      return c;
    } else if (caller == getArgListNoTransform()) {
      int childIndex = caller.getIndexOfChild(child);
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/LookupVariable.jrag:137
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/SyntacticClassification.jrag:127
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeAnalysis.jrag:217
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeAnalysis.jrag:530
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeAnalysis.jrag:576
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeHierarchyCheck.jrag:147
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TypeInference.jrag:69
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TypeInference.jrag:457
   * @apilevel internal
   */
