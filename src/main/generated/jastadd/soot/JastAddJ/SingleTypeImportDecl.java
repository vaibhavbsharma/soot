...
public class SingleTypeImportDecl extends ImportDecl implements Cloneable {
  ...
  public SingleTypeImportDecl fullCopy() {
    SingleTypeImportDecl tree = copy();
    if (children != null) {
   ...
   * @aspect NameCheck
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/NameCheck.jrag:20
   */
   ...
   * @aspect PrettyPrint
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/PrettyPrint.jadd:50
   */
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/LookupType.jrag:323
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  private SimpleSet importedTypes_compute(String name) {
    ...
    if (getAccess().type().name().equals(name)) set = set.add(getAccess().type());
    return set;
  }
  /**
   * @attribute inh
   * @aspect NameCheck
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/NameCheck.jrag:26
   */
  @SuppressWarnings({"unchecked", "cast"})
  public SimpleSet allImportedTypes(String name) {
    ASTNode$State state = state();
    SimpleSet allImportedTypes_String_value =
        getParent().Define_SimpleSet_allImportedTypes(this, null, name);
    return allImportedTypes_String_value;
  }
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/SyntacticClassification.jrag:72
   * @apilevel internal
   */
