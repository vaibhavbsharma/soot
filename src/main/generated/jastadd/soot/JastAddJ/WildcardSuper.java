...
/**
 * @production WildcardSuper : {@link AbstractWildcard} ::= <span class="component">{@link
 *     Access}</span>;
 * @ast node
...
public class WildcardSuper extends AbstractWildcard implements Cloneable {
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericsPrettyPrint.jrag:168
   */
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:1371
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  private TypeDecl type_compute() {
    return lookupWildcardSuper(getAccess().type());
  }
  /**
   * @attribute inh
   * @aspect LookupParTypeDecl
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:1372
   */
  @SuppressWarnings({"unchecked", "cast"})
