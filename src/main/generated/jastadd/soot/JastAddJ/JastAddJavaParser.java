...
/**
 * This class is a LALR parser generated by <a href="http://beaver.sourceforge.net">Beaver</a>
 * v0.9.6.1 from the grammar specification "JastAddJavaParser.beaver".
 */
public class JastAddJavaParser extends Parser {
  ...
  public CompilationUnit parse(java.io.InputStream is, String fileName)
    ...
    try {
      ...
      cu = new CompilationUnit();
      errors.add(
          new Problem(null, e.getMessage(), 0, 0, Problem.Severity.ERROR, Problem.Kind.LEXICAL));
    }
  ...
  protected Symbol invokeReduceAction(int rule_num, int offset) {
    switch (rule_num) {
      ...
      case 27: // compilation_unit = package_declaration.p import_declarations.i
        // type_declarations.t
        {
          final Symbol _symbol_p = _symbols[offset + 1];
          final IdUse p = (IdUse) _symbol_p.value;
      ...
      case 44: // type_import_on_demand_declaration = IMPORT.IMPORT name.n DOT.DOT MULT.MULT
        // SEMICOLON.SEMICOLON
        {
          final Symbol IMPORT = _symbols[offset + 1];
          final Symbol _symbol_n = _symbols[offset + 2];
      ...
      case 62: // class_declaration = modifiers.m CLASS.CLASS IDENTIFIER.IDENTIFIER
        // class_body.b
        {
          final Symbol _symbol_m = _symbols[offset + 1];
      ...
      case 64: // class_declaration = modifiers.m CLASS.CLASS IDENTIFIER.IDENTIFIER super.s
        // class_body.b
        {
          final Symbol _symbol_m = _symbols[offset + 1];
          final List m = (List) _symbol_m.value;
      ...
      case 65: // class_declaration = CLASS.CLASS IDENTIFIER.IDENTIFIER interfaces.i
        // class_body.b
        {
          final Symbol CLASS = _symbols[offset + 1];
          final Symbol IDENTIFIER = _symbols[offset + 2];
      ...
      case 66: // class_declaration = modifiers.m CLASS.CLASS IDENTIFIER.IDENTIFIER
      ...
      case 67: // class_declaration = CLASS.CLASS IDENTIFIER.IDENTIFIER super.s interfaces.i
        // class_body.b
        {
          final Symbol CLASS = _symbols[offset + 1];
          final Symbol IDENTIFIER = _symbols[offset + 2];
      ...
      case 68: // class_declaration = modifiers.m CLASS.CLASS IDENTIFIER.IDENTIFIER super.s
        // interfaces.i class_body.b
        {
          final Symbol _symbol_m = _symbols[offset + 1];
          final List m = (List) _symbol_m.value;
      ...
      case 86: // field_declaration = modifiers.m type.t variable_declarators.v
        // SEMICOLON.SEMICOLON
        {
          final Symbol _symbol_m = _symbols[offset + 1];
          final List m = (List) _symbol_m.value;
      ...
      case 88: // variable_declarators = variable_declarators.l COMMA.COMMA
      ...
      case 95: // method_header = type.t IDENTIFIER.IDENTIFIER LPAREN.LPAREN
        // formal_parameter_list_opt.l RPAREN.RPAREN
        {
          final Symbol _symbol_t = _symbols[offset + 1];
          final Access t = (Access) _symbol_t.value;
          final Symbol IDENTIFIER = _symbols[offset + 2];
          ...
          return new MethodDecl(
              ...
              t.addArrayDims(new List()),
              IDENTIFIER,
              l,
              new List(),
              new Opt());
        }
      case 96: // method_header = modifiers.m type.t IDENTIFIER.IDENTIFIER LPAREN.LPAREN
        // formal_parameter_list_opt.l RPAREN.RPAREN
        {
          final Symbol _symbol_m = _symbols[offset + 1];
          final List m = (List) _symbol_m.value;
          ...
          return new MethodDecl(
              new Modifiers(m), t.addArrayDims(new List()), IDENTIFIER, l, new List(), new Opt());
        }
      case 97: // method_header = type.t IDENTIFIER.IDENTIFIER LPAREN.LPAREN
        // formal_parameter_list_opt.l RPAREN.RPAREN dims.d
        {
          final Symbol _symbol_t = _symbols[offset + 1];
          final Access t = (Access) _symbol_t.value;
          final Symbol IDENTIFIER = _symbols[offset + 2];
          ...
          final List d = (List) _symbol_d.value;
          return new MethodDecl(
              new Modifiers(new List()), t.addArrayDims(d), IDENTIFIER, l, new List(), new Opt());
        }
      case 98: // method_header = modifiers.m type.t IDENTIFIER.IDENTIFIER LPAREN.LPAREN
        // formal_parameter_list_opt.l RPAREN.RPAREN dims.d
        {
          final Symbol _symbol_m = _symbols[offset + 1];
          final List m = (List) _symbol_m.value;
          ...
          final List d = (List) _symbol_d.value;
          return new MethodDecl(
              new Modifiers(m), t.addArrayDims(d), IDENTIFIER, l, new List(), new Opt());
        }
      case 99: // method_header = type.t IDENTIFIER.IDENTIFIER LPAREN.LPAREN
        // formal_parameter_list_opt.l RPAREN.RPAREN throws.tl
        {
          final Symbol _symbol_t = _symbols[offset + 1];
          final Access t = (Access) _symbol_t.value;
          final Symbol IDENTIFIER = _symbols[offset + 2];
          ...
          return new MethodDecl(
              new Modifiers(new List()), t.addArrayDims(new List()), IDENTIFIER, l, tl, new Opt());
        }
      case 100: // method_header = modifiers.m type.t IDENTIFIER.IDENTIFIER LPAREN.LPAREN
        // formal_parameter_list_opt.l RPAREN.RPAREN throws.tl
        {
          final Symbol _symbol_m = _symbols[offset + 1];
          final List m = (List) _symbol_m.value;
          ...
          final List tl = (List) _symbol_tl.value;
          return new MethodDecl(
              new Modifiers(m), t.addArrayDims(new List()), IDENTIFIER, l, tl, new Opt());
        }
      case 101: // method_header = type.t IDENTIFIER.IDENTIFIER LPAREN.LPAREN
        // formal_parameter_list_opt.l RPAREN.RPAREN dims.d throws.tl
        {
          final Symbol _symbol_t = _symbols[offset + 1];
          final Access t = (Access) _symbol_t.value;
          final Symbol IDENTIFIER = _symbols[offset + 2];
          ...
          final List tl = (List) _symbol_tl.value;
          return new MethodDecl(
              new Modifiers(new List()), t.addArrayDims(d), IDENTIFIER, l, tl, new Opt());
        }
      case 102: // method_header = modifiers.m type.t IDENTIFIER.IDENTIFIER LPAREN.LPAREN
        // formal_parameter_list_opt.l RPAREN.RPAREN dims.d throws.tl
        {
          final Symbol _symbol_m = _symbols[offset + 1];
          final List m = (List) _symbol_m.value;
      ...
      case 103: // method_header = VOID.VOID IDENTIFIER.IDENTIFIER LPAREN.LPAREN
        // formal_parameter_list_opt.l RPAREN.RPAREN throws_opt.tl
        {
      ...
      case 104: // method_header = modifiers.m VOID.VOID IDENTIFIER.IDENTIFIER LPAREN.LPAREN
        // formal_parameter_list_opt.l RPAREN.RPAREN throws_opt.tl
        {
          final Symbol _symbol_m = _symbols[offset + 1];
          final List m = (List) _symbol_m.value;
          ...
          final List tl = (List) _symbol_tl.value;
          return new MethodDecl(
              new Modifiers(m), new PrimitiveTypeAccess("void"), IDENTIFIER, l, tl, new Opt());
        }
      ...
      case 106: // formal_parameter_list = formal_parameter_list.l COMMA.COMMA
        // formal_parameter.f
        {
          final Symbol _symbol_l = _symbols[offset + 1];
          final List l = (List) _symbol_l.value;
      ...
      case 116: // constructor_declaration = IDENTIFIER.IDENTIFIER LPAREN.LPAREN
        // formal_parameter_list_opt.pl RPAREN.RPAREN throws_opt.tl LBRACE.LBRACE
        // RBRACE.RBRACE
        {
          final Symbol IDENTIFIER = _symbols[offset + 1];
          ...
          b.setStart(LBRACE.getStart());
          b.setEnd(RBRACE.getEnd());
          return new ConstructorDecl(new Modifiers(new List()), IDENTIFIER, pl, tl, new Opt(), b);
        }
      case 117: // constructor_declaration = modifiers.m IDENTIFIER.IDENTIFIER LPAREN.LPAREN
        // formal_parameter_list_opt.pl RPAREN.RPAREN throws_opt.tl LBRACE.LBRACE
        // RBRACE.RBRACE
        {
          final Symbol _symbol_m = _symbols[offset + 1];
      ...
      case 118: // constructor_declaration = IDENTIFIER.IDENTIFIER LPAREN.LPAREN
        // formal_parameter_list_opt.pl RPAREN.RPAREN throws_opt.tl LBRACE.LBRACE
        // explicit_constructor_invocation.c RBRACE.RBRACE
        {
          final Symbol IDENTIFIER = _symbols[offset + 1];
          final Symbol LPAREN = _symbols[offset + 2];
          final Symbol _symbol_pl = _symbols[offset + 3];
      ...
      case 119: // constructor_declaration = modifiers.m IDENTIFIER.IDENTIFIER LPAREN.LPAREN
        // formal_parameter_list_opt.pl RPAREN.RPAREN throws_opt.tl LBRACE.LBRACE
        // explicit_constructor_invocation.c RBRACE.RBRACE
        {
          final Symbol _symbol_m = _symbols[offset + 1];
      ...
      case 120: // constructor_declaration = IDENTIFIER.IDENTIFIER LPAREN.LPAREN
        // formal_parameter_list_opt.pl RPAREN.RPAREN throws_opt.tl LBRACE.LBRACE
        // block_statements.l RBRACE.RBRACE
        {
          final Symbol IDENTIFIER = _symbols[offset + 1];
          final Symbol LPAREN = _symbols[offset + 2];
          final Symbol _symbol_pl = _symbols[offset + 3];
          ...
          final Symbol RBRACE = _symbols[offset + 8];
          Block b = new Block(l);
          l.setStart(LBRACE.getStart() + 1);
          b.setStart(LBRACE.getStart());
          b.setEnd(RBRACE.getEnd());
          return new ConstructorDecl(new Modifiers(new List()), IDENTIFIER, pl, tl, new Opt(), b);
        }
      case 121: // constructor_declaration = modifiers.m IDENTIFIER.IDENTIFIER LPAREN.LPAREN
        // formal_parameter_list_opt.pl RPAREN.RPAREN throws_opt.tl LBRACE.LBRACE
        // block_statements.l RBRACE.RBRACE
        {
          final Symbol _symbol_m = _symbols[offset + 1];
      ...
      case 122: // constructor_declaration = IDENTIFIER.IDENTIFIER LPAREN.LPAREN
        // formal_parameter_list_opt.pl RPAREN.RPAREN throws_opt.tl LBRACE.LBRACE
        // explicit_constructor_invocation.c block_statements.l RBRACE.RBRACE
        {
          final Symbol IDENTIFIER = _symbols[offset + 1];
          final Symbol LPAREN = _symbols[offset + 2];
          final Symbol _symbol_pl = _symbols[offset + 3];
      ...
      case 123: // constructor_declaration = modifiers.m IDENTIFIER.IDENTIFIER LPAREN.LPAREN
        // formal_parameter_list_opt.pl RPAREN.RPAREN throws_opt.tl LBRACE.LBRACE
        // explicit_constructor_invocation.c block_statements.l RBRACE.RBRACE
        {
          final Symbol _symbol_m = _symbols[offset + 1];
      ...
      case 124: // explicit_constructor_invocation = THIS.THIS LPAREN.LPAREN
        // argument_list_opt.l RPAREN.RPAREN SEMICOLON.SEMICOLON
        {
      ...
      case 125: // explicit_constructor_invocation = SUPER.SUPER LPAREN.LPAREN
        // argument_list_opt.l RPAREN.RPAREN SEMICOLON.SEMICOLON
        {
      ...
      case 126: // explicit_constructor_invocation = primary.p DOT.DOT SUPER.SUPER
        // LPAREN.LPAREN argument_list_opt.l RPAREN.RPAREN SEMICOLON.SEMICOLON
        {
          final Symbol _symbol_p = _symbols[offset + 1];
      ...
      case 127: // explicit_constructor_invocation = name.n DOT.DOT SUPER.SUPER LPAREN.LPAREN
        // argument_list_opt.l RPAREN.RPAREN SEMICOLON.SEMICOLON
        {
          final Symbol _symbol_n = _symbols[offset + 1];
          final Access n = (Access) _symbol_n.value;
      ...
      case 128: // interface_declaration = INTERFACE.INTERFACE IDENTIFIER.IDENTIFIER
        // interface_body.b
        {
      ...
      case 129: // interface_declaration = modifiers.m INTERFACE.INTERFACE
        // IDENTIFIER.IDENTIFIER interface_body.b
        {
          final Symbol _symbol_m = _symbols[offset + 1];
          final List m = (List) _symbol_m.value;
      ...
      case 130: // interface_declaration = INTERFACE.INTERFACE IDENTIFIER.IDENTIFIER
        // extends_interfaces.i interface_body.b
        {
          final Symbol INTERFACE = _symbols[offset + 1];
          final Symbol IDENTIFIER = _symbols[offset + 2];
          final Symbol _symbol_i = _symbols[offset + 3];
      ...
      case 131: // interface_declaration = modifiers.m INTERFACE.INTERFACE
        // IDENTIFIER.IDENTIFIER extends_interfaces.i interface_body.b
        {
          final Symbol _symbol_m = _symbols[offset + 1];
          final List m = (List) _symbol_m.value;
          final Symbol INTERFACE = _symbols[offset + 2];
      ...
      case 134: // interface_body = LBRACE.LBRACE interface_member_declarations_opt.i
        // RBRACE.RBRACE
        {
          final Symbol LBRACE = _symbols[offset + 1];
          final Symbol _symbol_i = _symbols[offset + 2];
      ...
      case 136: // interface_member_declarations = interface_member_declarations.l
      ...
      case 147: // array_initializer = LBRACE.LBRACE variable_initializers.v COMMA.COMMA
        // RBRACE.RBRACE
        {
          final Symbol LBRACE = _symbols[offset + 1];
          final Symbol _symbol_v = _symbols[offset + 2];
      ...
      case 149: // variable_initializers = variable_initializers.l COMMA.COMMA
      ...
      case 156: // local_variable_declaration_statement = local_variable_declaration.l
        // SEMICOLON.SEMICOLON
        {
          final Symbol _symbol_l = _symbols[offset + 1];
          final VarDeclStmt l = (VarDeclStmt) _symbol_l.value;
      ...
      case 182: // if_then_statement = IF.IF LPAREN.LPAREN expression.e RPAREN.RPAREN
        // statement.s
        {
      ...
      case 183: // if_then_else_statement = IF.IF LPAREN.LPAREN expression.e RPAREN.RPAREN
        // statement_no_short_if.t ELSE.ELSE statement.els
        {
          final Symbol IF = _symbols[offset + 1];
          final Symbol LPAREN = _symbols[offset + 2];
          final Symbol _symbol_e = _symbols[offset + 3];
      ...
      case 184: // if_then_else_statement_no_short_if = IF.IF LPAREN.LPAREN expression.e
        // RPAREN.RPAREN statement_no_short_if.t ELSE.ELSE statement_no_short_if.els
        {
          final Symbol IF = _symbols[offset + 1];
          final Symbol LPAREN = _symbols[offset + 2];
          final Symbol _symbol_e = _symbols[offset + 3];
      ...
      case 187: // labeled_statement_no_short_if = IDENTIFIER.id COLON.COLON
      ...
      case 196: // switch_statement = SWITCH.SWITCH LPAREN.LPAREN expression.e RPAREN.RPAREN
        // switch_block.l
        {
      ...
      case 197: // switch_block = LBRACE.LBRACE switch_block_statement_groups.l
        // switch_labels.s RBRACE.RBRACE
        {
          final Symbol LBRACE = _symbols[offset + 1];
          final Symbol _symbol_l = _symbols[offset + 2];
          final List l = (List) _symbol_l.value;
          ...
          final Symbol RBRACE = _symbols[offset + 4];
          for (int ii = 0; ii < s.getNumChildNoTransform(); ii++) l.add(s.getChildNoTransform(ii));
          return new Block(l);
        }
      ...
      case 202: // switch_block_statement_groups = switch_block_statement_groups.l
        // switch_block_statement_group.g
        {
          final Symbol _symbol_l = _symbols[offset + 1];
          final List l = (List) _symbol_l.value;
          final Symbol _symbol_g = _symbols[offset + 2];
          final List g = (List) _symbol_g.value;
          for (int ii = 0; ii < g.getNumChildNoTransform(); ii++) l.add(g.getChildNoTransform(ii));
          return l;
        }
      ...
      case 208: // while_statement = WHILE.WHILE LPAREN.LPAREN expression.e RPAREN.RPAREN
        // statement.s
        {
      ...
      case 209: // while_statement_no_short_if = WHILE.WHILE LPAREN.LPAREN expression.e
        // RPAREN.RPAREN statement_no_short_if.s
        {
          final Symbol WHILE = _symbols[offset + 1];
          final Symbol LPAREN = _symbols[offset + 2];
          final Symbol _symbol_e = _symbols[offset + 3];
      ...
      case 210: // do_statement = DO.DO statement.s WHILE.WHILE LPAREN.LPAREN expression.e
      ...
      case 211: // for_statement = FOR.FOR LPAREN.LPAREN for_init_opt.i SEMICOLON.SEMICOLON
        // expression_opt.e SEMICOLON.SEMICOLON_ for_update_opt.u RPAREN.RPAREN
        // statement.s
        {
      ...
      case 212: // for_statement_no_short_if = FOR.FOR LPAREN.LPAREN for_init_opt.i
        // SEMICOLON.SEMICOLON expression_opt.e SEMICOLON.SEMICOLON_ for_update_opt.u
        // RPAREN.RPAREN statement_no_short_if.s
        {
          final Symbol FOR = _symbols[offset + 1];
          final Symbol LPAREN = _symbols[offset + 2];
      ...
      case 217: // statement_expression_list = statement_expression_list.l COMMA.COMMA
      ...
      case 224: // synchronized_statement = SYNCHRONIZED.SYNCHRONIZED LPAREN.LPAREN
        // expression.e RPAREN.RPAREN block.b
        {
          final Symbol SYNCHRONIZED = _symbols[offset + 1];
          final Symbol LPAREN = _symbols[offset + 2];
          final Symbol _symbol_e = _symbols[offset + 3];
      ...
      case 230: // catch_clause = CATCH.CATCH LPAREN.LPAREN formal_parameter.p RPAREN.RPAREN
        // block.b
        {
      ...
      case 233: // assert_statement = ASSERT.ASSERT expression.e COLON.COLON expression.s
        // SEMICOLON.SEMICOLON
        {
          final Symbol ASSERT = _symbols[offset + 1];
          final Symbol _symbol_e = _symbols[offset + 2];
      ...
      case 244: // array_creation_uninit = NEW.NEW class_or_interface_type.t dim_exprs.d
        // dims.e
        {
          final Symbol NEW = _symbols[offset + 1];
          final Symbol _symbol_t = _symbols[offset + 2];
      ...
      case 246: // array_creation_init = NEW.NEW class_or_interface_type.t dims.d
        // array_initializer.i
        {
          final Symbol NEW = _symbols[offset + 1];
          final Symbol _symbol_t = _symbols[offset + 2];
      ...
      case 250: // dims = LBRACK.LBRACK RBRACK.RBRACK
        {
          ...
          d.setStart(LBRACK.getStart());
          d.setEnd(RBRACK.getEnd());
          return new List().add(d);
        }
      ...
      case 256: // method_invocation = primary.p DOT.DOT IDENTIFIER.IDENTIFIER LPAREN.LPAREN
        // argument_list_opt.l RPAREN.RPAREN
        {
          final Symbol _symbol_p = _symbols[offset + 1];
          final Expr p = (Expr) _symbol_p.value;
          final Symbol DOT = _symbols[offset + 2];
      ...
      case 257: // method_invocation = SUPER.SUPER DOT.DOT IDENTIFIER.IDENTIFIER LPAREN.LPAREN
        // argument_list_opt.l RPAREN.RPAREN
        {
          final Symbol SUPER = _symbols[offset + 1];
          final Symbol DOT = _symbols[offset + 2];
      ...
      case 258: // method_invocation = name.n DOT.DOT SUPER.SUPER DOT.DOT_
        // IDENTIFIER.IDENTIFIER LPAREN.LPAREN argument_list_opt.l RPAREN.RPAREN
        {
          final Symbol _symbol_n = _symbols[offset + 1];
          final Access n = (Access) _symbol_n.value;
          final Symbol DOT = _symbols[offset + 2];
      ...
      case 260: // array_access = primary_no_new_array.p LBRACK.LBRACK expression.e
        // RBRACK.RBRACK
        {
          final Symbol _symbol_p = _symbols[offset + 1];
          final Expr p = (Expr) _symbol_p.value;
      ...
      case 278: // cast_expression = LPAREN.LPAREN primitive_type.t RPAREN.RPAREN
        // unary_expression.e
        {
      ...
      case 279: // cast_expression = LPAREN.LPAREN primitive_type.t dims.d RPAREN.RPAREN
        // unary_expression.e
        {
          final Symbol LPAREN = _symbols[offset + 1];
          final Symbol _symbol_t = _symbols[offset + 2];
      ...
      case 280: // cast_expression = LPAREN.LPAREN name.t RPAREN.RPAREN
      ...
      case 281: // cast_expression = LPAREN.LPAREN name.t dims.d RPAREN.RPAREN
        // unary_expression_not_plus_minus.e
        {
          final Symbol LPAREN = _symbols[offset + 1];
          final Symbol _symbol_t = _symbols[offset + 2];
      ...
      case 283: // multiplicative_expression = multiplicative_expression.e1 MULT.MULT
        // unary_expression.e2
        {
      ...
      case 284: // multiplicative_expression = multiplicative_expression.e1 DIV.DIV
        // unary_expression.e2
        {
          final Symbol _symbol_e1 = _symbols[offset + 1];
          final Expr e1 = (Expr) _symbol_e1.value;
      ...
      case 285: // multiplicative_expression = multiplicative_expression.e1 MOD.MOD
        // unary_expression.e2
        {
          final Symbol _symbol_e1 = _symbols[offset + 1];
          final Expr e1 = (Expr) _symbol_e1.value;
      ...
      case 287: // additive_expression = additive_expression.e1 PLUS.PLUS
        // multiplicative_expression.e2
        {
          final Symbol _symbol_e1 = _symbols[offset + 1];
          final Expr e1 = (Expr) _symbol_e1.value;
      ...
      case 288: // additive_expression = additive_expression.e1 MINUS.MINUS
        // multiplicative_expression.e2
        {
          final Symbol _symbol_e1 = _symbols[offset + 1];
          final Expr e1 = (Expr) _symbol_e1.value;
      ...
      case 292: // shift_expression = shift_expression.e1 URSHIFT.URSHIFT
        // additive_expression.e2
        {
          final Symbol _symbol_e1 = _symbols[offset + 1];
          final Expr e1 = (Expr) _symbol_e1.value;
      ...
      case 296: // relational_expression = relational_expression.e1 LTEQ.LTEQ
        // shift_expression.e2
        {
          final Symbol _symbol_e1 = _symbols[offset + 1];
          final Expr e1 = (Expr) _symbol_e1.value;
      ...
      case 297: // relational_expression = relational_expression.e1 GTEQ.GTEQ
        // shift_expression.e2
        {
          final Symbol _symbol_e1 = _symbols[offset + 1];
          final Expr e1 = (Expr) _symbol_e1.value;
      ...
      case 298: // relational_expression = relational_expression.e INSTANCEOF.INSTANCEOF
        // reference_type.t
        {
          final Symbol _symbol_e = _symbols[offset + 1];
          final Expr e = (Expr) _symbol_e.value;
      ...
      case 300: // equality_expression = equality_expression.e1 EQEQ.EQEQ
        // relational_expression.e2
        {
          final Symbol _symbol_e1 = _symbols[offset + 1];
          final Expr e1 = (Expr) _symbol_e1.value;
      ...
      case 301: // equality_expression = equality_expression.e1 NOTEQ.NOTEQ
        // relational_expression.e2
        {
          final Symbol _symbol_e1 = _symbols[offset + 1];
          final Expr e1 = (Expr) _symbol_e1.value;
      ...
      case 305: // exclusive_or_expression = exclusive_or_expression.e1 XOR.XOR
        // and_expression.e2
        {
          final Symbol _symbol_e1 = _symbols[offset + 1];
          final Expr e1 = (Expr) _symbol_e1.value;
      ...
      case 307: // inclusive_or_expression = inclusive_or_expression.e1 OR.OR
        // exclusive_or_expression.e2
        {
          final Symbol _symbol_e1 = _symbols[offset + 1];
          final Expr e1 = (Expr) _symbol_e1.value;
      ...
      case 309: // conditional_and_expression = conditional_and_expression.e1 ANDAND.ANDAND
        // inclusive_or_expression.e2
        {
          final Symbol _symbol_e1 = _symbols[offset + 1];
          final Expr e1 = (Expr) _symbol_e1.value;
      ...
      case 311: // conditional_or_expression = conditional_or_expression.e1 OROR.OROR
        // conditional_and_expression.e2
        {
          final Symbol _symbol_e1 = _symbols[offset + 1];
          final Expr e1 = (Expr) _symbol_e1.value;
      ...
      case 313: // conditional_expression = conditional_or_expression.c QUESTION.QUESTION
        // expression.e1 COLON.COLON conditional_expression.e2
        {
          final Symbol _symbol_c = _symbols[offset + 1];
          final Expr c = (Expr) _symbol_c.value;
      ...
      case 317: // assignment = postfix_expression.dest MULTEQ.MULTEQ
        // assignment_expression.source
        {
          final Symbol _symbol_dest = _symbols[offset + 1];
          final Expr dest = (Expr) _symbol_dest.value;
      ...
      case 318: // assignment = postfix_expression.dest DIVEQ.DIVEQ
        // assignment_expression.source
        {
          final Symbol _symbol_dest = _symbols[offset + 1];
          final Expr dest = (Expr) _symbol_dest.value;
      ...
      case 319: // assignment = postfix_expression.dest MODEQ.MODEQ
        // assignment_expression.source
        {
          final Symbol _symbol_dest = _symbols[offset + 1];
          final Expr dest = (Expr) _symbol_dest.value;
      ...
      case 320: // assignment = postfix_expression.dest PLUSEQ.PLUSEQ
        // assignment_expression.source
        {
          final Symbol _symbol_dest = _symbols[offset + 1];
          final Expr dest = (Expr) _symbol_dest.value;
      ...
      case 321: // assignment = postfix_expression.dest MINUSEQ.MINUSEQ
        // assignment_expression.source
        {
          final Symbol _symbol_dest = _symbols[offset + 1];
          final Expr dest = (Expr) _symbol_dest.value;
      ...
      case 322: // assignment = postfix_expression.dest LSHIFTEQ.LSHIFTEQ
        // assignment_expression.source
        {
          final Symbol _symbol_dest = _symbols[offset + 1];
          final Expr dest = (Expr) _symbol_dest.value;
      ...
      case 323: // assignment = postfix_expression.dest RSHIFTEQ.RSHIFTEQ
        // assignment_expression.source
        {
          final Symbol _symbol_dest = _symbols[offset + 1];
          final Expr dest = (Expr) _symbol_dest.value;
      ...
      case 324: // assignment = postfix_expression.dest URSHIFTEQ.URSHIFTEQ
        // assignment_expression.source
        {
          final Symbol _symbol_dest = _symbols[offset + 1];
          final Expr dest = (Expr) _symbol_dest.value;
      ...
      case 325: // assignment = postfix_expression.dest ANDEQ.ANDEQ
        // assignment_expression.source
        {
          final Symbol _symbol_dest = _symbols[offset + 1];
          final Expr dest = (Expr) _symbol_dest.value;
      ...
      case 326: // assignment = postfix_expression.dest XOREQ.XOREQ
        // assignment_expression.source
        {
          final Symbol _symbol_dest = _symbols[offset + 1];
          final Expr dest = (Expr) _symbol_dest.value;
      ...
      case 338: // annotation_type_declaration = AT.AT INTERFACE.INTERFACE
        // IDENTIFIER.IDENTIFIER annotation_type_body.b
        {
      ...
      case 339: // annotation_type_declaration = modifiers.m AT.AT INTERFACE.INTERFACE
        // IDENTIFIER.IDENTIFIER annotation_type_body.b
        {
          final Symbol _symbol_m = _symbols[offset + 1];
          final List m = (List) _symbol_m.value;
      ...
      case 340: // annotation_type_body = LBRACE.LBRACE
        // annotation_type_element_declarations_opt.i RBRACE.RBRACE
        {
          final Symbol LBRACE = _symbols[offset + 1];
          final Symbol _symbol_i = _symbols[offset + 2];
          final List i = (List) _symbol_i.value;
      ...
      case 341: // annotation_type_element_declarations =
        // annotation_type_element_declaration.i
        {
          final Symbol _symbol_i = _symbols[offset + 1];
          final BodyDecl i = (BodyDecl) _symbol_i.value;
          return new List().add(i);
        }
      case 342: // annotation_type_element_declarations =
        // annotation_type_element_declarations.l
        // annotation_type_element_declaration.i
        {
          final Symbol _symbol_l = _symbols[offset + 1];
          final List l = (List) _symbol_l.value;
      ...
      case 343: // annotation_type_element_declaration = type.t IDENTIFIER.IDENTIFIER
        // LPAREN.LPAREN RPAREN.RPAREN default_value_opt.default_value
        // SEMICOLON.SEMICOLON
        {
          final Symbol _symbol_t = _symbols[offset + 1];
          final Access t = (Access) _symbol_t.value;
      ...
      case 344: // annotation_type_element_declaration = modifiers.m type.t
        // IDENTIFIER.IDENTIFIER LPAREN.LPAREN RPAREN.RPAREN
        // default_value_opt.default_value SEMICOLON.SEMICOLON
        {
          final Symbol _symbol_m = _symbols[offset + 1];
          final List m = (List) _symbol_m.value;
          final Symbol _symbol_t = _symbols[offset + 2];
      ...
      case 347: // annotation_type_element_declaration =
        // interface_declaration.interface_declaration
        {
          final Symbol _symbol_interface_declaration = _symbols[offset + 1];
          final InterfaceDecl interface_declaration =
              (InterfaceDecl) _symbol_interface_declaration.value;
      ...
      case 349: // annotation_type_element_declaration =
        // annotation_type_declaration.annotation_type_declaration
        {
          ...
          final AnnotationDecl annotation_type_declaration =
              (AnnotationDecl) _symbol_annotation_type_declaration.value;
      ...
      case 356: // normal_annotation = AT.AT name.name LPAREN.LPAREN
        // element_value_pairs_opt.element_value_pairs RPAREN.RPAREN
        {
          final Symbol AT = _symbols[offset + 1];
      ...
      case 357: // element_value_pairs = element_value_pair.element_value_pair
        {
          ...
          final ElementValuePair element_value_pair =
              (ElementValuePair) _symbol_element_value_pair.value;
          return new List().add(element_value_pair);
        }
      case 358: // element_value_pairs = element_value_pairs.element_value_pairs COMMA.COMMA
      ...
      case 359: // element_value_pair = IDENTIFIER.IDENTIFIER EQ.EQ
      ...
      case 364: // element_value_array_initializer = LBRACE.LBRACE
        // element_values.element_values RBRACE.RBRACE
        {
          final Symbol LBRACE = _symbols[offset + 1];
      ...
      case 366: // element_value_array_initializer = LBRACE.LBRACE
        // element_values.element_values COMMA.COMMA RBRACE.RBRACE
        {
          final Symbol LBRACE = _symbols[offset + 1];
          final Symbol _symbol_element_values = _symbols[offset + 2];
          final List element_values = (List) _symbol_element_values.value;
      ...
      case 368: // element_values = element_values.element_values COMMA.COMMA
        // element_value.element_value
        {
      ...
      case 370: // single_element_annotation = AT.AT name.name LPAREN.LPAREN
        // element_value.element_value RPAREN.RPAREN
        {
          final Symbol AT = _symbols[offset + 1];
          final Symbol _symbol_name = _symbols[offset + 2];
          final Access name = (Access) _symbol_name.value;
          ...
          Annotation a =
              new Annotation(
                  "annotation", name, new List().add(new ElementValuePair("value", element_value)));
          a.setStart(AT.getStart());
          a.setEnd(RPAREN.getEnd());
          return a;
        }
      ...
      case 374: // compilation_unit = modifiers.a package_declaration.p import_declarations.i
        // type_declarations.t
        {
          final Symbol _symbol_a = _symbols[offset + 1];
          final List a = (List) _symbol_a.value;
      ...
      case 377: // enhanced_for_statement = FOR.FOR LPAREN.LPAREN enhanced_for_parameter.p
        // COLON.COLON expression.e RPAREN.RPAREN statement.s
        {
          final Symbol FOR = _symbols[offset + 1];
          final Symbol LPAREN = _symbols[offset + 2];
          final Symbol _symbol_p = _symbols[offset + 3];
      ...
      case 378: // enhanced_for_statement_no_short_if = FOR.FOR LPAREN.LPAREN
        // enhanced_for_parameter.p COLON.COLON expression.e RPAREN.RPAREN
        // statement_no_short_if.s
        {
          final Symbol FOR = _symbols[offset + 1];
          final Symbol LPAREN = _symbols[offset + 2];
      ...
      case 379: // enhanced_for_parameter = type.t IDENTIFIER.IDENTIFIER dims_opt.d
        {
          ...
          return new VariableDeclaration(
              new Modifiers(new List()), t.addArrayDims(d), IDENTIFIER, new Opt());
        }
      case 380: // enhanced_for_parameter = modifiers.m type.t IDENTIFIER.IDENTIFIER
        // dims_opt.d
        {
          final Symbol _symbol_m = _symbols[offset + 1];
          final List m = (List) _symbol_m.value;
          ...
          final List d = (List) _symbol_d.value;
          return new VariableDeclaration(
              new Modifiers(m), t.addArrayDims(d), IDENTIFIER, new Opt());
        }
      ...
      case 387: // enum_declaration = modifiers.m ENUM.ENUM IDENTIFIER.id interfaces.i
        // enum_body.b
        {
          final Symbol _symbol_m = _symbols[offset + 1];
          final List m = (List) _symbol_m.value;
      ...
      case 391: // enum_body = LBRACE.LBRACE enum_constants.enum_constants COMMA.COMMA
        // RBRACE.RBRACE
        {
          final Symbol LBRACE = _symbols[offset + 1];
          final Symbol _symbol_enum_constants = _symbols[offset + 2];
      ...
      case 392: // enum_body = LBRACE.LBRACE enum_body_declarations.enum_body_declarations
        // RBRACE.RBRACE
        {
          final Symbol LBRACE = _symbols[offset + 1];
      ...
      case 393: // enum_body = LBRACE.LBRACE enum_constants.c enum_body_declarations.d
        // RBRACE.RBRACE
        {
          final Symbol LBRACE = _symbols[offset + 1];
          final Symbol _symbol_c = _symbols[offset + 2];
          ...
          final List d = (List) _symbol_d.value;
          final Symbol RBRACE = _symbols[offset + 4];
          for (int i = 0; i < d.getNumChildNoTransform(); i++) c.add(d.getChildNoTransform(i));
          return c;
        }
      case 394: // enum_body = LBRACE.LBRACE COMMA.COMMA
        // enum_body_declarations.enum_body_declarations RBRACE.RBRACE
        {
          final Symbol LBRACE = _symbols[offset + 1];
          final Symbol COMMA = _symbols[offset + 2];
      ...
      case 395: // enum_body = LBRACE.LBRACE enum_constants.c COMMA.COMMA
        // enum_body_declarations.d RBRACE.RBRACE
        {
          final Symbol LBRACE = _symbols[offset + 1];
          final Symbol _symbol_c = _symbols[offset + 2];
          final List c = (List) _symbol_c.value;
      ...
      case 397: // enum_constants = enum_constants.enum_constants COMMA.COMMA
      ...
      case 398: // enum_constant = IDENTIFIER.id
        {
          ...
          return new EnumConstant(
              new Modifiers(new List()), ((String) id.value), new List(), new List());
        }
      case 399: // enum_constant = annotations.annotations IDENTIFIER.id
        {
          ...
          final Symbol id = _symbols[offset + 2];
          return new EnumConstant(
              new Modifiers(annotations), ((String) id.value), new List(), new List());
        }
      case 400: // enum_constant = IDENTIFIER.id arguments.arguments
        {
          ...
          return new EnumConstant(
              new Modifiers(new List()), ((String) id.value), arguments, new List());
        }
      case 401: // enum_constant = annotations.annotations IDENTIFIER.id arguments.arguments
        {
          ...
          final List arguments = (List) _symbol_arguments.value;
          return new EnumConstant(
              new Modifiers(annotations), ((String) id.value), arguments, new List());
        }
      case 402: // enum_constant = IDENTIFIER.id class_body.class_body
        {
          ...
          return new EnumConstant(
              new Modifiers(new List()), ((String) id.value), new List(), class_body);
        }
      case 403: // enum_constant = annotations.annotations IDENTIFIER.id class_body.class_body
        {
          ...
          final List class_body = (List) _symbol_class_body.value;
          return new EnumConstant(
              new Modifiers(annotations), ((String) id.value), new List(), class_body);
        }
      case 404: // enum_constant = IDENTIFIER.id arguments.arguments class_body.class_body
        {
          ...
          final List class_body = (List) _symbol_class_body.value;
          return new EnumConstant(
              new Modifiers(new List()), ((String) id.value), arguments, class_body);
        }
      case 405: // enum_constant = annotations.annotations IDENTIFIER.id arguments.arguments
        // class_body.class_body
        {
          ...
          final List class_body = (List) _symbol_class_body.value;
          return new EnumConstant(
              new Modifiers(annotations), ((String) id.value), arguments, class_body);
        }
      ...
      case 409: // enum_body_declarations = SEMICOLON.SEMICOLON
      ...
      case 410: // explicit_constructor_invocation = type_arguments.a THIS.THIS LPAREN.LPAREN
        // argument_list_opt.l RPAREN.RPAREN SEMICOLON.SEMICOLON
        {
          final Symbol _symbol_a = _symbols[offset + 1];
          final List a = (List) _symbol_a.value;
      ...
      case 411: // explicit_constructor_invocation = type_arguments.a SUPER.SUPER
        // LPAREN.LPAREN argument_list_opt.l RPAREN.RPAREN SEMICOLON.SEMICOLON
        {
          final Symbol _symbol_a = _symbols[offset + 1];
          final List a = (List) _symbol_a.value;
      ...
      case 412: // explicit_constructor_invocation = primary.p DOT.DOT type_arguments.a
        // SUPER.SUPER LPAREN.LPAREN argument_list_opt.l RPAREN.RPAREN
        // SEMICOLON.SEMICOLON
        {
          final Symbol _symbol_p = _symbols[offset + 1];
          final Expr p = (Expr) _symbol_p.value;
      ...
      case 413: // explicit_constructor_invocation = name.n DOT.DOT type_arguments.a
        // SUPER.SUPER LPAREN.LPAREN argument_list_opt.l RPAREN.RPAREN
        // SEMICOLON.SEMICOLON
        {
          final Symbol _symbol_n = _symbols[offset + 1];
      ...
      case 414: // method_invocation = primary.p DOT.DOT type_arguments.a
        // IDENTIFIER.IDENTIFIER LPAREN.LPAREN argument_list_opt.l RPAREN.RPAREN
        {
          final Symbol _symbol_p = _symbols[offset + 1];
          final Expr p = (Expr) _symbol_p.value;
      ...
      case 415: // method_invocation = name.n DOT.DOT type_arguments.a IDENTIFIER.IDENTIFIER
        // LPAREN.LPAREN argument_list_opt.l RPAREN.RPAREN
        {
          final Symbol _symbol_n = _symbols[offset + 1];
          final Access n = (Access) _symbol_n.value;
          final Symbol DOT = _symbols[offset + 2];
      ...
      case 416: // method_invocation = SUPER.SUPER DOT.DOT type_arguments.a
        // IDENTIFIER.IDENTIFIER LPAREN.LPAREN argument_list_opt.l RPAREN.RPAREN
        {
          final Symbol SUPER = _symbols[offset + 1];
          final Symbol DOT = _symbols[offset + 2];
          ...
          final List l = (List) _symbol_l.value;
          final Symbol RPAREN = _symbols[offset + 7];
          return new SuperAccess("super").qualifiesAccess(new ParMethodAccess(IDENTIFIER, l, a));
        }
      case 417: // method_invocation = name.n DOT.d1 SUPER.SUPER DOT.d2 type_arguments.a
        // IDENTIFIER.IDENTIFIER LPAREN.LPAREN argument_list_opt.l RPAREN.RPAREN
        {
          final Symbol _symbol_n = _symbols[offset + 1];
          final Access n = (Access) _symbol_n.value;
          ...
          return n.qualifiesAccess(new SuperAccess("super"))
              .qualifiesAccess(new ParMethodAccess(IDENTIFIER, l, a));
        }
      case 418: // method_header = LT.LT type_parameter_list_1.l type.t IDENTIFIER.IDENTIFIER
        // LPAREN.LPAREN formal_parameter_list_opt.p RPAREN.RPAREN
        {
      ...
      case 419: // method_header = modifiers.m LT.LT type_parameter_list_1.l type.t
        // IDENTIFIER.IDENTIFIER LPAREN.LPAREN formal_parameter_list_opt.p
        // RPAREN.RPAREN
        {
          final Symbol _symbol_m = _symbols[offset + 1];
          final List m = (List) _symbol_m.value;
      ...
      case 420: // method_header = LT.LT type_parameter_list_1.l type.t IDENTIFIER.IDENTIFIER
        // LPAREN.LPAREN formal_parameter_list_opt.p RPAREN.RPAREN dims.d
        {
          final Symbol LT = _symbols[offset + 1];
          final Symbol _symbol_l = _symbols[offset + 2];
          final List l = (List) _symbol_l.value;
      ...
      case 421: // method_header = modifiers.m LT.LT type_parameter_list_1.l type.t
        // IDENTIFIER.IDENTIFIER LPAREN.LPAREN formal_parameter_list_opt.p
        // RPAREN.RPAREN dims.d
        {
          final Symbol _symbol_m = _symbols[offset + 1];
          final List m = (List) _symbol_m.value;
          final Symbol LT = _symbols[offset + 2];
          ...
          final List d = (List) _symbol_d.value;
          return new GenericMethodDecl(
              new Modifiers(m), t.addArrayDims(d), IDENTIFIER, p, new List(), new Opt(), l);
        }
      case 422: // method_header = LT.LT type_parameter_list_1.l type.t IDENTIFIER.IDENTIFIER
        // LPAREN.LPAREN formal_parameter_list_opt.p RPAREN.RPAREN throws.tl
        {
          final Symbol LT = _symbols[offset + 1];
          final Symbol _symbol_l = _symbols[offset + 2];
          final List l = (List) _symbol_l.value;
      ...
      case 423: // method_header = modifiers.m LT.LT type_parameter_list_1.l type.t
        // IDENTIFIER.IDENTIFIER LPAREN.LPAREN formal_parameter_list_opt.p
        // RPAREN.RPAREN throws.tl
        {
          final Symbol _symbol_m = _symbols[offset + 1];
          final List m = (List) _symbol_m.value;
          final Symbol LT = _symbols[offset + 2];
          ...
          final List tl = (List) _symbol_tl.value;
          return new GenericMethodDecl(
              new Modifiers(m), t.addArrayDims(new List()), IDENTIFIER, p, tl, new Opt(), l);
        }
      case 424: // method_header = LT.LT type_parameter_list_1.l type.t IDENTIFIER.IDENTIFIER
        // LPAREN.LPAREN formal_parameter_list_opt.p RPAREN.RPAREN dims.d throws.tl
        {
          final Symbol LT = _symbols[offset + 1];
          final Symbol _symbol_l = _symbols[offset + 2];
          final List l = (List) _symbol_l.value;
          ...
          final List tl = (List) _symbol_tl.value;
          return new GenericMethodDecl(
              new Modifiers(new List()), t.addArrayDims(d), IDENTIFIER, p, tl, new Opt(), l);
        }
      case 425: // method_header = modifiers.m LT.LT type_parameter_list_1.l type.t
        // IDENTIFIER.IDENTIFIER LPAREN.LPAREN formal_parameter_list_opt.p
        // RPAREN.RPAREN dims.d throws.tl
        {
          final Symbol _symbol_m = _symbols[offset + 1];
          final List m = (List) _symbol_m.value;
          final Symbol LT = _symbols[offset + 2];
          ...
          final List tl = (List) _symbol_tl.value;
          return new GenericMethodDecl(
              new Modifiers(m), t.addArrayDims(d), IDENTIFIER, p, tl, new Opt(), l);
        }
      case 426: // method_header = LT.LT type_parameter_list_1.l VOID.VOID
        // IDENTIFIER.IDENTIFIER LPAREN.LPAREN formal_parameter_list_opt.p
        // RPAREN.RPAREN throws_opt.tl
        {
          final Symbol LT = _symbols[offset + 1];
          final Symbol _symbol_l = _symbols[offset + 2];
          final List l = (List) _symbol_l.value;
      ...
      case 427: // method_header = modifiers.m LT.LT type_parameter_list_1.l VOID.VOID
        // IDENTIFIER.IDENTIFIER LPAREN.LPAREN formal_parameter_list_opt.p
        // RPAREN.RPAREN throws_opt.tl
        {
          final Symbol _symbol_m = _symbols[offset + 1];
          ...
          final List tl = (List) _symbol_tl.value;
          return new GenericMethodDecl(
              new Modifiers(m), new PrimitiveTypeAccess("void"), IDENTIFIER, p, tl, new Opt(), l);
        }
      case 428: // constructor_declaration = LT.LT type_parameter_list_1.l
        // IDENTIFIER.IDENTIFIER LPAREN.LPAREN formal_parameter_list_opt.pl
        // RPAREN.RPAREN throws_opt.tl LBRACE.LBRACE RBRACE.RBRACE
        {
          final Symbol LT = _symbols[offset + 1];
          final Symbol _symbol_l = _symbols[offset + 2];
          final List l = (List) _symbol_l.value;
          ...
          return new GenericConstructorDecl(
              new Modifiers(new List()), IDENTIFIER, pl, tl, new Opt(), new Block(new List()), l);
        }
      case 429: // constructor_declaration = modifiers.m LT.LT type_parameter_list_1.l
        // IDENTIFIER.IDENTIFIER LPAREN.LPAREN formal_parameter_list_opt.pl
        // RPAREN.RPAREN throws_opt.tl LBRACE.LBRACE RBRACE.RBRACE
        {
          final Symbol _symbol_m = _symbols[offset + 1];
          ...
          final Symbol RBRACE = _symbols[offset + 10];
          return new GenericConstructorDecl(
              new Modifiers(m), IDENTIFIER, pl, tl, new Opt(), new Block(new List()), l);
        }
      case 430: // constructor_declaration = LT.LT type_parameter_list_1.l
        // IDENTIFIER.IDENTIFIER LPAREN.LPAREN formal_parameter_list_opt.pl
        // RPAREN.RPAREN throws_opt.tl LBRACE.LBRACE explicit_constructor_invocation.c
        // RBRACE.RBRACE
        {
          final Symbol LT = _symbols[offset + 1];
          final Symbol _symbol_l = _symbols[offset + 2];
          ...
          final Symbol RBRACE = _symbols[offset + 10];
          return new GenericConstructorDecl(
              new Modifiers(new List()), IDENTIFIER, pl, tl, new Opt(c), new Block(new List()), l);
        }
      case 431: // constructor_declaration = modifiers.m LT.LT type_parameter_list_1.l
        // IDENTIFIER.IDENTIFIER LPAREN.LPAREN formal_parameter_list_opt.pl
        // RPAREN.RPAREN throws_opt.tl LBRACE.LBRACE explicit_constructor_invocation.c
        // RBRACE.RBRACE
        {
          ...
          return new GenericConstructorDecl(
              new Modifiers(m), IDENTIFIER, pl, tl, new Opt(c), new Block(new List()), l);
        }
      case 432: // constructor_declaration = LT.LT type_parameter_list_1.l
        // IDENTIFIER.IDENTIFIER LPAREN.LPAREN formal_parameter_list_opt.pl
        // RPAREN.RPAREN throws_opt.tl LBRACE.LBRACE block_statements.bl RBRACE.RBRACE
        {
          final Symbol LT = _symbols[offset + 1];
          final Symbol _symbol_l = _symbols[offset + 2];
          final List l = (List) _symbol_l.value;
          ...
          final Symbol RBRACE = _symbols[offset + 10];
          return new GenericConstructorDecl(
              new Modifiers(new List()), IDENTIFIER, pl, tl, new Opt(), new Block(bl), l);
        }
      case 433: // constructor_declaration = modifiers.m LT.LT type_parameter_list_1.l
        // IDENTIFIER.IDENTIFIER LPAREN.LPAREN formal_parameter_list_opt.pl
        // RPAREN.RPAREN throws_opt.tl LBRACE.LBRACE block_statements.bl RBRACE.RBRACE
        {
          final Symbol _symbol_m = _symbols[offset + 1];
          ...
          final Symbol RBRACE = _symbols[offset + 11];
          return new GenericConstructorDecl(
              new Modifiers(m), IDENTIFIER, pl, tl, new Opt(), new Block(bl), l);
        }
      case 434: // constructor_declaration = LT.LT type_parameter_list_1.l
        // IDENTIFIER.IDENTIFIER LPAREN.LPAREN formal_parameter_list_opt.pl
        // RPAREN.RPAREN throws_opt.tl LBRACE.LBRACE explicit_constructor_invocation.c
        // block_statements.bl RBRACE.RBRACE
        {
          final Symbol LT = _symbols[offset + 1];
          final Symbol _symbol_l = _symbols[offset + 2];
          final List l = (List) _symbol_l.value;
      ...
      case 435: // constructor_declaration = modifiers.m LT.LT type_parameter_list_1.l
        // IDENTIFIER.IDENTIFIER LPAREN.LPAREN formal_parameter_list_opt.pl
        // RPAREN.RPAREN throws_opt.tl LBRACE.LBRACE explicit_constructor_invocation.c
        // block_statements.bl RBRACE.RBRACE
        {
      ...
      case 436: // class_declaration = CLASS.CLASS IDENTIFIER.IDENTIFIER type_parameters.p
        // class_body.b
        {
          final Symbol CLASS = _symbols[offset + 1];
          final Symbol IDENTIFIER = _symbols[offset + 2];
          ...
          final Symbol _symbol_b = _symbols[offset + 4];
          final List b = (List) _symbol_b.value;
          return new GenericClassDecl(
              new Modifiers(new List()), IDENTIFIER, new Opt(), new List(), b, p);
        }
      case 437: // class_declaration = modifiers.m CLASS.CLASS IDENTIFIER.IDENTIFIER
        // type_parameters.p class_body.b
        {
          final Symbol _symbol_m = _symbols[offset + 1];
          final List m = (List) _symbol_m.value;
          final Symbol CLASS = _symbols[offset + 2];
      ...
      case 438: // class_declaration = CLASS.CLASS IDENTIFIER.IDENTIFIER type_parameters.p
        // super.s class_body.b
        {
          final Symbol CLASS = _symbols[offset + 1];
          final Symbol IDENTIFIER = _symbols[offset + 2];
          final Symbol _symbol_p = _symbols[offset + 3];
      ...
      case 439: // class_declaration = modifiers.m CLASS.CLASS IDENTIFIER.IDENTIFIER
        // type_parameters.p super.s class_body.b
        {
          final Symbol _symbol_m = _symbols[offset + 1];
          final List m = (List) _symbol_m.value;
          final Symbol CLASS = _symbols[offset + 2];
      ...
      case 440: // class_declaration = CLASS.CLASS IDENTIFIER.IDENTIFIER type_parameters.p
        // interfaces.i class_body.b
        {
          final Symbol CLASS = _symbols[offset + 1];
          final Symbol IDENTIFIER = _symbols[offset + 2];
      ...
      case 441: // class_declaration = modifiers.m CLASS.CLASS IDENTIFIER.IDENTIFIER
        // type_parameters.p interfaces.i class_body.b
        {
          final Symbol _symbol_m = _symbols[offset + 1];
          final List m = (List) _symbol_m.value;
          final Symbol CLASS = _symbols[offset + 2];
      ...
      case 442: // class_declaration = CLASS.CLASS IDENTIFIER.IDENTIFIER type_parameters.p
        // super.s interfaces.i class_body.b
        {
          final Symbol CLASS = _symbols[offset + 1];
          final Symbol IDENTIFIER = _symbols[offset + 2];
          final Symbol _symbol_p = _symbols[offset + 3];
      ...
      case 443: // class_declaration = modifiers.m CLASS.CLASS IDENTIFIER.IDENTIFIER
        // type_parameters.p super.s interfaces.i class_body.b
        {
          final Symbol _symbol_m = _symbols[offset + 1];
          final List m = (List) _symbol_m.value;
          final Symbol CLASS = _symbols[offset + 2];
      ...
      case 444: // interface_declaration = INTERFACE.INTERFACE IDENTIFIER.IDENTIFIER
        // type_parameters.p interface_body.b
        {
          final Symbol INTERFACE = _symbols[offset + 1];
          final Symbol IDENTIFIER = _symbols[offset + 2];
          final Symbol _symbol_p = _symbols[offset + 3];
      ...
      case 445: // interface_declaration = modifiers.m INTERFACE.INTERFACE
        // IDENTIFIER.IDENTIFIER type_parameters.p interface_body.b
        {
          final Symbol _symbol_m = _symbols[offset + 1];
          final List m = (List) _symbol_m.value;
          final Symbol INTERFACE = _symbols[offset + 2];
      ...
      case 446: // interface_declaration = INTERFACE.INTERFACE IDENTIFIER.IDENTIFIER
        // type_parameters.p extends_interfaces.i interface_body.b
        {
          final Symbol INTERFACE = _symbols[offset + 1];
          final Symbol IDENTIFIER = _symbols[offset + 2];
          final Symbol _symbol_p = _symbols[offset + 3];
      ...
      case 447: // interface_declaration = modifiers.m INTERFACE.INTERFACE
        // IDENTIFIER.IDENTIFIER type_parameters.p extends_interfaces.i
        // interface_body.b
        {
          final Symbol _symbol_m = _symbols[offset + 1];
          final List m = (List) _symbol_m.value;
      ...
      case 449: // class_or_interface = class_or_interface.n LT.LT type_argument_list_1.l
        // DOT.DOT name.end
        {
          final Symbol _symbol_n = _symbols[offset + 1];
          final Access n = (Access) _symbol_n.value;
      ...
      case 452: // array_type = class_or_interface.t LT.LT type_argument_list_1.l DOT.DOT
        // name.n dims.d
        {
          final Symbol _symbol_t = _symbols[offset + 1];
          final Access t = (Access) _symbol_t.value;
      ...
      case 467: // class_instance_creation_expression = NEW.NEW class_or_interface_type.t
        // LPAREN.LPAREN argument_list_opt.l RPAREN.RPAREN subclass_body_opt.b
        {
          final Symbol NEW = _symbols[offset + 1];
          final Symbol _symbol_t = _symbols[offset + 2];
          final Access t = (Access) _symbol_t.value;
      ...
      case 468: // class_instance_creation_expression = NEW.NEW type_arguments.a
        // class_or_interface_type.t LPAREN.LPAREN argument_list_opt.l RPAREN.RPAREN
        // subclass_body_opt.b
        {
          final Symbol NEW = _symbols[offset + 1];
      ...
      case 469: // class_instance_creation_expression = primary.n DOT.DOT NEW.NEW
        // simple_name.id LPAREN.LPAREN argument_list_opt.l RPAREN.RPAREN
        // subclass_body_opt.b
        {
          final Symbol _symbol_n = _symbols[offset + 1];
      ...
      case 470: // class_instance_creation_expression = primary.n DOT.DOT NEW.NEW
        // simple_name.id type_arguments.a LPAREN.LPAREN argument_list_opt.l
        // RPAREN.RPAREN subclass_body_opt.b
        {
          final Symbol _symbol_n = _symbols[offset + 1];
          final Expr n = (Expr) _symbol_n.value;
          final Symbol DOT = _symbols[offset + 2];
      ...
      case 471: // class_instance_creation_expression = primary.n DOT.DOT NEW.NEW
        // type_arguments.ca simple_name.id LPAREN.LPAREN argument_list_opt.l
        // RPAREN.RPAREN subclass_body_opt.b
        {
          final Symbol _symbol_n = _symbols[offset + 1];
          final Expr n = (Expr) _symbol_n.value;
      ...
      case 472: // class_instance_creation_expression = primary.n DOT.DOT NEW.NEW
        // type_arguments.ca simple_name.id type_arguments.ta LPAREN.LPAREN
        // argument_list_opt.l RPAREN.RPAREN subclass_body_opt.b
        {
          final Symbol _symbol_n = _symbols[offset + 1];
          final Expr n = (Expr) _symbol_n.value;
          final Symbol DOT = _symbols[offset + 2];
      ...
      case 473: // class_instance_creation_expression = name.n DOT.DOT NEW.NEW simple_name.id
        // LPAREN.LPAREN argument_list_opt.l RPAREN.RPAREN subclass_body_opt.b
        {
          final Symbol _symbol_n = _symbols[offset + 1];
          final Access n = (Access) _symbol_n.value;
      ...
      case 474: // class_instance_creation_expression = name.n DOT.DOT NEW.NEW simple_name.id
        // type_arguments.a LPAREN.LPAREN argument_list_opt.l RPAREN.RPAREN
        // subclass_body_opt.b
        {
          final Symbol _symbol_n = _symbols[offset + 1];
          final Access n = (Access) _symbol_n.value;
      ...
      case 475: // class_instance_creation_expression = name.n DOT.DOT NEW.NEW
        // type_arguments.ca simple_name.id LPAREN.LPAREN argument_list_opt.l
        // RPAREN.RPAREN subclass_body_opt.b
        {
          final Symbol _symbol_n = _symbols[offset + 1];
      ...
      case 476: // class_instance_creation_expression = name.n DOT.DOT NEW.NEW
        // type_arguments.ca simple_name.id type_arguments.ta LPAREN.LPAREN
        // argument_list_opt.l RPAREN.RPAREN subclass_body_opt.b
        {
          final Symbol _symbol_n = _symbols[offset + 1];
      ...
      case 498: // cast_expression = LPAREN.LPAREN name.n LT.LT type_argument_list_1.a
        // RPAREN.RPAREN unary_expression_not_plus_minus.e
        {
          final Symbol LPAREN = _symbols[offset + 1];
          final Symbol _symbol_n = _symbols[offset + 2];
          final Access n = (Access) _symbol_n.value;
      ...
      case 499: // cast_expression = LPAREN.LPAREN name.n LT.LT type_argument_list_1.a dims.d
        // RPAREN.RPAREN unary_expression_not_plus_minus.e
        {
          final Symbol LPAREN = _symbols[offset + 1];
          final Symbol _symbol_n = _symbols[offset + 2];
      ...
      case 500: // cast_expression = LPAREN.LPAREN name.n LT.LT type_argument_list_1.a DOT.DOT
        // class_or_interface_type.t RPAREN.RPAREN unary_expression_not_plus_minus.e
        {
          final Symbol LPAREN = _symbols[offset + 1];
          final Symbol _symbol_n = _symbols[offset + 2];
          final Access n = (Access) _symbol_n.value;
          ...
          final Expr e = (Expr) _symbol_e.value;
          return new CastExpr(
              new ParTypeAccess(n, a).qualifiesAccess(t).addArrayDims(new List()), e);
        }
      case 501: // cast_expression = LPAREN.LPAREN name.n LT.LT type_argument_list_1.a DOT.DOT
        // class_or_interface_type.t dims.d RPAREN.RPAREN
        // unary_expression_not_plus_minus.e
        {
          final Symbol LPAREN = _symbols[offset + 1];
          final Symbol _symbol_n = _symbols[offset + 2];
      ...
      case 506: // type_parameter_list_1 = type_parameter_list.l COMMA.COMMA
        // type_parameter_1.p
        {
          final Symbol _symbol_l = _symbols[offset + 1];
          final List l = (List) _symbol_l.value;
      ...
      case 523: // single_static_import_declaration = IMPORT.IMPORT STATIC.STATIC name.n
        // DOT.DOT IDENTIFIER.IDENTIFIER SEMICOLON.SEMICOLON
        {
          final Symbol IMPORT = _symbols[offset + 1];
      ...
      case 524: // static_import_on_demand_declaration = IMPORT.IMPORT STATIC.STATIC name.n
        // DOT.DOT MULT.MULT SEMICOLON.SEMICOLON
        {
          final Symbol IMPORT = _symbols[offset + 1];
          final Symbol STATIC = _symbols[offset + 2];
          final Symbol _symbol_n = _symbols[offset + 3];
      ...
      case 525: // formal_parameter = type.t ELLIPSIS.ELLIPSIS IDENTIFIER.IDENTIFIER
        // dims_opt.d
        {
          final Symbol _symbol_t = _symbols[offset + 1];
          final Access t = (Access) _symbol_t.value;
          ...
          return new VariableArityParameterDeclaration(
              new Modifiers(new List()), t.addArrayDims(d), IDENTIFIER);
        }
      case 526: // formal_parameter = modifiers.m type.t ELLIPSIS.ELLIPSIS
        // IDENTIFIER.IDENTIFIER dims_opt.d
        {
          final Symbol _symbol_m = _symbols[offset + 1];
          final List m = (List) _symbol_m.value;
          final Symbol _symbol_t = _symbols[offset + 2];
          ...
          final List d = (List) _symbol_d.value;
          return new VariableArityParameterDeclaration(
              new Modifiers(m), t.addArrayDims(d), IDENTIFIER);
        }
      ...
      case 555: // multiplicative_expression_nn = multiplicative_expression_nn.e1 MULT.MULT
        // unary_expression.e2
        {
          final Symbol _symbol_e1 = _symbols[offset + 1];
          final Expr e1 = (Expr) _symbol_e1.value;
      ...
      case 557: // multiplicative_expression_nn = multiplicative_expression_nn.e1 DIV.DIV
        // unary_expression.e2
        {
          final Symbol _symbol_e1 = _symbols[offset + 1];
          final Expr e1 = (Expr) _symbol_e1.value;
      ...
      case 559: // multiplicative_expression_nn = multiplicative_expression_nn.e1 MOD.MOD
        // unary_expression.e2
        {
          final Symbol _symbol_e1 = _symbols[offset + 1];
          final Expr e1 = (Expr) _symbol_e1.value;
      ...
      case 562: // additive_expression_nn = additive_expression_nn.e1 PLUS.PLUS
        // multiplicative_expression.e2
        {
          final Symbol _symbol_e1 = _symbols[offset + 1];
          final Expr e1 = (Expr) _symbol_e1.value;
      ...
      case 564: // additive_expression_nn = additive_expression_nn.e1 MINUS.MINUS
        // multiplicative_expression.e2
        {
          final Symbol _symbol_e1 = _symbols[offset + 1];
          final Expr e1 = (Expr) _symbol_e1.value;
      ...
      case 567: // shift_expression_nn = shift_expression_nn.e1 LSHIFT.LSHIFT
        // additive_expression.e2
        {
          final Symbol _symbol_e1 = _symbols[offset + 1];
          final Expr e1 = (Expr) _symbol_e1.value;
      ...
      case 569: // shift_expression_nn = shift_expression_nn.e1 RSHIFT.RSHIFT
        // additive_expression.e2
        {
          final Symbol _symbol_e1 = _symbols[offset + 1];
          final Expr e1 = (Expr) _symbol_e1.value;
      ...
      case 571: // shift_expression_nn = shift_expression_nn.e1 URSHIFT.URSHIFT
        // additive_expression.e2
        {
          final Symbol _symbol_e1 = _symbols[offset + 1];
          final Expr e1 = (Expr) _symbol_e1.value;
      ...
      case 578: // relational_expression_nn = relational_expression_nn.e1 LTEQ.LTEQ
        // shift_expression.e2
        {
          final Symbol _symbol_e1 = _symbols[offset + 1];
          final Expr e1 = (Expr) _symbol_e1.value;
      ...
      case 580: // relational_expression_nn = relational_expression_nn.e1 GTEQ.GTEQ
        // shift_expression.e2
        {
          final Symbol _symbol_e1 = _symbols[offset + 1];
          final Expr e1 = (Expr) _symbol_e1.value;
      ...
      case 582: // relational_expression_nn = relational_expression_nn.e INSTANCEOF.INSTANCEOF
        // reference_type.t
        {
          final Symbol _symbol_e = _symbols[offset + 1];
          final Expr e = (Expr) _symbol_e.value;
      ...
      case 585: // equality_expression_nn = equality_expression_nn.e1 EQEQ.EQEQ
        // relational_expression.e2
        {
          final Symbol _symbol_e1 = _symbols[offset + 1];
          final Expr e1 = (Expr) _symbol_e1.value;
      ...
      case 587: // equality_expression_nn = equality_expression_nn.e1 NOTEQ.NOTEQ
        // relational_expression.e2
        {
          final Symbol _symbol_e1 = _symbols[offset + 1];
          final Expr e1 = (Expr) _symbol_e1.value;
      ...
      case 593: // exclusive_or_expression_nn = exclusive_or_expression_nn.e1 XOR.XOR
        // and_expression.e2
        {
          final Symbol _symbol_e1 = _symbols[offset + 1];
          final Expr e1 = (Expr) _symbol_e1.value;
      ...
      case 596: // inclusive_or_expression_nn = inclusive_or_expression_nn.e1 OR.OR
        // exclusive_or_expression.e2
        {
          final Symbol _symbol_e1 = _symbols[offset + 1];
          final Expr e1 = (Expr) _symbol_e1.value;
      ...
      case 598: // conditional_and_expression_nn = name.e1 ANDAND.ANDAND
        // inclusive_or_expression.e2
        {
          final Symbol _symbol_e1 = _symbols[offset + 1];
          final Access e1 = (Access) _symbol_e1.value;
      ...
      case 599: // conditional_and_expression_nn = conditional_and_expression_nn.e1
        // ANDAND.ANDAND inclusive_or_expression.e2
        {
          final Symbol _symbol_e1 = _symbols[offset + 1];
          final Expr e1 = (Expr) _symbol_e1.value;
          final Symbol ANDAND = _symbols[offset + 2];
      ...
      case 601: // conditional_or_expression_nn = name.e1 OROR.OROR
        // conditional_and_expression.e2
        {
          final Symbol _symbol_e1 = _symbols[offset + 1];
          final Access e1 = (Access) _symbol_e1.value;
      ...
      case 602: // conditional_or_expression_nn = conditional_or_expression_nn.e1 OROR.OROR
        // conditional_and_expression.e2
        {
          final Symbol _symbol_e1 = _symbols[offset + 1];
          final Expr e1 = (Expr) _symbol_e1.value;
      ...
      case 604: // conditional_expression_nn = name.c QUESTION.QUESTION expression.e1
        // COLON.COLON conditional_expression.e2
        {
          final Symbol _symbol_c = _symbols[offset + 1];
          final Access c = (Access) _symbol_c.value;
          final Symbol QUESTION = _symbols[offset + 2];
      ...
      case 605: // conditional_expression_nn = conditional_or_expression_nn.c
        // QUESTION.QUESTION expression.e1 COLON.COLON conditional_expression.e2
        {
          final Symbol _symbol_c = _symbols[offset + 1];
          final Expr c = (Expr) _symbol_c.value;
          final Symbol QUESTION = _symbols[offset + 2];
      ...
      case 615: // annotation_type_element_declarations_opt =
      ...
      case 345: // annotation_type_element_declaration =
