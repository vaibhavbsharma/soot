 ...
 *
 * @production Literal : {@link PrimaryExpr} ::= <span
 *     class="component">&lt;LITERAL:String&gt;</span>;
 * @ast node
...
public abstract class Literal extends PrimaryExpr implements Cloneable {
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/BytecodeCONSTANT.jrag:75
   */
   ...
   * @aspect BytecodeCONSTANT
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/BytecodeCONSTANT.jrag:79
   */
   ...
   * @aspect PrettyPrint
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/PrettyPrint.jadd:263
   */
   ...
   * @aspect PrettyPrint
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/PrettyPrint.jadd:290
   */
    ...
    for (int i = 0; i < s.length(); i++) {
      switch (s.charAt(i)) {
        ...
        default:
          ...
          if (value < 0x20 || (value > 0x7e)) result.append(asEscape(value));
   ...
   * @aspect PrettyPrint
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/PrettyPrint.jadd:312
   */
  protected static String asEscape(int value) {
    StringBuffer s = new StringBuffer("\\u");
    String hex = Integer.toHexString(value);
    for (int i = 0; i < 4 - hex.length(); i++) s.append("0");
    s.append(hex);
    return s.toString();
  }
  /** @ast method */
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/ConstantExpression.jrag:96
   */
  @SuppressWarnings({"unchecked", "cast"})
