...
/**
 * @production VariableDecl : {@link ASTNode} ::= <span class="component">&lt;ID:String&gt;</span>
 *     <span class="component">{@link Dims}*</span> <span class="component">[Init:{@link
 *     Expr}]</span>;
 * @ast node
...
public class VariableDecl extends ASTNode<ASTNode> implements Cloneable {
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/VariableDeclaration.jrag:182
   */
  public VariableDeclaration createVariableDeclarationFrom(Modifiers modifiers, Access type) {
    VariableDeclaration decl =
        new VariableDeclaration(modifiers, type.addArrayDims(getDimsList()), getID(), getInitOpt());
   ...
   * @aspect VariableDeclarationTransformation
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/VariableDeclaration.jrag:196
   */
  public FieldDeclaration createFieldDeclarationFrom(Modifiers modifiers, Access type) {
    FieldDeclaration decl =
        new FieldDeclaration(modifiers, type.addArrayDims(getDimsList()), getID(), getInitOpt());
    decl.setStart(start); // copy location information
    decl.setEnd(end); // copy location information
    decl.IDstart = IDstart;
    decl.IDend = IDend;
  ...
  /**
   * Retrieves the number of children in the Dims list. Calling this method will not trigger
   * rewrites..
   *
   * @return Number of children in the Dims list.
   * @apilevel low-level
   ...
   * @aspect Variables
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/VariableDeclaration.jrag:84
   */
  public String name() {
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:41
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Backend/InnerClasses.jrag:69
   * @apilevel internal
   */
