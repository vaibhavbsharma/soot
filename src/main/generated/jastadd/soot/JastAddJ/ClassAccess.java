...
public class ClassAccess extends Access implements Cloneable {
   ...
   * @aspect NameCheck
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/NameCheck.jrag:177
   */
   ...
   * @aspect PrettyPrint
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/PrettyPrint.jadd:520
   */
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Backend/Transformations.jrag:160
   */
  public void transformation() {
    ...
    if (isQualified() && qualifier().type().isReferenceType()) {
      ...
      FieldDeclaration f =
          hostType()
              .topLevelType()
              .createStaticClassField(prevExpr().type().referenceClassFieldName());
    }
  }
  /**
   * @ast method
   * @aspect Expressions
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/JimpleBackend/Expressions.jrag:911
   */
  public soot.Value eval(Body b) {
    if (prevExpr().type().isPrimitiveType() || prevExpr().type().isVoid()) {
      ...
      b.setLine(this);
      b.add(b.newIfStmt(b.newNeExpr(ref, soot.jimple.NullConstant.v(), this), next_label, this));
      // emit string literal
   ...
   * @aspect TypeAnalysis
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeAnalysis.jrag:401
   */
   ...
   * @aspect Generics
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:119
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  private TypeDecl type_compute() {
    ...
    if (type.isPrimitiveType()) type = type.boxed();
    ArrayList list = new ArrayList();
    list.add(type);
