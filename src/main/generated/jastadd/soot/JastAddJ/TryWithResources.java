 ...
 *
 * @production TryWithResources : {@link TryStmt} ::= <span class="component">Resource:{@link
 *     ResourceDeclaration}*</span> <span class="component">{@link Block}</span> <span
 *     class="component">{@link CatchClause}*</span> <span class="component">[Finally:{@link
 *     Block}]</span>;
 * @ast node
 * @declaredat
 *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TryWithResources.ast:4
 */
public class TryWithResources extends TryStmt implements Cloneable, VariableScope {
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TryWithResources.jrag:40
   */
        ...
        if (!twrHandlesException(exceptionType))
          error(
              "automatic closing of resource "
                  + resource.name()
                  + " may raise the uncaught exception "
  ...
  /**
   * Returns true if the try-with-resources statement can throw an exception of type (or a subtype
   * of) catchType.
   *
   * @ast method
   * @aspect TryWithResources
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TryWithResources.jrag:181
   */
  protected boolean reachedException(TypeDecl catchType) {
    boolean found = false;
    // found is true if the exception type is caught by a catch clause
    for (int i = 0; i < getNumCatchClause() && !found; i++)
      if (getCatchClause(i).handles(catchType)) found = true;
    ...
    if (!found && (!hasFinally() || getFinally().canCompleteNormally()))
      if (catchableException(catchType)) return true;
    // even if the exception is caught by the catch clauses they may
    // throw new exceptions
    for (int i = 0; i < getNumCatchClause(); i++)
      if (getCatchClause(i).reachedException(catchType)) return true;
   ...
   * @aspect PrettyPrint
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TryWithResources.jrag:244
   */
  ...
  /** @ast method */
  public TryWithResources(
      List<ResourceDeclaration> p0, Block p1, List<CatchClause> p2, Opt<Block> p3) {
    setChild(p0, 0);
    setChild(p1, 1);
    setChild(p2, 2);
    setChild(p3, 3);
  ...
  /**
   * Retrieves the number of children in the Resource list. Calling this method will not trigger
   * rewrites..
   *
   * @return Number of children in the Resource list.
   * @apilevel low-level
  ...
  public void addResource(ResourceDeclaration node) {
    List<ResourceDeclaration> list =
        (parent == null || state == null) ? getResourceListNoTransform() : getResourceList();
    list.addChild(node);
  }
  /**
   * @apilevel low-level
  ...
  /**
   * This attribute computes whether or not the TWR statement has a catch clause which handles the
   * exception.
   *
   * @attribute syn
   * @aspect TryWithResources
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TryWithResources.jrag:60
   */
  ...
  /**
   * Returns true if exceptions of type exceptionType are handled in the try-with-resources
   * statement or any containing statement within the directly enclosing method or initializer
   * block.
   *
   * @attribute syn
   * @aspect TryWithResources
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TryWithResources.jrag:72
   */
  public boolean twrHandlesException(TypeDecl exceptionType) {
    ASTNode$State state = state();
    try {
      if (catchHandlesException(exceptionType)) return true;
   ...
   * @aspect TryWithResources
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TryWithResources.jrag:95
   */
  public MethodDecl lookupClose(ResourceDeclaration resource) {
    ...
    try {
       ...
       */
      // throw new RuntimeException("close() not found for resource type
   ...
   * @aspect TryWithResources
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TryWithResources.jrag:128
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect TryWithResources
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TryWithResources.jrag:133
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  private VariableDeclaration localVariableDeclaration_compute(String name) {
    for (ResourceDeclaration resource : getResourceList())
      if (resource.declaresVariable(name)) return resource;
    return null;
  }
   ...
   * @aspect TryWithResources
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TryWithResources.jrag:167
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  /**
   * True if the automatic closing of resources in this try-with-resources statement may throw an
   * exception of type catchType.
   *
   * @attribute syn
   * @aspect TryWithResources
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TryWithResources.jrag:204
   */
  public boolean resourceClosingException(TypeDecl catchType) {
    ...
    try {
      for (ResourceDeclaration resource : getResourceList()) {
        ...
        for (Access exception : close.getExceptionList()) {
          TypeDecl exceptionType = exception.type();
          if (catchType.mayCatch(exception.type())) return true;
        }
      }
      return false;
    } finally {
  ...
  /**
   * True if the resource initialization of this try-with-resources statement may throw an exception
   * of type catchType.
   *
   * @attribute syn
   * @aspect TryWithResources
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TryWithResources.jrag:221
   */
   ...
   * @aspect TryWithResources
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TryWithResources.jrag:232
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect TryWithResources
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TryWithResources.jrag:83
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect TryWithResources
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TryWithResources.jrag:110
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect TryWithResources
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TryWithResources.jrag:111
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect TryWithResources
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TryWithResources.jrag:141
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect TryWithResources
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TryWithResources.jrag:145
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TryWithResources.jrag:88
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TryWithResources.jrag:113
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TryWithResources.jrag:127
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TryWithResources.jrag:142
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TryWithResources.jrag:146
   * @apilevel internal
   */
    ...
    if (caller == getResourceListNoTransform()) {
      int index = caller.getIndexOfChild(child);
      {
        for (int i = 0; i < index; ++i) {
          if (getResource(i).name().equals(name)) return true;
        }
        return false;
      }
    } else {
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TryWithResources.jrag:173
   * @apilevel internal
   */
