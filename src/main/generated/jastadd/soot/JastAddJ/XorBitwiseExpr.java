...
public class XorBitwiseExpr extends BitwiseExpr implements Cloneable {
   ...
   * @aspect Expressions
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/JimpleBackend/Expressions.jrag:835
   */
  ...
  public Constant constant() {
    ...
    try {
      return type().xorBitwise(getLeftOperand().constant(), getRightOperand().constant());
    } finally {
    }
  }
  /**
