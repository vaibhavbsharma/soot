...
/**
 * @production GenericClassDeclSubstituted : {@link GenericClassDecl} ::= <span
 *     class="component">&lt;Original:TypeDecl&gt;</span> <span class="component">{@link
 *     BodyDecl}*</span>;
 * @ast node
 * @declaredat /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.ast:43
 */
public class GenericClassDeclSubstituted extends GenericClassDecl
    implements Cloneable, MemberSubstitutor {
  /** @apilevel low-level */
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:1052
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:1508
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericsSubtype.jrag:488
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect GenericsSubtype
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericsSubtype.jrag:511
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  public boolean supertypeGenericClassDeclSubstituted(GenericClassDeclSubstituted type) {
    ASTNode$State state = state();
    try {
      return original() == type.original() && type.enclosingType().subtype(enclosingType())
  ...
  public boolean supertypeGenericClassDecl(GenericClassDecl type) {
    ASTNode$State state = state();
    try {
      return super.supertypeGenericClassDecl(type) || original().supertypeGenericClassDecl(type);
    } finally {
    }
  }
  /** @apilevel internal */
