...
/**
 * Literal produced when the compiler tries to parse a malformatted NumericLiteral. This literal
 * kind has an associated error message.
 *
...
public class IllegalLiteral extends Literal implements Cloneable {
   ...
   * @aspect Literals
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/Literals.jrag:469
   */
  ...
  /**
   * The type of an IllegalLiteral does not matter, as it is only a placeholder literal for error
   * messages.
   *
   * @attribute syn
   * @aspect Literals
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/Literals.jrag:457
   */
  @SuppressWarnings({"unchecked", "cast"})
