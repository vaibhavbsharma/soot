...
public class Modifiers extends ASTNode<ASTNode> implements Cloneable {
   ...
   * @aspect Modifiers
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/Modifiers.jrag:314
   */
  public void checkModifiers() {
    super.checkModifiers();
    if (numProtectionModifiers() > 1) error("only one public, protected, private allowed");
    if (numModifier("static") > 1) error("only one static allowed");
    // 8.4.3.1
    // 8.4.3.2
    // 8.1.1.2
    if (numCompletenessModifiers() > 1) error("only one of final, abstract, volatile allowed");
    if (numModifier("synchronized") > 1) error("only one synchronized allowed");
    if (numModifier("transient") > 1) error("only one transient allowed");
    if (numModifier("native") > 1) error("only one native allowed");
    if (numModifier("strictfp") > 1) error("only one strictfp allowed");

    if (isPublic() && !mayBePublic()) error("modifier public not allowed in this context");
    if (isPrivate() && !mayBePrivate()) error("modifier private not allowed in this context");
    if (isProtected() && !mayBeProtected()) error("modifier protected not allowed in this context");
    if (isStatic() && !mayBeStatic()) error("modifier static not allowed in this context");
    if (isFinal() && !mayBeFinal()) error("modifier final not allowed in this context");
    if (isAbstract() && !mayBeAbstract()) error("modifier abstract not allowed in this context");
    if (isVolatile() && !mayBeVolatile()) error("modifier volatile not allowed in this context");
    if (isTransient() && !mayBeTransient()) error("modifier transient not allowed in this context");
    if (isStrictfp() && !mayBeStrictfp()) error("modifier strictfp not allowed in this context");
    if (isSynchronized() && !mayBeSynchronized())
      error("modifier synchronized not allowed in this context");
    if (isNative() && !mayBeNative()) error("modifier native not allowed in this context");
  }
  /**
   * @ast method
   * @aspect PrettyPrint
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/PrettyPrint.jadd:435
   */
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/Jimple1.5Backend/AnnotationsCodegen.jrag:83
   */
          ...
          if (!a.isRuntimeVisible() && !a.isRuntimeInvisible()) {
            soot.tagkit.VisibilityAnnotationTag tag =
                new soot.tagkit.VisibilityAnnotationTag(
                    soot.tagkit.AnnotationConstants.SOURCE_VISIBLE);
   ...
   * @aspect AnnotationsCodegen
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/Jimple1.5Backend/AnnotationsCodegen.jrag:101
   */
   ...
   * @aspect AnnotationsCodegen
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/Jimple1.5Backend/AnnotationsCodegen.jrag:110
   */
   ...
   * @aspect AnnotationsCodegen
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/Jimple1.5Backend/AnnotationsCodegen.jrag:125
   */
   ...
   * @aspect AnnotationsCodegen
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/Jimple1.5Backend/AnnotationsCodegen.jrag:210
   */
  public Collection runtimeVisibleAnnotations() {
    Collection annotations = new ArrayList();
    for (int i = 0; i < getNumModifier(); i++)
      if (getModifier(i).isRuntimeVisible()) annotations.add(getModifier(i));
    return annotations;
  }
  /**
   * @ast method
   * @aspect AnnotationsCodegen
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/Jimple1.5Backend/AnnotationsCodegen.jrag:266
   */
  public Collection runtimeInvisibleAnnotations() {
    Collection annotations = new ArrayList();
    for (int i = 0; i < getNumModifier(); i++)
      if (getModifier(i).isRuntimeInvisible()) annotations.add(getModifier(i));
    return annotations;
  }
  /**
   * @ast method
   * @aspect AnnotationsCodegen
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/Jimple1.5Backend/AnnotationsCodegen.jrag:290
   */
   ...
   * @aspect EnumsCodegen
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/Jimple1.5Backend/EnumsCodegen.jrag:12
   */
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/Jimple1.5Backend/GenericsCodegen.jrag:325
   */
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/Jimple1.5Backend/VariableArityParametersCodegen.jrag:78
   */
  ...
  /**
   * Retrieves the number of children in the Modifier list. Calling this method will not trigger
   * rewrites..
   *
   * @return Number of children in the Modifier list.
   * @apilevel low-level
  ...
  public void addModifier(Modifier node) {
    List<Modifier> list =
        (parent == null || state == null) ? getModifierListNoTransform() : getModifierList();
    list.addChild(node);
  }
  /**
   * @apilevel low-level
   ...
   * @aspect Modifiers
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/Modifiers.jrag:372
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect Modifiers
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/Modifiers.jrag:373
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect Modifiers
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/Modifiers.jrag:374
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect Modifiers
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/Modifiers.jrag:375
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect Modifiers
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/Modifiers.jrag:376
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect Modifiers
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/Modifiers.jrag:377
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect Modifiers
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/Modifiers.jrag:378
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect Modifiers
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/Modifiers.jrag:379
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect Modifiers
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/Modifiers.jrag:380
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect Modifiers
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/Modifiers.jrag:381
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect Modifiers
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/Modifiers.jrag:382
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect Modifiers
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/Modifiers.jrag:384
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect Modifiers
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/Modifiers.jrag:386
   */
   ...
   * @aspect Modifiers
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/Modifiers.jrag:389
   */
   ...
   * @aspect Modifiers
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/Modifiers.jrag:392
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect Annotations
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Annotations.jrag:214
   */
   ...
   * @aspect Annotations
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Annotations.jrag:289
   */
   ...
   * @aspect Annotations
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Annotations.jrag:319
   */
   ...
   * @aspect SafeVarargs
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/SafeVarargs.jrag:49
   */
   ...
   * @aspect Modifiers
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/Modifiers.jrag:358
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect Modifiers
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/Modifiers.jrag:360
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect Modifiers
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/Modifiers.jrag:361
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect Modifiers
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/Modifiers.jrag:362
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect Modifiers
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/Modifiers.jrag:363
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect Modifiers
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/Modifiers.jrag:364
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect Modifiers
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/Modifiers.jrag:365
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect Modifiers
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/Modifiers.jrag:366
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect Modifiers
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/Modifiers.jrag:367
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect Modifiers
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/Modifiers.jrag:368
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect Modifiers
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/Modifiers.jrag:369
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect Modifiers
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/Modifiers.jrag:370
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect Annotations
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Annotations.jrag:56
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Annotations.jrag:424
   * @apilevel internal
   */
