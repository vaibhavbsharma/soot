...
/**
 * @production InstanceOfExpr : {@link Expr} ::= <span class="component">{@link Expr}</span> <span
 *     class="component">TypeAccess:{@link Access}</span>;
 * @ast node
...
public class InstanceOfExpr extends Expr implements Cloneable {
   ...
   * @aspect PrettyPrint
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/PrettyPrint.jadd:421
   */
   ...
   * @aspect TypeCheck
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeCheck.jrag:235
   */
  public void typeCheck() {
    ...
    if (!relationalExpr.isUnknown()) {
      ...
      if (!relationalExpr.castingConversionTo(referenceType))
        error(
            "The type "
                + relationalExpr.typeName()
                + " of the relational expression "
                + getExpr()
                + " can not be cast into the type "
   ...
   * @aspect Expressions
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/JimpleBackend/Expressions.jrag:902
   */
  public soot.Value eval(Body b) {
    return b.newInstanceOfExpr(
        asImmediate(b, getExpr().eval(b)), getTypeAccess().type().getSootType(), this);
  }
  /** @ast method */
   ...
   * @aspect TypeAnalysis
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeAnalysis.jrag:361
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/SyntacticClassification.jrag:89
   * @apilevel internal
   */
