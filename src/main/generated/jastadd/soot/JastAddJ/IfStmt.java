...
/**
 * @production IfStmt : {@link Stmt} ::= <span class="component">Condition:{@link Expr}</span> <span
 *     class="component">Then:{@link Stmt}</span> <span class="component">[Else:{@link
 *     Stmt}]</span>;
 * @ast node
...
public class IfStmt extends Stmt implements Cloneable {
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/NodeConstructors.jrag:66
   */
   ...
   * @aspect NodeConstructors
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/NodeConstructors.jrag:70
   */
   ...
   * @aspect PrettyPrint
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/PrettyPrint.jadd:574
   */
   ...
   * @aspect TypeCheck
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeCheck.jrag:316
   */
   ...
   * @aspect Statements
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/JimpleBackend/Statements.jrag:115
   */
  public void jimplify2(Body b) {
    soot.jimple.Stmt endBranch = newLabel();
    if (getCondition().isConstant()) {
      if (getCondition().isTrue()) getThen().jimplify2(b);
      else if (getCondition().isFalse() && hasElse()) getElse().jimplify2(b);
    } else {
      ...
      if (hasElse()) getElse().jimplify2(b);
    }
    if (getThen().canCompleteNormally() && hasElse()) b.addLabel(endBranch);
  }
  /** @ast method */
  public IfStmt() {
    super();
  ...
  /**
   * Replaces the optional node for the Else child. This is the {@code Opt} node containing the
   * child Else, not the actual child!
   *
  ...
  /**
   * Retrieves the optional node for child Else. This is the {@code Opt} node containing the child
   * Else, not the actual child!
   *
   * <p><em>This method does not invoke AST transformations.</em>
   *
   ...
   * @aspect DA
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:525
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  private boolean isDAafter_compute(Variable v) {
    return hasElse()
        ? getThen().isDAafter(v) && getElse().isDAafter(v)
   ...
   * @aspect DU
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:994
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  private boolean isDUafter_compute(Variable v) {
    return hasElse()
        ? getThen().isDUafter(v) && getElse().isDUafter(v)
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/UnreachableStatements.jrag:141
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect Statements
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/JimpleBackend/Statements.jrag:113
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect Statements
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/JimpleBackend/Statements.jrag:114
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  public boolean modifiedInScope(Variable var) {
    ASTNode$State state = state();
    try {
      if (getThen().modifiedInScope(var)) return true;
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:528
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:997
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/UnreachableStatements.jrag:144
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/UnreachableStatements.jrag:150
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/JimpleBackend/BooleanExpressions.jrag:38
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/JimpleBackend/BooleanExpressions.jrag:39
   * @apilevel internal
   */
