 ...
 * simple name in the class and interface declarations of the compilation unit in which the
 * single-static import declaration appears.
 *
 * @production SingleStaticImportDecl : {@link StaticImportDecl} ::= <span
 *     class="component">&lt;ID:String&gt;</span>;
 * @ast node
 * @declaredat
 *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/StaticImports.ast:12
 */
public class SingleStaticImportDecl extends StaticImportDecl implements Cloneable {
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/StaticImports.jrag:61
   */
  public void typeCheck() {
    if (!getAccess().type().typeName().equals(typeName()) && !getAccess().type().isUnknown())
      error(
          "Single-type import "
              + typeName()
              + " is not the canonical name of type "
   ...
   * @aspect StaticImports
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/StaticImports.jrag:93
   */
  public void nameCheck() {
    if (importedFields(name()).isEmpty()
      ...
      error(
          "Semantic Error: At least one static member named "
              + name()
              + " must be available in static imported type "
              + type().fullName());
    }
  }
  /**
   ...
   * @aspect StaticImports
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/StaticImports.jrag:207
   */
   ...
   * @aspect StaticImports
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/StaticImports.jrag:53
   */
   ...
   * @aspect StaticImports
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/StaticImports.jrag:99
   */
  public String name() {
    ASTNode$State state = state();
    try {
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/StaticImports.jrag:203
   * @apilevel internal
   */
