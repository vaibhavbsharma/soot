...
public class OrBitwiseExpr extends BitwiseExpr implements Cloneable {
   ...
   * @aspect Expressions
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/JimpleBackend/Expressions.jrag:829
   */
  ...
  public Constant constant() {
    ...
    try {
      return type().orBitwise(getLeftOperand().constant(), getRightOperand().constant());
    } finally {
    }
  }
  /**
