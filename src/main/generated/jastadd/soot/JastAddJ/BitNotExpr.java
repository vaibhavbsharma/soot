...
public class BitNotExpr extends Unary implements Cloneable {
   ...
   * @aspect TypeCheck
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeCheck.jrag:281
   */
  public void typeCheck() {
    if (!getOperand().type().isIntegralType()) error("unary ~ only operates on integral types");
  }
  /**
   * @ast method
   * @aspect Expressions
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/JimpleBackend/Expressions.jrag:696
   */
   ...
   * @aspect TypeAnalysis
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeAnalysis.jrag:317
   */
  @SuppressWarnings({"unchecked", "cast"})
