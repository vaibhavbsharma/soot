...
public abstract class NumericType extends PrimitiveType implements Cloneable {
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/Jimple1.5Backend/AutoBoxingCodegen.jrag:20
   */
  public soot.Value emitCastTo(Body b, soot.Value v, TypeDecl type, ASTNode location) {
    ...
    } else if (!type.isNumericType()) return emitCastTo(b, v, boxed(), location);
    else
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeAnalysis.jrag:155
   */
  private TypeDecl refined_NumericPromotion_NumericType_binaryNumericPromotion_TypeDecl(
      TypeDecl type) {
    if (!type.isNumericType()) return unknownType();
   ...
   * @aspect NumericPromotion
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeAnalysis.jrag:148
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect AutoBoxing
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/AutoBoxing.jrag:175
   */
  @SuppressWarnings({"unchecked", "cast"})
  public TypeDecl binaryNumericPromotion(TypeDecl type) {
    Object _parameters = type;
    if (binaryNumericPromotion_TypeDecl_values == null)
      binaryNumericPromotion_TypeDecl_values = new java.util.HashMap(4);
    ...
    if (isFinal && num == state().boundariesCrossed)
      binaryNumericPromotion_TypeDecl_values.put(
          _parameters, binaryNumericPromotion_TypeDecl_value);
    return binaryNumericPromotion_TypeDecl_value;
  }
  /** @apilevel internal */
  private TypeDecl binaryNumericPromotion_compute(TypeDecl type) {
    if (type.isReferenceType()) type = type.unboxed();
