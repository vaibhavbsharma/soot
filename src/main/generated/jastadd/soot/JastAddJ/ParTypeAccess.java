...
/**
 * @production ParTypeAccess : {@link Access} ::= <span class="component">TypeAccess:{@link
 *     Access}</span> <span class="component">TypeArgument:{@link Access}*</span>;
 * @ast node
...
public class ParTypeAccess extends Access implements Cloneable {
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:336
   */
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:444
   */
            ...
            if (!getTypeArgument(i).type().instanceOf(original.getTypeParameter(i))) {
              error(
                  "type argument "
                      + i
                      + " is of type "
                      + getTypeArgument(i).type().typeName()
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericsPrettyPrint.jrag:23
   */
  ...
  public Expr unqualifiedScope() {
    ...
    try {
      return getParent() instanceof Access
   ...
   * @aspect GenericsTypeAnalysis
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:273
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  private TypeDecl type_compute() {
    ...
    if (typeDecl instanceof GenericTypeDecl) {
      ...
      for (int i = 0; i < getNumTypeArgument(); i++) args.add(getTypeArgument(i).type());
   ...
   * @aspect GenericsTypeAnalysis
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:287
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:265
   * @apilevel internal
   */
