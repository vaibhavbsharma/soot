 ...
 *     Modifiers}</span> <span class="component">&lt;ID:String&gt;</span> <span
 *     class="component">[SuperClassAccess:{@link Access}]</span> <span
 *     class="component">Implements:{@link Access}*</span> <span class="component">{@link
 *     BodyDecl}*</span>;
 * @ast node
...
public class ClassDecl extends ReferenceType implements Cloneable {
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/AccessControl.jrag:147
   */
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/ExceptionHandling.jrag:106
   */
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/LookupMethod.jrag:265
   */
   ...
   * @aspect Modifiers
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/Modifiers.jrag:96
   */
   ...
   * @aspect PrettyPrint
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/PrettyPrint.jadd:70
   */
   ...
   * @aspect SuperClasses
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeAnalysis.jrag:596
   */
   ...
   * @aspect SuperClasses
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeAnalysis.jrag:600
   */
   ...
   * @aspect SuperClasses
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeAnalysis.jrag:615
   */
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeHierarchyCheck.jrag:239
   */
  public void nameCheck() {
    ...
    if (isObject() && hasSuperClassAccess()) error("class Object may not have superclass");
    if (isObject() && getNumImplements() != 0) error("class Object may not implement interfaces");
   ...
   * @aspect TypeHierarchyCheck
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeHierarchyCheck.jrag:286
   */
  private void interfaceMethodCompatibleWithInherited(MethodDecl m, MethodDecl n) {
    if (n.isStatic()) error("Xa static method may not hide an instance method");
    if (!n.isAbstract() && !n.isPublic())
      error(
          "Xoverriding access modifier error for "
              + m.signature()
              + " in "
              + m.hostType().typeName()
              + " and "
    ...
    if (!n.isAbstract()) {
      ...
      for (int i = 0; i < n.getNumException(); i++) {
        ...
        for (int j = 0; !found && j < m.getNumException(); j++) {
          if (e.type().instanceOf(m.getException(j).type())) found = true;
        }
   ...
   * @aspect Generics
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:187
   */
  public TypeDecl makeGeneric(Signatures.ClassSignature s) {
    if (s.hasFormalTypeParameters()) {
      ...
      if (s.hasSuperclassSignature()) setSuperClassAccessOpt(new Opt(s.superclassSignature()));
      if (s.hasSuperinterfaceSignature()) setImplementsList(s.superinterfaceSignature());
      return this;
    }
  }
  /**
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:1313
   */
  public ClassDecl substitutedClassDecl(Parameterization parTypeDecl) {
    ClassDecl c =
        new ClassDeclSubstituted(
   ...
   * @aspect EmitJimple
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/JimpleBackend/EmitJimple.jrag:163
   */
  public void jimplify1phase2() {
    ...
    if (isNestedType()) sc.setOuterClass(enclosingType().getSootClassDecl());
  ...
  /** @ast method */
  public ClassDecl(
      Modifiers p0, beaver.Symbol p1, Opt<Access> p2, List<Access> p3, List<BodyDecl> p4) {
    setChild(p0, 0);
    setID(p1);
    setChild(p2, 1);
    setChild(p3, 2);
  ...
  /**
   * Replaces the optional node for the SuperClassAccess child. This is the {@code Opt} node
   * containing the child SuperClassAccess, not the actual child!
   *
   ...
   *
   * @return {@code true} if the optional SuperClassAccess child exists, {@code false} if it does
   *     not.
   * @apilevel high-level
   * @ast method
   */
  ...
  /**
   * Retrieves the optional node for child SuperClassAccess. This is the {@code Opt} node containing
   * the child SuperClassAccess, not the actual child!
   *
   * <p><em>This method does not invoke AST transformations.</em>
   *
  ...
  /**
   * Retrieves the number of children in the Implements list. Calling this method will not trigger
   * rewrites..
   *
   * @return Number of children in the Implements list.
   * @apilevel low-level
  ...
  public void addImplements(Access node) {
    List<Access> list =
        (parent == null || state == null) ? getImplementsListNoTransform() : getImplementsList();
    list.addChild(node);
  }
  /**
   * @apilevel low-level
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeAnalysis.jrag:84
   */
   ...
   * @aspect Generics
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:57
   */
  private boolean refined_Generics_ClassDecl_castingConversionTo_TypeDecl(TypeDecl type) {
    ...
    if (T instanceof TypeVariable) {
      ...
      for (int i = 0; i < t.getNumTypeBound(); i++)
        if (castingConversionTo(t.getTypeBound(i).type())) return true;
      return false;
    }
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/SootJastAddJ/EmitJimpleRefinements.jrag:24
   */
  private SootClass refined_EmitJimpleRefinements_ClassDecl_sootClass() {
    ...
    if (Scene.v().containsClass(jvmName())) {
      ...
      // prefer that class over the Coffi class that may already have been loaded from
      // bytecode
      try {
    ...
    if (needAddclass) {
      if (options().verbose()) System.out.println("Creating from source " + jvmName());
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/LookupConstructor.jrag:207
   */
  public boolean noConstructor() {
    ASTNode$State state = state();
    try {
      if (!compilationUnit().fromSource()) return false;
      for (int i = 0; i < getNumBodyDecl(); i++)
        if (getBodyDecl(i) instanceof ConstructorDecl) return false;
      return true;
    } finally {
    }
  }
   ...
   * @aspect MemberMethods
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/LookupMethod.jrag:280
   */
   ...
   * @aspect MemberMethods
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/LookupMethod.jrag:286
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/MethodSignature.jrag:359
   */
  @SuppressWarnings({"unchecked", "cast"})
      ...
      for (Iterator iter = superclass().methodsIterator(); iter.hasNext(); ) {
        ...
        if (!m.isPrivate()
          ...
          if (!(m instanceof MethodDeclSubstituted)
              || !localMethodsSignatureMap().containsKey(m.sourceMethodDecl().signature()))
            putSimpleSetElement(map, m.signature(), m);
        }
      }
    }
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/LookupMethod.jrag:380
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  private SimpleSet ancestorMethods_compute(String signature) {
    ...
    if (hasSuperclass()) {
      for (Iterator iter = superclass().localMethodsSignature(signature).iterator();
          iter.hasNext(); ) {
        MethodDecl m = (MethodDecl) iter.next();
        if (!m.isPrivate()) set = set.add(m);
      }
    }
    ...
    if (set.size() == 1) {
      ...
      if (!m.isAbstract()) {
        ...
        for (Iterator iter = superclass().ancestorMethods(signature).iterator(); iter.hasNext(); ) {
          ...
          if (n.isPrivate() || !n.accessibleFrom(m.hostType())) done = false;
        }
        if (done) return set;
      }
    }
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/LookupType.jrag:498
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  private SimpleSet memberTypes_compute(String name) {
    ...
    for (Iterator outerIter = interfacesIterator(); outerIter.hasNext(); ) {
      ...
      for (Iterator iter = type.memberTypes(name).iterator(); iter.hasNext(); ) {
        ...
        if (!decl.isPrivate() && decl.accessibleFrom(this)) set = set.add(decl);
      }
    }
    if (hasSuperclass()) {
   ...
   * @aspect Fields
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/LookupVariable.jrag:283
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect Fields
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/LookupVariable.jrag:334
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  private SimpleSet memberFields_compute(String name) {
    ...
    if (hasSuperclass()) {
      for (Iterator iter = superclass().memberFields(name).iterator(); iter.hasNext(); ) {
        FieldDeclaration decl = (FieldDeclaration) iter.next();
        if (!decl.isPrivate() && decl.accessibleFrom(this)) fields = fields.add(decl);
      }
    }
    for (Iterator outerIter = interfacesIterator(); outerIter.hasNext(); ) {
      TypeDecl type = (TypeDecl) outerIter.next();
   ...
   * @aspect Modifiers
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/Modifiers.jrag:17
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  private Collection unimplementedMethods_compute() {
    ...
    for (Iterator iter = interfacesMethodsIterator(); iter.hasNext(); ) {
      ...
      if (set.size() == 1) {
        ...
        if (!n.isAbstract()) implemented = true;
      }
      if (!implemented) {
    ...
    if (hasSuperclass()) {
      for (Iterator iter = superclass().unimplementedMethods().iterator(); iter.hasNext(); ) {
        ...
        if (set.size() == 1) {
          MethodDecl n = (MethodDecl) set.iterator().next();
          if (n.isAbstract() || !n.overrides(m)) c.add(m);
        } else c.add(m);
      }
    }
   ...
   * @aspect Modifiers
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/Modifiers.jrag:66
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect AutoBoxing
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/AutoBoxing.jrag:134
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  private boolean castingConversionTo_compute(TypeDecl type) {
    if (refined_Generics_ClassDecl_castingConversionTo_TypeDecl(type)) return true;
    boolean canUnboxThis = !unboxed().isUnknown();
    boolean canUnboxType = !type.unboxed().isUnknown();
    if (canUnboxThis && !canUnboxType) return unboxed().wideningConversionTo(type);
    return false;
    /*
   ...
   * @aspect TypeAnalysis
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeAnalysis.jrag:225
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect TypeAnalysis
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeAnalysis.jrag:228
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericsSubtype.jrag:387
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect Circularity
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeAnalysis.jrag:677
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:400
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect GenericsSubtype
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericsSubtype.jrag:407
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  public boolean supertypeArrayDecl(ArrayDecl type) {
    ASTNode$State state = state();
    try {
      if (super.supertypeArrayDecl(type)) return true;
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/SootJastAddJ/IncrementalJimple.jrag:35
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/Modifiers.jrag:259
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/SyntacticClassification.jrag:74
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeAnalysis.jrag:579
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Annotations.jrag:276
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Annotations.jrag:377
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:269
   * @apilevel internal
   */
