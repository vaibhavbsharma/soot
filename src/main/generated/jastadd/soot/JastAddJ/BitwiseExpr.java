...
public abstract class BitwiseExpr extends Binary implements Cloneable {
   ...
   * @aspect TypeCheck
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeCheck.jrag:192
   */
  public void typeCheck() {
    TypeDecl left = getLeftOperand().type();
    TypeDecl right = getRightOperand().type();
    if (left.isIntegralType() && right.isIntegralType()) return;
    else if (left.isBoolean() && right.isBoolean()) return;
    else error(left.typeName() + " is not compatible with " + right.typeName());
  }
  /** @ast method */
  public BitwiseExpr() {
    super();
   ...
   * @aspect TypeAnalysis
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeAnalysis.jrag:350
   */
  @SuppressWarnings({"unchecked", "cast"})
