...
/**
 * @production AssertStmt : {@link Stmt} ::= <span class="component">first:{@link Expr}</span> <span
 *     class="component">[{@link Expr}]</span>;
 * @ast node
...
public class AssertStmt extends Stmt implements Cloneable {
   ...
   * @aspect PrettyPrint
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/PrettyPrint.jadd:729
   */
   ...
   * @aspect TypeCheck
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeCheck.jrag:378
   */
  public void typeCheck() {
    // 14.10
    if (!getfirst().type().isBoolean()) error("Assert requires boolean condition");
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Backend/Transformations.jrag:170
   */
  public void transformation() {
    ...
    FieldDeclaration f =
        hostType()
            .topLevelType()
            .createStaticClassField(hostType().topLevelType().referenceClassFieldName());
    ...
    if (hasExpr())
      ...
      else args.add(getExpr().fullCopy());
    Stmt stmt =
        new IfStmt(
            new LogNotExpr(
                new ParExpr(
                    new OrLogicalExpr(new BoundFieldAccess(assertionsDisabled), condition))),
            new ThrowStmt(
  ...
  /**
   * Replaces the optional node for the Expr child. This is the {@code Opt} node containing the
   * child Expr, not the actual child!
   *
  ...
  /**
   * Retrieves the optional node for child Expr. This is the {@code Opt} node containing the child
   * Expr, not the actual child!
   *
   * <p><em>This method does not invoke AST transformations.</em>
   *
   ...
   * @aspect DA
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:418
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect DU
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:866
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:419
   * @apilevel internal
   */
