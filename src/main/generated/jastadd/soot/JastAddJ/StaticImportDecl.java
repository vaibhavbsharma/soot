 ...
 * @ast node
 * @declaredat
 *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/StaticImports.ast:4
 */
public abstract class StaticImportDecl extends ImportDecl implements Cloneable {
  ...
  private SimpleSet importedTypes_compute(String name) {
    ...
    for (Iterator iter = type().memberTypes(name).iterator(); iter.hasNext(); ) {
      ...
      if (decl.isStatic() && decl.accessibleFromPackage(packageName())) set = set.add(decl);
    }
    return set;
  }
   ...
   * @aspect StaticImports
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/StaticImports.jrag:31
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect StaticImports
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/StaticImports.jrag:42
   */
  @SuppressWarnings({"unchecked", "cast"})
