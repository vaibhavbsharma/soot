...
/**
 * @production EnhancedForStmt : {@link BranchTargetStmt} ::= <span class="component">{@link
 *     VariableDeclaration}</span> <span class="component">{@link Expr}</span> <span
 *     class="component">{@link Stmt}</span>;
 * @ast node
 * @declaredat
 *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/EnhancedFor.ast:1
 */
public class EnhancedForStmt extends BranchTargetStmt implements Cloneable, VariableScope {
   ...
   * @aspect EnhancedFor
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/EnhancedFor.jrag:15
   */
    ...
    if (!getExpr().type().isArrayDecl() && !getExpr().type().isIterable()) {
      error(
        ...
        && !getExpr()
            .type()
            .componentType()
            .assignConversionTo(getVariableDeclaration().type(), null))
      error(
          "parameter of type "
              + getVariableDeclaration().type().typeName()
              + " can not be assigned an element of type "
              + getExpr().type().componentType().typeName());
    else if (getExpr().type().isIterable() && !getExpr().type().isUnknown()) {
      MethodDecl iterator =
          (MethodDecl) getExpr().type().memberMethods("iterator").iterator().next();
   ...
   * @aspect EnhancedFor
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/EnhancedFor.jrag:58
   */
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/Jimple1.5Backend/EnhancedForCodegen.jrag:24
   */
  public void jimplify2(Body b) {
    if (getExpr().type().isArrayDecl()) {
      ...
      soot.Local parameter =
          b.newLocal(
              getVariableDeclaration().name(), getVariableDeclaration().type().getSootType());
          ...
          b.newAssignStmt(
              ...
              asRValue(
                  ...
                  getExpr()
                      ...
                      .emitCastTo(
                          b,
                          asLocal(b, b.newArrayRef(array, index, this)),
          ...
          b.newIfStmt(
              b.newEqExpr(
                  asImmediate(
                      b,
                      b.newInterfaceInvokeExpr(
                          iterator, hasNextMethod().sootRef(), new ArrayList(), this)),
          ...
          b.newAssignStmt(
              ...
              nextMethod()
                  ...
                  .emitCastTo(
                      b,
                      b.newInterfaceInvokeExpr(
                          iterator, nextMethod().sootRef(), new ArrayList(), this),
                      getVariableDeclaration().type(),
                      this),
              this));
      getStmt().jimplify2(b);
   ...
   * @aspect EnhancedForToBytecode
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/Jimple1.5Backend/EnhancedForCodegen.jrag:151
   */
   ...
   * @aspect EnhancedForToBytecode
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/Jimple1.5Backend/EnhancedForCodegen.jrag:161
   */
   ...
   * @aspect EnhancedForToBytecode
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/Jimple1.5Backend/EnhancedForCodegen.jrag:171
   */
   ...
   * @aspect EnhancedFor
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/EnhancedFor.jrag:50
   */
   ...
   * @aspect EnhancedFor
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/EnhancedFor.jrag:75
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect EnhancedFor
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/EnhancedFor.jrag:76
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect EnhancedFor
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/EnhancedFor.jrag:79
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect EnhancedFor
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/EnhancedFor.jrag:83
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  private boolean isDAafter_compute(Variable v) {
    if (!getExpr().isDAafter(v)) return false;
    /*
   ...
   * @aspect EnhancedFor
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/EnhancedFor.jrag:99
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  private boolean isDUafter_compute(Variable v) {
    if (!getExpr().isDUafter(v)) return false;
    for (Iterator iter = targetBreaks().iterator(); iter.hasNext(); ) {
      BreakStmt stmt = (BreakStmt) iter.next();
   ...
   * @aspect EnhancedForToBytecode
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/Jimple1.5Backend/EnhancedForCodegen.jrag:12
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect EnhancedForToBytecode
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/Jimple1.5Backend/EnhancedForCodegen.jrag:13
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect EnhancedForToBytecode
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/Jimple1.5Backend/EnhancedForCodegen.jrag:14
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect EnhancedForToBytecode
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/Jimple1.5Backend/EnhancedForCodegen.jrag:16
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect EnhancedFor
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/EnhancedFor.jrag:38
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/EnhancedFor.jrag:41
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/EnhancedFor.jrag:43
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/EnhancedFor.jrag:48
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/EnhancedFor.jrag:71
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/EnhancedFor.jrag:72
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/EnhancedFor.jrag:73
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/EnhancedFor.jrag:80
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/EnhancedFor.jrag:97
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/EnhancedFor.jrag:111
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/EnhancedFor.jrag:113
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/Jimple1.5Backend/EnhancedForCodegen.jrag:18
   * @apilevel internal
   */
