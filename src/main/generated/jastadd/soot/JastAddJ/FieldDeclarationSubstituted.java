...
/**
 * @production FieldDeclarationSubstituted : {@link FieldDeclaration} ::= <span
 *     class="component">&lt;Original:FieldDeclaration&gt;</span>;
 * @ast node
...
public class FieldDeclarationSubstituted extends FieldDeclaration implements Cloneable {
  ...
  /** @ast method */
  public FieldDeclarationSubstituted(
      Modifiers p0, Access p1, String p2, Opt<Expr> p3, FieldDeclaration p4) {
    setChild(p0, 0);
    setChild(p1, 1);
    setID(p2);
    setChild(p3, 2);
  ...
  /** @ast method */
  public FieldDeclarationSubstituted(
      Modifiers p0, Access p1, beaver.Symbol p2, Opt<Expr> p3, FieldDeclaration p4) {
    setChild(p0, 0);
    setChild(p1, 1);
    setID(p2);
    setChild(p3, 2);
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:1522
   */
  @SuppressWarnings({"unchecked", "cast"})
