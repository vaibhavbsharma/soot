...
/**
 * @production ElementValuePair : {@link ASTNode} ::= <span
 *     class="component">&lt;Name:String&gt;</span> <span class="component">{@link
 *     ElementValue}</span>;
 * @ast node
 * @declaredat
 *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Annotations.ast:8
 */
public class ElementValuePair extends ASTNode<ASTNode> implements Cloneable {
   ...
   * @aspect Annotations
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Annotations.jrag:504
   */
  public void typeCheck() {
    if (!type().commensurateWith(getElementValue()))
      error(
          "can not construct annotation with "
              + getName()
              + " = "
              ...
              + getElementValue().type().typeName());
  }
  /**
   * @ast method
   * @aspect Annotations
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Annotations.jrag:593
   */
   ...
   * @aspect Annotations
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Annotations.jrag:458
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect Annotations
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Annotations.jrag:460
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  public ASTNode rewriteTo() {
    // Declared in
    // /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Annotations.jrag at
    // line 527
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Annotations.jrag:527
   * @apilevel internal
   */
