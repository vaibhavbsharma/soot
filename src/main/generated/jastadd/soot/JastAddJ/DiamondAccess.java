 ...
 *
 * @production DiamondAccess : {@link Access} ::= <span class="component">TypeAccess:{@link
 *     Access}</span>;
 * @ast node
 * @declaredat
 *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TypeInference.ast:4
 */
public class DiamondAccess extends Access implements Cloneable {
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TypeInference.jrag:72
   */
   ...
   * @aspect TypeInference
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TypeInference.jrag:91
   */
  ...
  /**
   * Select potentially applicable method declarations from a set of candidates. Type inference is
   * applied to the (potentially) applicable candidates.
   *
   * @ast method
   * @aspect TypeInference
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TypeInference.jrag:224
   */
   ...
   * @aspect TypeInference
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TypeInference.jrag:241
   */
  protected boolean potentiallyApplicable(GenericMethodDecl candidate) {
    ...
    if (typeArgs.size() != 0) {
      if (candidate.getNumTypeParameter() != typeArgs.size()) return false;
      for (int i = 0; i < candidate.getNumTypeParameter(); i++)
        if (!typeArgs.get(i).subtype(candidate.original().getTypeParameter(i))) return false;
    }
    return true;
  }
  /**
   ...
   * @aspect TypeInference
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TypeInference.jrag:297
   */
  public Collection<TypeDecl> computeConstraints(GenericMethodDecl decl) {
    ...
    for (int i = 0; i < instanceExpr.getNumArg(); i++) {
      ...
      if (decl.getParameter(index) instanceof VariableArityParameterDeclaration
          && (instanceExpr.getNumArg() != decl.getNumParameter() || !A.isArrayDecl())) {
        F = F.componentType();
      }
      c.convertibleTo(A, F);
    }
   ...
   * @aspect TypeInference
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TypeInference.jrag:344
   */
  protected boolean applicableBySubtyping(ClassInstanceExpr expr, MethodDecl method) {
    if (method.getNumParameter() != expr.getNumArg()) return false;
    for (int i = 0; i < method.getNumParameter(); i++)
      if (!expr.getArg(i).type().instanceOf(method.getParameter(i).type())) return false;
    return true;
  }
  /**
   ...
   * @aspect TypeInference
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TypeInference.jrag:357
   */
   ...
   * @aspect TypeInference
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TypeInference.jrag:371
   */
  protected boolean applicableByVariableArity(ClassInstanceExpr expr, MethodDecl method) {
    ...
    for (int i = method.getNumParameter() - 1; i < expr.getNumArg(); i++)
      if (!expr.getArg(i)
          .type()
          .methodInvocationConversionTo(method.lastParameter().type().componentType()))
        return false;
    return true;
  }
  /**
   * Checks if this diamond access is legal. The diamond access is not legal if it either is part of
   * an inner class declaration, if it is used to access a non-generic type, or if it is part of a
   * call to a generic constructor with explicit type arguments.
   *
   * @ast method
   * @aspect TypeInference
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TypeInference.jrag:487
   */
  public void typeCheck() {
    ...
    if (isExplicitGenericConstructorAccess())
      error(
          "the diamond operator may not be used with generic "
   ...
   * @aspect TypeInference
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TypeInference.jrag:505
   */
  ...
  /**
   * If this DiamondAccess node constitutes a legal use of the diamond operator, the inferred
   * generic type for the enclosing class instance expression is returned.
   *
   * @attribute syn
   * @aspect TypeInference
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TypeInference.jrag:39
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  private TypeDecl type_compute() {
    ...
    if (isAnonymousDecl()) return accessType;
    ...
    if (maxSpecific.isEmpty()) return getTypeAccess().type();
   ...
   * @aspect TypeInference
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TypeInference.jrag:65
   */
   ...
   * @aspect TypeInference
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TypeInference.jrag:267
   */
  @SuppressWarnings({"unchecked", "cast"})
    ...
    if (decl instanceof GenericMethodDecl) {
      ...
      for (TypeDecl argument : arguments) {
        if (argument == null) {
          ...
          if (v.getNumTypeBound() == 0) argument = typeObject();
          else if (v.getNumTypeBound() == 1) argument = v.getTypeBound(0).type();
          else argument = v.lubType();
        }
   ...
   * @aspect TypeInference
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TypeInference.jrag:68
   */
  @SuppressWarnings({"unchecked", "cast"})
  public ClassInstanceExpr getClassInstanceExpr() {
    ASTNode$State state = state();
    ClassInstanceExpr getClassInstanceExpr_value =
        getParent().Define_ClassInstanceExpr_getClassInstanceExpr(this, null);
   ...
   * @aspect TypeInference
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TypeInference.jrag:262
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect TypeInference
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TypeInference.jrag:452
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  /**
   * @return true if the Access is part of a generic constructor invocation with explicit type
   *     arguments
   * @attribute inh
   * @aspect TypeInference
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TypeInference.jrag:468
   */
  @SuppressWarnings({"unchecked", "cast"})
  public boolean isExplicitGenericConstructorAccess() {
    ASTNode$State state = state();
    boolean isExplicitGenericConstructorAccess_value =
        getParent().Define_boolean_isExplicitGenericConstructorAccess(this, null);
