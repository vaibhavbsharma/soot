...
/**
 * @production AnnotationMethodDecl : {@link MethodDecl} ::= <span
 *     class="component">[DefaultValue:{@link ElementValue}]</span>;
 * @ast node
 * @declaredat
 *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Annotations.ast:3
 */
public class AnnotationMethodDecl extends MethodDecl implements Cloneable {
   ...
   * @aspect Annotations
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Annotations.jrag:160
   */
   ...
   * @aspect Annotations
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Annotations.jrag:571
   */
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/Jimple1.5Backend/AnnotationsCodegen.jrag:293
   */
  public void addAttributes() {
    ...
    if (hasDefaultValue()) {
      ...
      soot.tagkit.AnnotationDefaultTag tag =
          new soot.tagkit.AnnotationDefaultTag((soot.tagkit.AnnotationElem) elements.get(0));
  ...
  /**
   * Replaces the optional node for the DefaultValue child. This is the {@code Opt} node containing
   * the child DefaultValue, not the actual child!
   *
  ...
  /**
   * Retrieves the optional node for child DefaultValue. This is the {@code Opt} node containing the
   * child DefaultValue, not the actual child!
   *
   * <p><em>This method does not invoke AST transformations.</em>
   *
