...
/**
 * @production PrimitiveType : {@link TypeDecl} ::= <span class="component">{@link Modifiers}</span>
 *     <span class="component">&lt;ID:String&gt;</span> <span
 *     class="component">[SuperClassAccess:{@link Access}]</span> <span class="component">{@link
 *     BodyDecl}*</span>;
 * @ast node
...
public class PrimitiveType extends TypeDecl implements Cloneable {
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/QualifiedNames.jrag:108
   */
   ...
   * @aspect SuperClasses
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeAnalysis.jrag:608
   */
   ...
   * @aspect TypeConversion
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeAnalysis.jrag:27
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericsSubtype.jrag:390
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  public boolean isSupertypeOfPrimitiveType(PrimitiveType type) {
    ASTNode$State state = state();
    try {
      if (super.isSupertypeOfPrimitiveType(type)) return true;
      return type.hasSuperclass()
          && type.superclass().isPrimitive()
   ...
   * @aspect SuperClasses
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeAnalysis.jrag:612
   */
  ...
  * @attribute syn
   ...
   * @aspect GenericsSubtype
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericsSubtype.jrag:410
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  public boolean supertypePrimitiveType(PrimitiveType type) {
    ASTNode$State state = state();
    try {
      if (super.supertypePrimitiveType(type)) return true;
      return type.hasSuperclass()
          && type.superclass().isPrimitive()
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeAnalysis.jrag:577
   * @apilevel internal
   */
