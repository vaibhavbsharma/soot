...
public class RShiftExpr extends ShiftExpr implements Cloneable {
   ...
   * @aspect Expressions
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/JimpleBackend/Expressions.jrag:799
   */
   ...
   * @aspect Expressions
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/JimpleBackend/Expressions.jrag:823
   */
  ...
  public Constant constant() {
    ...
    try {
      return type().rshift(getLeftOperand().constant(), getRightOperand().constant());
    } finally {
    }
  }
  /**
