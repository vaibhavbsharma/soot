...
/**
 * @production ElementArrayValue : {@link ElementValue} ::= <span class="component">{@link
 *     ElementValue}*</span>;
 * @ast node
 * @declaredat
 *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Annotations.ast:13
 */
public class ElementArrayValue extends ElementValue implements Cloneable {
   ...
   * @aspect Annotations
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Annotations.jrag:603
   */
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/Jimple1.5Backend/AnnotationsCodegen.jrag:359
   */
  ...
  /**
   * Retrieves the number of children in the ElementValue list. Calling this method will not trigger
   * rewrites..
   *
   * @return Number of children in the ElementValue list.
   * @apilevel low-level
  ...
  public boolean validTarget(Annotation a) {
    ...
    try {
      for (int i = 0; i < getNumElementValue(); i++)
        if (getElementValue(i).validTarget(a)) return true;
      return false;
    } finally {
    }
  }
  ...
  public boolean hasValue(String s) {
    ...
    try {
      for (int i = 0; i < getNumElementValue(); i++)
        if (getElementValue(i).hasValue(s)) return true;
      return false;
    } finally {
    }
  }
   ...
   * @aspect Annotations
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Annotations.jrag:495
   */
  public boolean commensurateWithArrayDecl(ArrayDecl type) {
    ASTNode$State state = state();
    try {
      for (int i = 0; i < getNumElementValue(); i++)
        if (!type.componentType().commensurateWith(getElementValue(i))) return false;
      return true;
    } finally {
    }
  }
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Annotations.jrag:178
   * @apilevel internal
   */
