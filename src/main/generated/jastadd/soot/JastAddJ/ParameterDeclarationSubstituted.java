...
/**
 * @production ParameterDeclarationSubstituted : {@link ParameterDeclaration} ::= <span
 *     class="component">&lt;Original:ParameterDeclaration&gt;</span>;
 * @ast node
...
public class ParameterDeclarationSubstituted extends ParameterDeclaration implements Cloneable {
  ...
  public ParameterDeclarationSubstituted fullCopy() {
    ParameterDeclarationSubstituted tree = copy();
    if (children != null) {
  ...
  /** @ast method */
  public ParameterDeclarationSubstituted(
      Modifiers p0, Access p1, String p2, ParameterDeclaration p3) {
    setChild(p0, 0);
    setChild(p1, 1);
    setID(p2);
    setOriginal(p3);
  ...
  /** @ast method */
  public ParameterDeclarationSubstituted(
      Modifiers p0, Access p1, beaver.Symbol p2, ParameterDeclaration p3) {
    setChild(p0, 0);
    setChild(p1, 1);
    setID(p2);
    setOriginal(p3);
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:1524
   */
  @SuppressWarnings({"unchecked", "cast"})
