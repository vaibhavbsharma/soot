...
/**
 * @production ElementAnnotationValue : {@link ElementValue} ::= <span class="component">{@link
 *     Annotation}</span>;
 * @ast node
 * @declaredat
 *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Annotations.ast:12
 */
public class ElementAnnotationValue extends ElementValue implements Cloneable {
   ...
   * @aspect Annotations
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Annotations.jrag:600
   */
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/Jimple1.5Backend/AnnotationsCodegen.jrag:354
   */
  public void appendAsAttributeTo(Collection list, String name) {
    ...
    list.add(
        new soot.tagkit.AnnotationAnnotationElem(
            (soot.tagkit.AnnotationTag) elemVals.get(0), '@', name));
  }
  /** @ast method */
   ...
   * @aspect Annotations
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Annotations.jrag:423
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Annotations.jrag:95
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Annotations.jrag:427
   * @apilevel internal
   */
