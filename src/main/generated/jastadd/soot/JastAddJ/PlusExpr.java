...
public class PlusExpr extends Unary implements Cloneable {
   ...
   * @aspect TypeCheck
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeCheck.jrag:269
   */
  public void typeCheck() {
    if (!getOperand().type().isNumericType()) error("unary plus only operates on numeric types");
  }
  /**
   * @ast method
   * @aspect Expressions
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/JimpleBackend/Expressions.jrag:695
   */
  public soot.Value eval(Body b) {
    return getOperand().eval(b);
  }
  /** @ast method */
  public PlusExpr() {
    super();
  ...
  public Constant constant() {
    ...
    try {
      return type().plus(getOperand().constant());
    } finally {
    }
  }
  /**
   ...
   * @aspect TypeAnalysis
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeAnalysis.jrag:315
   */
  @SuppressWarnings({"unchecked", "cast"})
