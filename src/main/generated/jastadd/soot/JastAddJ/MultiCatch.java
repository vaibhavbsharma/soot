 ...
 *
 * @production MultiCatch : {@link CatchClause} ::= <span class="component">Parameter:{@link
 *     CatchParameterDeclaration}</span> <span class="component">{@link Block}</span>;
 * @ast node
...
public class MultiCatch extends CatchClause implements Cloneable {
   ...
   * @aspect MultiCatch
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/MultiCatch.jrag:146
   */
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/PreciseRethrow.jrag:204
   */
   ...
   * @aspect MultiCatch
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/MultiCatch.jrag:86
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  public boolean handles(TypeDecl exceptionType) {
    ...
    try {
      ...
      for (int i = 0; i < param.getNumTypeAccess(); ++i) {
        ...
        if (!type.isUnknown() && exceptionType.instanceOf(type)) return true;
      }
      return false;
    } finally {
    }
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/MultiCatch.jrag:27
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/MultiCatch.jrag:28
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/MultiCatch.jrag:29
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/MultiCatch.jrag:80
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/MultiCatch.jrag:128
   * @apilevel internal
   */
