...
public class TypeImportOnDemandDecl extends ImportDecl implements Cloneable {
   ...
   * @aspect NameCheck
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/NameCheck.jrag:30
   */
   ...
   * @aspect PrettyPrint
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/PrettyPrint.jadd:56
   */
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/LookupType.jrag:329
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  private SimpleSet importedTypes_compute(String name) {
    ...
    if (getAccess() instanceof PackageAccess) {
      ...
      if (typeDecl != null
          && typeDecl.accessibleFromPackage(packageName())
   ...
   * @aspect TypeScopePropagation
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/LookupType.jrag:348
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/SyntacticClassification.jrag:107
   * @apilevel internal
   */
