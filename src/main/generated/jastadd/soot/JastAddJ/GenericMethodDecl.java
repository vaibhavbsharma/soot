...
/**
 * @production GenericMethodDecl : {@link MethodDecl} ::= <span
 *     class="component">TypeParameter:{@link TypeVariable}*</span>;
 * @ast node
 * @declaredat
 *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericMethods.ast:2
 */
public class GenericMethodDecl extends MethodDecl implements Cloneable {
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericMethods.jrag:103
   */
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericMethods.jrag:216
   */
   ...
   * @aspect GenericMethodsPrettyPrint
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericMethods.jrag:225
   */
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:1261
   */
  public BodyDecl substitutedBodyDecl(Parameterization parTypeDecl) {
    // System.out.println("Begin substituting generic " + signature() + " in " +
    // hostType().typeName() + " with " + parTypeDecl.typeSignature());
    GenericMethodDecl m =
        new GenericMethodDecl(
   ...
   * @aspect LookupParTypeDecl
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:1277
   */
   ...
   * @aspect GenericMethods
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericMethods.jrag:34
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  * @attribute syn
  ...
  public MethodDecl lookupParMethodDecl(java.util.List typeArguments) {
    ...
    if (lookupParMethodDecl_java_util_List_values == null)
      lookupParMethodDecl_java_util_List_values = new java.util.HashMap(4);
    ...
    int num = state.boundariesCrossed;
    boolean isFinal = this.is$Final();
    MethodDecl lookupParMethodDecl_java_util_List_value =
        lookupParMethodDecl_compute(typeArguments);
    ...
    if (true)
      lookupParMethodDecl_java_util_List_values.put(
          _parameters, lookupParMethodDecl_java_util_List_value);
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericMethods.jrag:147
   */
   ...
   * @aspect LookupParTypeDecl
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:1276
   */
  public GenericMethodDecl original() {
    ASTNode$State state = state();
    try {
   ...
   * @aspect GenericMethodsNameAnalysis
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericMethods.jrag:146
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericMethods.jrag:144
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericMethods.jrag:154
   * @apilevel internal
   */
