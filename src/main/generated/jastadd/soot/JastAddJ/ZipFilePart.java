...
public class ZipFilePart extends PathPart {
  ...
  public boolean selectCompilationUnit(String canonicalName) throws IOException {
    ...
    try {
      ...
      if (zipFile != null && !success) zipFile.close();
    }
    return success;
  }

  /**
   * Wrapper class for the input stream of a ZipFile entry. All methods are passed through to the
   * underlining ZipFile entry input stream. However, close has the additional functionality of
   * ensuring that the ZipFile is closed along with the input stream when close is called.
   */
