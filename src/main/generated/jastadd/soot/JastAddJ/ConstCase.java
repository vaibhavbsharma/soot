...
public class ConstCase extends Case implements Cloneable {
   ...
   * @aspect NameCheck
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/NameCheck.jrag:406
   */
   ...
   * @aspect PrettyPrint
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/PrettyPrint.jadd:562
   */
   ...
   * @aspect EnumsCodegen
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/Jimple1.5Backend/EnumsCodegen.jrag:32
   */
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/StringsInSwitch.jrag:68
   */
  public void typeCheck() {
    ...
    if (!type.assignConversionTo(switchType, getValue()))
      error(
          "Case label has incompatible type "
              + switchType.name()
              + ", expected type compatible with "
              + type.name());
    if (!getValue().isConstant() && !getValue().type().isUnknown() && !isEnumConstant)
   ...
   * @aspect NameCheck
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/NameCheck.jrag:432
   */
  private boolean refined_NameCheck_ConstCase_constValue_Case(Case c) {
    if (!(c instanceof ConstCase) || !getValue().isConstant()) return false;
    if (!getValue().type().assignableToInt()
        || !((ConstCase) c).getValue().type().assignableToInt()) return false;
  ...
  private boolean refined_Enums_ConstCase_constValue_Case(Case c) {
    ...
    } else return refined_NameCheck_ConstCase_constValue_Case(c);
  }
  /**
   * @attribute syn
   * @aspect NameCheck
  ...
  public boolean constValue(Case c) {
    ...
    try {
      if (isDefaultCase() || c.isDefaultCase()) return isDefaultCase() && c.isDefaultCase();
      ...
      if (myType.isString() || otherType.isString()) {
        if (!myType.isString() || !otherType.isString()) return false;
        if (!myValue.isConstant() || !otherValue.isConstant()) return false;
