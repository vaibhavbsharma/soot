...
public class SuperConstructorAccess extends ConstructorAccess implements Cloneable {
  ...
  public SuperConstructorAccess fullCopy() {
    SuperConstructorAccess tree = copy();
    if (children != null) {
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeHierarchyCheck.jrag:63
   */
  public void nameCheck() {
    ...
    TypeDecl c = hostType();
    TypeDecl s =
        c.isClassDecl() && ((ClassDecl) c).hasSuperclass()
    ...
    if (isQualified()) {
      if (!s.isInnerType() || s.inStaticContext())
        ...
        error(
            "The type of this primary expression, "
                + qualifier().type().typeName()
                + " is not enclosing the super type, "
                + s.typeName()
                + ", of "
                + c.typeName());
    }
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Backend/Transformations.jrag:149
   */
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/SootJastAddJ/EmitJimpleRefinements.jrag:239
   */
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/Jimple1.5Backend/GenericsCodegen.jrag:255
   */
    ...
    if (c.needsEnclosing()) {
      if (hasPrevExpr() && !prevExpr().isTypeAccess()) {
        ...
        if (hostType().needsSuperEnclosing()) {
          ...
          else list.add(asImmediate(b, b.newParameterRef(type, 0, this)));
        } else {
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/MethodSignature.jrag:77
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  private SimpleSet decls_compute() {
    Collection c =
        hasPrevExpr() && !prevExpr().isTypeAccess()
   ...
   * @aspect Names
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/QualifiedNames.jrag:20
   */
  public String name() {
    ASTNode$State state = state();
    try {
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/LookupConstructor.jrag:19
   */
  @SuppressWarnings({"unchecked", "cast"})
  public Collection lookupSuperConstructor() {
    ASTNode$State state = state();
    Collection lookupSuperConstructor_value =
        getParent().Define_Collection_lookupSuperConstructor(this, null);
   ...
   * @aspect TypeCheck
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeCheck.jrag:503
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/LookupType.jrag:89
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/LookupVariable.jrag:134
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/TypeHierarchyCheck.jrag:131
   * @apilevel internal
   */
