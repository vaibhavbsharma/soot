...
/**
 * @production GenericClassDecl : {@link ClassDecl} ::= <span class="component">{@link
 ...
 *     BodyDecl}*</span> <span class="component">TypeParameter:{@link TypeVariable}*</span>;
 * @ast node
...
public class GenericClassDecl extends ClassDecl implements Cloneable, GenericTypeDecl {
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:425
   */
  public void typeCheck() {
    ...
    if (instanceOf(typeThrowable()))
      error(
          " generic class "
              + typeName()
              + " may not directly or indirectly inherit java.lang.Throwable");
  }
  /**
   * @ast method
   * @aspect LookupParTypeDecl
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:1324
   */
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericsPrettyPrint.jrag:61
   */
   ...
   * @aspect GenericsPrettyPrint
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericsPrettyPrint.jrag:73
   */
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:489
   */
  public SimpleSet addTypeVariables(SimpleSet c, String name) {
    ...
    for (int i = 0; i < original.getNumTypeParameter(); i++) {
      ...
      if (p.name().equals(name)) c = c.add(p);
    }
    return c;
  }
  /**
   ...
   * @aspect LookupParTypeDecl
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:799
   */
  public List createArgumentList(ArrayList params) {
    ...
    if (params.isEmpty()) {
      ...
      // Concern: The previous version seem to add the erasure of the type variable for some
      // reason,
      // maybe this is how the raw type is represented (?), but this doesn't really comply
      // with the
  ...
  /**
   * Retrieves the number of children in the TypeParameter list. Calling this method will not
   * trigger rewrites..
   *
   * @return Number of children in the TypeParameter list.
   * @apilevel low-level
   ...
   * @aspect Generics
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:176
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect LookupParTypeDecl
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:715
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect LookupParTypeDecl
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:1077
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericsSubtype.jrag:13
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @aspect GenericsSubtype
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericsSubtype.jrag:394
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  /**
   * The placeholder method list for the constructors of this generic class.
   *
   * @return list of placeholder methods
   * @attribute syn
   * @aspect TypeInference
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java7Frontend/TypeInference.jrag:124
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  private List<PlaceholderMethodDecl> getPlaceholderMethodList_compute() {
    List<PlaceholderMethodDecl> placeholderMethods = new List<PlaceholderMethodDecl>();
    ...
    for (Iterator iter = typeParams.iterator(); iter.hasNext(); ++arg) {
      ...
      classTypeVars.add(
          new TypeVariable(new Modifiers(), substName, new List<BodyDecl>(), typeBounds));
    }
  ...
  public TypeDecl lookupParTypeDecl(ParTypeAccess p) {
    ...
    if (isFinal && num == state().boundariesCrossed)
      lookupParTypeDecl_ParTypeAccess_values.put(
          _parameters, lookupParTypeDecl_ParTypeAccess_value);
  ...
  private TypeDecl lookupParTypeDecl_compute(ParTypeAccess p) {
    ...
    for (int i = 0; i < p.getNumTypeArgument(); i++) typeArguments.add(p.getTypeArgument(i).type());
   ...
   * @aspect GenericsTypeCheck
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:435
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:481
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:482
   * @apilevel internal
   */
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:531
   * @apilevel internal
   */
  public SimpleSet Define_SimpleSet_lookupType(ASTNode caller, ASTNode child, String name) {
    if (caller == getBodyDeclListNoTransform()) {
      int index = caller.getIndexOfChild(child);
      {
        ...
        if (getBodyDecl(index).visibleTypeParameters()) c = addTypeVariables(c, name);
  ...
  /**
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/GenericsParTypeDecl.jrag:50
   * @apilevel internal
   */
