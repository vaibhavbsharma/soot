...
public abstract class AbstractWildcardType extends TypeDecl implements Cloneable {
  ...
  /**
   * Qualified access for wildcard types. Since they have no ordinary package and type name we just
   * return the bound access.
   *
   * @ast method
   * @aspect Generics
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.5Frontend/Generics.jrag:17
   */
   ...
   * @declaredat
   *     /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/Jimple1.5Backend/GenericsCodegen.jrag:424
   */
  @SuppressWarnings({"unchecked", "cast"})
