...
public class StoresTest extends AbstractASMBackendTest {
  ...
  protected void generate(TraceClassVisitor visitor) {
    ...
    visitor.visit(
        ...
        "soot/asm/backend/targets/Stores",
        null,
        "java/lang/Object",
        null);
    ...
    if (targetCompiler == TargetCompiler.eclipse) {
      ...
      mv.visitLabel(l0);
      // mv.visitFrame(F_FULL, 5, new Object[] {"soot/asm/backend/targets/Stores", INTEGER,
      // DOUBLE, FLOAT, INTEGER}, 0, new Object[] {});
      ...
      mv.visitInsn(DADD);
      mv.visitMethodInsn(
          INVOKESTATIC, "java/lang/String", "valueOf", "(D)Ljava/lang/String;", false);
      mv.visitMethodInsn(
