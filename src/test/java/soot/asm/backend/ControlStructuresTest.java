...
public class ControlStructuresTest extends AbstractASMBackendTest {
  ...
  protected void generate(TraceClassVisitor cw) {
    ...
    cw.visit(
        ...
        "soot/asm/backend/targets/ControlStructures",
        null,
        "java/lang/Object",
        null);
...

    {
      fv =
          cw.visitField(
              0, "result", "Ljava/util/List;", "Ljava/util/List<Ljava/lang/Integer;>;", null);
      fv.visitEnd();
    }
    {
    ...
    }
    {
      ...
      mv.visitFieldInsn(
          PUTFIELD, "soot/asm/backend/targets/ControlStructures", "result", "Ljava/util/List;");
      ...
      mv.visitVarInsn(ALOAD, 0);
      mv.visitFieldInsn(
          GETFIELD, "soot/asm/backend/targets/ControlStructures", "result", "Ljava/util/List;");
