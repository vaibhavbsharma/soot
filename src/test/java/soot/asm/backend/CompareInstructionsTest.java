...
public class CompareInstructionsTest extends AbstractASMBackendTest {
  ...
  protected void generate(TraceClassVisitor cw) {
    ...
    cw.visit(
        ...
        "soot/asm/backend/targets/CompareInstructions",
        null,
        "java/lang/Object",
        null);
    ...
    }
    {
      ...
      mv.visitVarInsn(ALOAD, 0);
      mv.visitFieldInsn(
          GETFIELD, "soot/asm/backend/targets/CompareInstructions", "o", "Ljava/lang/Object;");
      Label l0 = new Label();
      ...
      mv.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", "<init>", "()V", false);
      mv.visitFieldInsn(
          PUTFIELD, "soot/asm/backend/targets/CompareInstructions", "o", "Ljava/lang/Object;");
      mv.visitLabel(l0);
