...
public class OuterClassTest extends AbstractASMBackendTest {
  ...
  protected void generate(TraceClassVisitor cw) {
    ...
    cw.visit(
        ...
        "soot/asm/backend/targets/InnerClass",
        null,
        "java/lang/Object",
        null);
    ...
    cw.visitInnerClass(
        "soot/asm/backend/targets/InnerClass$Inner",
        "soot/asm/backend/targets/InnerClass",
        "Inner",
        ACC_PRIVATE);
    ...
    }
    {
      ...
      mv.visitMethodInsn(
          INVOKESPECIAL,
          "soot/asm/backend/targets/InnerClass$1",
          "<init>",
          "(Lsoot/asm/backend/targets/InnerClass;)V",
          false);
      mv.visitInsn(RETURN);
      mv.visitMaxs(0, 0);
      mv.visitEnd();
