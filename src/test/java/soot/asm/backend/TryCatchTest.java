...
public class TryCatchTest extends AbstractASMBackendTest {
  ...
  protected void generate(TraceClassVisitor cw) {
    ...
    cw.visit(
        ...
        "soot/asm/backend/targets/TryCatch",
        null,
        "java/lang/Object",
        null);
    ...
    if (targetCompiler == TargetCompiler.eclipse) {
      ...
      mv.visitLabel(l2);
      // mv.visitFrame(F_FULL, 3, new Object[] {"soot/asm/backend/targets/TryCatch",
      // "java/lang/Object", INTEGER}, 1, new Object[] {"java/lang/NullPointerException"});
