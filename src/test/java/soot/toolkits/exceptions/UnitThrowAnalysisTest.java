...
public class UnitThrowAnalysisTest {
  ...
  public void setUp() {
    ...
    bogusClass.addMethod(
        Scene.v()
            .makeSootMethod(
                ...
                FloatType.v(),
                Modifier.STATIC));
    SootFieldRef nanFieldRef =
        Scene.v()
            .makeFieldRef(Scene.v().getSootClass("java.lang.Float"), "NaN", FloatType.v(), true);
    ...
    floatArrayRef =
        Grimp.v().newArrayRef(Jimple.v().newLocal("local1", FloatType.v()), IntConstant.v(0));
    floatVirtualInvoke =
        Grimp.v()
            .newVirtualInvokeExpr(
                floatConstantLocal,
                Scene.v()
                    .makeMethodRef(bogusClass, "floatFunction", voidList, FloatType.v(), false),
                voidList);
    floatStaticInvoke =
        Grimp.v()
            .newStaticInvokeExpr(
  ...
  public void testJBreakpointStmt() {
    ...
    assertEquals(
        utility.VM_ERRORS_PLUS_SUPERTYPES, utility.catchableSubset(unitAnalysis.mightThrow(s)));
  }
  ...
  public void testJInvokeStmt() {
    ...
    ExceptionHashSet expectedCatch =
        new ExceptionHashSet(utility.VM_AND_RESOLVE_METHOD_ERRORS_PLUS_SUPERTYPES);
    ...
    assertTrue(
        ExceptionTestUtility.sameMembers(
            expectedRep, Collections.EMPTY_SET, immaculateAnalysis.mightThrow(s)));
    assertEquals(expectedCatch, utility.catchableSubset(immaculateAnalysis.mightThrow(s)));
    assertTrue(
        ExceptionTestUtility.sameMembers(
            utility.ALL_THROWABLES_REP, Collections.EMPTY_SET, unitAnalysis.mightThrow(s)));
    assertEquals(utility.ALL_TEST_THROWABLES, utility.catchableSubset(unitAnalysis.mightThrow(s)));

    SootClass bogusClass = new SootClass("BogusClass");
    bogusClass.addMethod(
        Scene.v().makeSootMethod("emptyMethod", voidList, VoidType.v(), Modifier.STATIC));
    s =
        Jimple.v()
            .newInvokeStmt(
                Jimple.v()
                    .newStaticInvokeExpr(
                        Scene.v()
                            .makeMethodRef(bogusClass, "emptyMethod", voidList, VoidType.v(), true),
                        voidList));
    assertTrue(
        ExceptionTestUtility.sameMembers(
            utility.ALL_ERRORS_REP, Collections.EMPTY_SET, immaculateAnalysis.mightThrow(s)));
    assertEquals(
        utility.ALL_TEST_ERRORS_PLUS_SUPERTYPES,
  ...
  public void testJAssignStmt() {
    ...
    ArrayRef arrayRef =
        Jimple.v()
            .newArrayRef(
                Jimple.v().newLocal("local1", ArrayType.v(RefType.v("java.lang.Object"), 1)),
                IntConstant.v(0));
    ...
    assertTrue(
        ExceptionTestUtility.sameMembers(
            expectedRep, Collections.EMPTY_SET, unitAnalysis.mightThrow(s)));
  ...
  public void testGAssignStmt() {
    ...
    ArrayRef arrayRef =
        Grimp.v()
            .newArrayRef(
                Grimp.v().newLocal("local1", ArrayType.v(RefType.v("java.lang.Object"), 1)),
                IntConstant.v(0));
  ...
  public void testJIdentityStmt() {
    ...
    Stmt s =
        Jimple.v()
            .newIdentityStmt(
                Grimp.v().newLocal("local0", IntType.v()), Jimple.v().newCaughtExceptionRef());
    assertTrue(
        ExceptionTestUtility.sameMembers(
            utility.VM_ERRORS, Collections.EMPTY_SET, unitAnalysis.mightThrow(s)));
    assertEquals(
    ...
    s =
        Jimple.v()
            .newIdentityStmt(
                Grimp.v().newLocal("local0", RefType.v("java.lang.NullPointerException")),
  ...
  public void testGIdentityStmt() {
    ...
    Stmt s =
        Grimp.v()
            .newIdentityStmt(
                Grimp.v().newLocal("local0", IntType.v()), Grimp.v().newCaughtExceptionRef());
    assertTrue(
        ExceptionTestUtility.sameMembers(
            utility.VM_ERRORS, Collections.EMPTY_SET, unitAnalysis.mightThrow(s)));
    assertEquals(
  ...
  public void testJIfStmt() {
    IfStmt s =
        Jimple.v().newIfStmt(Jimple.v().newEqExpr(IntConstant.v(1), IntConstant.v(1)), (Unit) null);
  ...
  public void testJThrowStmt() {
    ...
    ThrowStmt s =
        Jimple.v()
            .newThrowStmt(
                Jimple.v().newLocal("local0", RefType.v("java.lang.NullPointerException")));
    ...
    assertTrue(
        ExceptionTestUtility.sameMembers(
            expectedRep, Collections.EMPTY_SET, unitAnalysis.mightThrow(s)));
    assertEquals(
        utility.PERENNIAL_THROW_EXCEPTIONS_PLUS_SUPERTYPES,
  ...
  public void testGThrowStmt() {
    ThrowStmt s =
        Grimp.v()
            .newThrowStmt(Grimp.v().newLocal("local0", RefType.v("java.util.zip.ZipException")));
            ...
            .newThrowStmt(
                Grimp.v()
                    .newNewInvokeExpr(
                        ...
                        Scene.v()
                            .makeMethodRef(
                                utility.INCOMPATIBLE_CLASS_CHANGE_ERROR.getSootClass(),
                                "void <init>",
    ...
    assertTrue(
        ExceptionTestUtility.sameMembers(
            utility.THROW_PLUS_INCOMPATIBLE_CLASS_CHANGE,
            Collections.EMPTY_SET,
            unitAnalysis.mightThrow(s)));
    assertEquals(
        utility.THROW_PLUS_INCOMPATIBLE_CLASS_CHANGE_PLUS_SUPERTYPES,
        utility.catchableSubset(unitAnalysis.mightThrow(s)));
  ...
  public void testJArrayRef() {
    ...
    assertTrue(
        ExceptionTestUtility.sameMembers(
            expectedRep, Collections.EMPTY_SET, unitAnalysis.mightThrow(arrayRef)));
  ...
  public void testJDivExpr() {
    ...
    assertTrue(
        ExceptionTestUtility.sameMembers(
            vmAndArithmetic, Collections.EMPTY_SET, unitAnalysis.mightThrow(v)));
    ...
    assertTrue(
        ExceptionTestUtility.sameMembers(
            utility.VM_ERRORS, Collections.EMPTY_SET, unitAnalysis.mightThrow(v)));
    assertEquals(
        utility.VM_ERRORS_PLUS_SUPERTYPES, utility.catchableSubset(unitAnalysis.mightThrow(v)));
  ...
  public void testGDivExpr() {
    ...
    v =
        Grimp.v()
            .newDivExpr(
                Grimp.v().newAddExpr(intLocal, intLocal), Grimp.v().newMulExpr(intLocal, intLocal));
    assertTrue(
        ExceptionTestUtility.sameMembers(
            vmAndArithmetic, Collections.EMPTY_SET, unitAnalysis.mightThrow(v)));
    assertEquals(vmAndArithmeticAndSupertypes, utility.catchableSubset(unitAnalysis.mightThrow(v)));
    ...
    v =
        Grimp.v()
            .newDivExpr(
                Grimp.v().newAddExpr(longLocal, longLocal),
  ...
  public void testJBinOpExp() {
    ...
    v =
        Jimple.v()
            .newEqExpr(DoubleConstant.v(-33.45e-3), Jimple.v().newLocal("local", DoubleType.v()));
    assertTrue(
        ExceptionTestUtility.sameMembers(
            utility.VM_ERRORS, Collections.EMPTY_SET, unitAnalysis.mightThrow(v)));
    assertEquals(
  ...
  public void testGBinOpExp() {
    ...
    assertTrue(
        ExceptionTestUtility.sameMembers(
            utility.ALL_ERRORS_REP, Collections.EMPTY_SET, unitAnalysis.mightThrow(v)));
    assertEquals(
        utility.ALL_TEST_ERRORS_PLUS_SUPERTYPES,
    ...
    assertTrue(
        ExceptionTestUtility.sameMembers(
            expectedRep, Collections.EMPTY_SET, unitAnalysis.mightThrow(v)));
    assertEquals(expectedCatch, utility.catchableSubset(unitAnalysis.mightThrow(v)));

    v = Grimp.v().newEqExpr(v, floatVirtualInvoke);
    assertTrue(
        ExceptionTestUtility.sameMembers(
            expectedRep, Collections.EMPTY_SET, immaculateAnalysis.mightThrow(v)));
    assertEquals(expectedCatch, utility.catchableSubset(immaculateAnalysis.mightThrow(v)));
    assertTrue(
        ExceptionTestUtility.sameMembers(
            utility.ALL_THROWABLES_REP, Collections.EMPTY_SET, unitAnalysis.mightThrow(v)));
  ...
  public void testJCastExpr() {
    ...
    Value v =
        Jimple.v()
            .newCastExpr(
                Jimple.v().newLocal("local", utility.INCOMPATIBLE_CLASS_CHANGE_ERROR),
    ...
    v =
        Jimple.v()
            .newCastExpr(
                Jimple.v().newLocal("local", utility.LINKAGE_ERROR), utility.LINKAGE_ERROR);
    assertTrue(
        ExceptionTestUtility.sameMembers(
            expectedRep, Collections.EMPTY_SET, unitAnalysis.mightThrow(v)));
    assertEquals(expectedCatch, utility.catchableSubset(unitAnalysis.mightThrow(v)));
    ...
    v =
        Jimple.v()
            .newCastExpr(
                Jimple.v().newLocal("local", utility.LINKAGE_ERROR),
                utility.INCOMPATIBLE_CLASS_CHANGE_ERROR);
    ...
    Value v =
        Grimp.v()
            .newInstanceFieldRef(
                ...
                Scene.v()
                    .makeFieldRef(
                        utility.THROWABLE.getSootClass(),
                        "detailMessage",
  ...
  public void testJLocal() {
    ...
    assertTrue(
        ExceptionTestUtility.sameMembers(
            utility.VM_ERRORS, Collections.EMPTY_SET, unitAnalysis.mightThrow(local)));
    assertEquals(
        utility.VM_ERRORS_PLUS_SUPERTYPES, utility.catchableSubset(unitAnalysis.mightThrow(local)));
  }
  ...
  public void testBAddInst() {
    ...
    assertTrue(
        ExceptionTestUtility.sameMembers(
            utility.VM_ERRORS, Collections.EMPTY_SET, unitAnalysis.mightThrow(i)));
    assertEquals(
        utility.VM_ERRORS_PLUS_SUPERTYPES, utility.catchableSubset(unitAnalysis.mightThrow(i)));
  }
  ...
  public void testBArrayLengthInst() {
    ...
    assertTrue(
        ExceptionTestUtility.sameMembers(
            expectedRep, Collections.EMPTY_SET, unitAnalysis.mightThrow(i)));
    Set expectedCatch = new ExceptionHashSet(utility.VM_ERRORS_PLUS_SUPERTYPES);
    expectedCatch.add(utility.NULL_POINTER_EXCEPTION);
    expectedCatch.add(utility.RUNTIME_EXCEPTION);
    expectedCatch.add(utility.EXCEPTION);
