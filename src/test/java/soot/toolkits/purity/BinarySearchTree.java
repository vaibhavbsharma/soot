...
/**
 * This example is from the article A Combined Pointer and Purity Analysis for Java Programs" by
 * Alexandru Salcianu and Martin Rinard. It is supposed to demonstrate the purity analysis
 * (-annot-purity)
 *
