...
public class MethodHandleTest {
  ...
  public void testConstant() throws IOException {
    ...
    MethodVisitor mv =
        cv.visitMethod(
            ...
            "getSquareRoot",
            Type.getMethodDescriptor(Type.getType(java.lang.invoke.MethodHandle.class)),
            null,
            null);
    ...
    String[] commandLine = {
      "-asm-backend", "-pp", "-cp", tempDir.getAbsolutePath(), "-O", "HelloMethodHandles",
    };
  ...
  public void testInvoke() throws IOException {
    ...
    mv.visitMethodInsn(
        ...
        Type.getInternalName(java.lang.invoke.MethodHandle.class),
        "invoke",
    ...
    String[] commandLine = {
      "-asm-backend", "-pp", "-cp", tempDir.getAbsolutePath(), "-O", "UniformDistribution",
    };
